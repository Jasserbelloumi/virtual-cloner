...
@Metadata(bv = {}, d1 = {"\u0000\u001a\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u001a=\u0010\u0006\u001a\u00020\u00052.\u0010\u0004\u001a\u0018\u0012\u0014\b\u0001\u0012\u0010\u0012\u0004\u0012\u00020\u0002\u0012\u0006\u0012\u0004\u0018\u00010\u00030\u00010\u0000\"\u0010\u0012\u0004\u0012\u00020\u0002\u0012\u0006\u0012\u0004\u0018\u00010\u00030\u0001¢\u0006\u0004\b\u0006\u0010\u0007\u001a\u0006\u0010\b\u001a\u00020\u0005¨\u0006\t"}, d2 = {"", "Lo0OO0o/o0O0o00;", "", "", "pairs", "Landroid/os/Bundle;", o0OO000o.o00oOOoO.f12961o00oOo00, "([Lo0OO0o/o0O0o00;)Landroid/os/Bundle;", "o00oOOo0", "core-ktx_release"}, k = 2, mv = {1, 7, 1})
/* loaded from: classes.dex */
public final class o00oOo0O {
    @NotNull
    public static final Bundle o00oOOo0() {
        return new Bundle(0);
    }

    @NotNull
    public static final Bundle o00oOOoO(@NotNull o0O0o00<String, ? extends Object>... o0o0o00Arr) {
        o0ooO.o00oo0O0(o0o0o00Arr, "pairs");
        Bundle bundle = new Bundle(o0o0o00Arr.length);
        for (o0O0o00<String, ? extends Object> o0o0o00 : o0o0o00Arr) {
            ...
            if (component2 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    o0ooO.o00oo0(component2, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(component1, (Parcelable[]) component2);
                } else if (String.class.isAssignableFrom(componentType)) {
                    o0ooO.o00oo0(component2, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(component1, (String[]) component2);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    o0ooO.o00oo0(component2, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
                    bundle.putCharSequenceArray(component1, (CharSequence[]) component2);
                } else {
                    if (!Serializable.class.isAssignableFrom(componentType)) {
                        throw new IllegalArgumentException("Illegal value array type " + componentType.getCanonicalName() + " for key \"" + component1 + oOo0oooO.f13903o00oOOoO);
                    }
                ...
                if (!(component2 instanceof Serializable)) {
                    if (component2 instanceof IBinder) {
                        o00oOOoO.o00oOOo0(bundle, component1, (IBinder) component2);
                    } else if (component2 instanceof Size) {
                        o00oOo00.o00oOOo0(bundle, component1, (Size) component2);
                        ...
                        o00oOo00.o00oOOoO(bundle, component1, (SizeF) component2);
                    }
                }
                bundle.putSerializable(component1, (Serializable) component2);
            }
