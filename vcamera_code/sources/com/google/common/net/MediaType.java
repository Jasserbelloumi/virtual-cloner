        ...
        try {
            ...
            while (tokenizer.hasMore()) {
                ...
                if ('\"' == tokenizer.previewChar()) {
                    tokenizer.consumeCharacter(oOo0oooO.f13903o00oOOoO);
                    StringBuilder sb = new StringBuilder();
            ...
            throw new IllegalArgumentException(o00oOOoO.o00oOOo0(o00oOOo0.o00oOOo0(str, 18), "Could not parse '", str, "'"), e);
        }
    }
        ...
        if (optional == null) {
            ...
            while (it.hasNext()) {
                ...
                if (str == null) {
                    ...
                    throw new IllegalStateException(com.google.common.base.o00oOOo0.o00oOOo0(o00oOOo0.o00oOOo0(next, str.length() + 35), "Multiple charset values defined: ", str, ", ", next));
                }
            }
