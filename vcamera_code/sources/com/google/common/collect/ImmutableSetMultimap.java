...
public class ImmutableSetMultimap<K, V> extends ImmutableMultimap<K, V> implements SetMultimap<K, V> {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        if (readInt < 0) {
            throw new InvalidObjectException(o00oOOo0.o00oOOo0(29, "Invalid key count ", readInt));
        }
        ...
        for (int i2 = 0; i2 < readInt; i2++) {
            ...
            if (readInt2 <= 0) {
                throw new InvalidObjectException(o00oOOo0.o00oOOo0(31, "Invalid value count ", readInt2));
            }
            ...
            if (build.size() != readInt2) {
                ...
                throw new InvalidObjectException(o00oOo00.o00oOOo0(valueOf.length() + 40, "Duplicate key-value pairs exist for key ", valueOf));
            }
