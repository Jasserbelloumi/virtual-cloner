...
public final class RegularImmutableMap<K, V> extends ImmutableMap<K, V> {
    ...
    */
    ...
    private static IllegalArgumentException duplicateKeyException(Object obj, Object obj2, Object[] objArr, int i) {
        ...
        StringBuilder o00oOOo02 = o00oOOoO.o00oOOo0(valueOf4.length() + valueOf3.length() + valueOf2.length() + valueOf.length() + 39, "Multiple entries with same key: ", valueOf, "=", valueOf2);
        ...
        if (i == 1) {
            ...
            if (obj instanceof byte[]) {
                ...
                while (true) {
                    ...
                    int i6 = sArr[i5] & oO0000Oo.f13232o00oo0o0;
                    if (i6 == 65535) {
                        return null;
                    }
