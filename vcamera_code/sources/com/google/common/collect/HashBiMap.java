...
public final class HashBiMap<K, V> extends AbstractMap<K, V> implements BiMap<K, V>, Serializable {
    ...
    private void deleteFromTableKToV(int i, int i2) {
        ...
        throw new AssertionError(o00oOo00.o00oOOo0(valueOf.length() + 32, "Expected to find entry with key ", valueOf));
    }
    ...
    private void deleteFromTableVToK(int i, int i2) {
        ...
        throw new AssertionError(o00oOo00.o00oOOo0(valueOf.length() + 34, "Expected to find entry with value ", valueOf));
    }
    ...
    public void replaceKeyInEntry(int i, @ParametricNullness K k, boolean z) {
        ...
        if (findEntryByKey != -1) {
            if (!z) {
                ...
                throw new IllegalArgumentException(o00oOo00.o00oOOo0(valueOf.length() + 28, "Key already present in map: ", valueOf));
            }
    ...
    public void replaceValueInEntry(int i, @ParametricNullness V v, boolean z) {
        ...
        if (findEntryByValue != -1) {
            if (!z) {
                ...
                throw new IllegalArgumentException(o00oOo00.o00oOOo0(valueOf.length() + 30, "Value already present in map: ", valueOf));
            }
