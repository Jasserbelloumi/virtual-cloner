...
final class CompactHashing {
    ...
    public static Object createTable(int i) {
        if (i < 2 || i > 1073741824 || Integer.highestOneBit(i) != i) {
            throw new IllegalArgumentException(o00oOOo0.o00oOOo0(52, "must be power of 2 between 2^1 and 2^30: ", i));
        }
    ...
    public static int tableGet(Object obj, int i) {
        return obj instanceof byte[] ? ((byte[]) obj)[i] & 255 : obj instanceof short[] ? ((short[]) obj)[i] & oO0000Oo.f13232o00oo0o0 : ((int[]) obj)[i];
    }
