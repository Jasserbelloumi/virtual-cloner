...
public abstract class Equivalence<T> {
    ...
    public static final class EquivalentToPredicate<T> implements Predicate<T>, Serializable {
        ...
        public String toString() {
            ...
            return o00oOOo0.o00oOOo0(valueOf2.length() + valueOf.length() + 15, valueOf, ".equivalentTo(", valueOf2, ")");
        }
    }
    ...
    public static final class Wrapper<T> implements Serializable {
        ...
        public String toString() {
            ...
            return o00oOOo0.o00oOOo0(valueOf2.length() + valueOf.length() + 7, valueOf, ".wrap(", valueOf2, ")");
        }
    }
