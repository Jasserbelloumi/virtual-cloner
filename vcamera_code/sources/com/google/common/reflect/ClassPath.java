    ...
    public static final class LocationInfo {
        ...
        private void scan(File file, Set<File> set, ImmutableSet.Builder<ResourceInfo> builder) throws IOException {
            try {
                ...
                logger.warning(o00oOOo0.o00oOOo0(valueOf2.length() + valueOf.length() + 16, "Cannot access ", valueOf, ": ", valueOf2));
            }
        }
            ...
            for (File file2 : listFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (set.add(canonicalFile)) {
                        scanDirectory(canonicalFile, o00oOOoO.o00oOOo0(com.google.android.gms.internal.ads.o00oOOo0.o00oOOo0(name, com.google.android.gms.internal.ads.o00oOOo0.o00oOOo0(str, 1)), str, name, "/"), set, builder);
