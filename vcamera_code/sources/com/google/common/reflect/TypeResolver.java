...
public final class TypeResolver {
    ...
    public static class WildcardCapturer {
        ...
        public TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            ...
            String join = Joiner.on((char) oOo0oooO.f13912o00oOooO).join(typeArr);
            StringBuilder sb = new StringBuilder(o00oOOo0.o00oOOo0(join, 33));
            sb.append("capture#");
    ...
    public static <T> T expectArgument(Class<T> cls, Object obj) {
        try {
            ...
            throw new IllegalArgumentException(o00oOOoO.o00oOOo0(simpleName.length() + valueOf.length() + 10, valueOf, " is not a ", simpleName));
        }
    }
    ...
    public static void populateTypeMappings(final Map<TypeVariableKey, Type> map, Type type, final Type type2) {
        ...
        new TypeVisitor() { // from class: com.google.common.reflect.TypeResolver.1
            ...
            public void visitClass(Class<?> cls) {
                ...
                throw new IllegalArgumentException(com.google.common.base.o00oOOo0.o00oOOo0(valueOf2.length() + valueOf.length() + 25, "No type mapping from ", valueOf, " to ", valueOf2));
            }
