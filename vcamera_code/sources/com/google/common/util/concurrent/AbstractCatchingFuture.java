...
public abstract class AbstractCatchingFuture<V, X extends Throwable, F, T> extends FluentFuture.TrustedFuture<V> implements Runnable {
    ...
    public String pendingToString() {
        ...
        if (listenableFuture != null) {
            ...
            str = o00oOOoO.o00oOOo0(valueOf.length() + 16, "inputFuture=[", valueOf, "], ");
        } else {
            str = "";
        }
        if (cls != null && f != null) {
            ...
            return android.support.v4.media.o00oOOoO.o00oOOo0(com.google.common.base.o00oOOoO.o00oOOo0(valueOf3.length() + valueOf2.length() + com.google.android.gms.internal.ads.o00oOOo0.o00oOOo0(str, 29), str, "exceptionType=[", valueOf2, "], fallback=["), valueOf3, "]");
    ...
    */
    public final void run() {
        ...
        L3b:
            ...
            java.lang.StringBuilder r4 = com.google.common.base.o00oOOoO.o00oOOo0(r8, r7, r6, r9, r4)
