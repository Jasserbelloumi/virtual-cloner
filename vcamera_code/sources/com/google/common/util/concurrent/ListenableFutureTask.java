...
public class ListenableFutureTask<V> extends FutureTask<V> implements ListenableFuture<V> {
    ...
    public V get(long j, TimeUnit timeUnit) throws TimeoutException, InterruptedException, ExecutionException {
        ...
        return nanos <= OverflowAvoidingLockSupport.MAX_NANOSECONDS_THRESHOLD ? (V) super.get(j, timeUnit) : (V) super.get(Math.min(nanos, (long) OverflowAvoidingLockSupport.MAX_NANOSECONDS_THRESHOLD), TimeUnit.NANOSECONDS);
    }
}
