...
public final class ServiceManager implements ServiceManagerBridge {
        ...
        public void failed(Service.State state, Throwable th) {
            ...
            if (serviceManagerState != null) {
                if (!(this.service instanceof NoOpService)) {
                    ...
                    StringBuilder o00oOOo02 = o00oOOoO.o00oOOo0(valueOf2.length() + valueOf.length() + 34, "Service ", valueOf, " has failed in the ", valueOf2);
                    o00oOOo02.append(" state.");
                    logger.log(level, o00oOOo02.toString(), th);
                }
    ...
    public static final class ServiceManagerState {
        ...
        public void checkHealthy() {
            ...
            throw new IllegalStateException(o00oOo00.o00oOOo0(valueOf.length() + 79, "Expected to be healthy after starting. The following services are not running: ", valueOf));
        }
        ...
        public void enqueueFailedEvent(final Service service) {
            this.listeners.enqueue(new ListenerCallQueue.Event<Listener>(this) { // from class: com.google.common.util.concurrent.ServiceManager.ServiceManagerState.2
                ...
                public String toString() {
                    ...
                    return com.google.android.gms.internal.ads.o00oOOoO.o00oOOo0(valueOf.length() + 18, "failed({service=", valueOf, "})");
                }
            });
        }
    ...
    public ServiceManager startAsync() {
        ...
        while (it2.hasNext()) {
            ...
            try {
                ...
                logger2.log(level, o00oOo00.o00oOOo0(valueOf.length() + 24, "Unable to start Service ", valueOf), (Throwable) e);
            }
        }
        return this;
    }
