...
public final class ListenerCallQueue<L> {
            ...
            if (z) {
                try {
                    ...
                    synchronized (this) {
                        ...
                        logger.log(level, com.google.common.base.o00oOOo0.o00oOOo0(valueOf2.length() + valueOf.length() + 42, "Exception while running callbacks for ", valueOf, " on ", valueOf2), (Throwable) e);
                        throw e;
                    }
                }
            }
    ...
    private void enqueueHelper(Event<L> event, Object obj) {
        Preconditions.checkNotNull(event, oOo000Oo.f9217o0O00o0o);
        Preconditions.checkNotNull(obj, oO0O0O0.f9051o00oOoo0);
