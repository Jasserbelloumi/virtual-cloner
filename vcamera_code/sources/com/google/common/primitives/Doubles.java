...
public final class Doubles extends DoublesMethodsForWeb {
    ...
    private static Pattern fpPattern() {
        ...
        StringBuilder o00oOOo02 = o00oOOoO.o00oOOo0(o00oOOo0.o00oOOo0("0[xX](?:[0-9a-fA-F]+#(?:\\.[0-9a-fA-F]*#)?|\\.[0-9a-fA-F]+#)[pP][+-]?\\d+#[fFdD]?", o00oOOo0.o00oOOo0(concat, 23)), "[+-]?(?:NaN|Infinity|", concat, o0OO0.o00oOOoO.f12937o00oOOoO, "0[xX](?:[0-9a-fA-F]+#(?:\\.[0-9a-fA-F]*#)?|\\.[0-9a-fA-F]+#)[pP][+-]?\\d+#[fFdD]?");
        o00oOOo02.append(")");
        return Pattern.compile(o00oOOo02.toString().replace("#", BadgeDrawable.DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX));
    }
