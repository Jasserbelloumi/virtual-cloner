...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            long load642 = jArr[0] + LittleEndianByteArray.load64(bArr, i7 + 40) + rotateRight2;
            ...
            if (i7 == i4) {
                ...
                long load643 = (jArr[0] * 9) + LittleEndianByteArray.load64(bArr, i6 + 40) + (Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bArr, i6 + 48), 42) * j3);
