...
public final class Quantiles {
    ...
    public static final class ScaleAndIndexes {
        ...
        public Map<Integer, Double> computeInPlace(double... dArr) {
            ...
            while (true) {
                ...
                int i6 = iArr5[i];
                if (i6 == 0) {
                    valueOf = Integer.valueOf(iArr7[i]);
                    interpolate = dArr[i5];
                } else {
                    valueOf = Integer.valueOf(iArr7[i]);
                    interpolate = Quantiles.interpolate(dArr[i5], dArr[i5 + 1], i6, this.scale);
                }
    ...
    public static void checkIndex(int i, int i2) {
        if (i < 0 || i > i2) {
            throw new IllegalArgumentException(o00oOOo0.o00oOOo0(70, "Quantile indexes must be between 0 and the scale, which is ", i2));
        }
    }
