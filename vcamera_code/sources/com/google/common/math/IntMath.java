...
public final class IntMath {
    ...
    @VisibleForTesting
    public static final int[] powersOf10 = {1, 10, 100, 1000, 10000, AacUtil.AAC_LC_MAX_RATE_BYTES_PER_SECOND, 1000000, 10000000, 100000000, 1000000000};
    @VisibleForTesting
    ...
    @VisibleForTesting
    public static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, o00oOoO.f10155o00oo0oO, 110, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    */
    ...
    public static int gcd(int i, int i2) {
        MathPreconditions.checkNonNegative(oooOO0.f12266o00oOOo0, i);
    ...
    public static int sqrt(int i, RoundingMode roundingMode) {
        ...
        switch (AnonymousClass1.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 5:
                ...
                return lessThanBranchFree(i2, i) + sqrtFloor;
            case 6:
            case 7:
            case 8:
