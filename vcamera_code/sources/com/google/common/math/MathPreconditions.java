...
final class MathPreconditions {
    ...
    public static void checkNoOverflow(boolean z, String str, int i, int i2) {
        ...
        StringBuilder sb = new StringBuilder(o00oOOo0.o00oOOo0(str, 36));
        sb.append("overflow: ");
        sb.append(str);
        sb.append("(");
        sb.append(i);
    ...
    public static int checkPositive(String str, int i) {
        ...
        StringBuilder sb = new StringBuilder(o00oOOo0.o00oOOo0(str, 26));
        sb.append(str);
        sb.append(" (");
        sb.append(i);
        sb.append(") must be > 0");
    ...
    public static void checkNoOverflow(boolean z, String str, long j, long j2) {
        ...
        StringBuilder sb = new StringBuilder(o00oOOo0.o00oOOo0(str, 54));
        sb.append("overflow: ");
        sb.append(str);
        sb.append("(");
        sb.append(j);
    ...
    public static int checkNonNegative(String str, int i) {
        ...
        StringBuilder sb = new StringBuilder(o00oOOo0.o00oOOo0(str, 27));
        sb.append(str);
        sb.append(" (");
        sb.append(i);
        sb.append(") must be >= 0");
    ...
    public static long checkPositive(String str, long j) {
        ...
        StringBuilder sb = new StringBuilder(o00oOOo0.o00oOOo0(str, 35));
        sb.append(str);
        sb.append(" (");
        sb.append(j);
        sb.append(") must be > 0");
    ...
    public static BigInteger checkPositive(String str, BigInteger bigInteger) {
        ...
        throw new IllegalArgumentException(com.google.common.base.o00oOOo0.o00oOOo0(valueOf.length() + o00oOOo0.o00oOOo0(str, 15), str, " (", valueOf, ") must be > 0"));
    }
    ...
    public static BigInteger checkNonNegative(String str, BigInteger bigInteger) {
        ...
        String valueOf = String.valueOf(bigInteger);
        throw new IllegalArgumentException(com.google.common.base.o00oOOo0.o00oOOo0(valueOf.length() + o00oOOo0.o00oOOo0(str, 16), str, " (", valueOf, ") must be >= 0"));
    }
}
