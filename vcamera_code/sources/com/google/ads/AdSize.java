...
public final class AdSize {
    ...
    public AdSize(@oo0oO0 com.google.android.gms.ads.AdSize adSize) {
        this.zza = adSize;
    }

    public boolean equals(@oo0oO0 Object obj) {
    ...
    @o0OO00OO
    public AdSize findBestSize(@oo0oO0 AdSize... adSizeArr) {
        int width;
        int height;
        AdSize adSize = null;
        if (adSizeArr == null) {
