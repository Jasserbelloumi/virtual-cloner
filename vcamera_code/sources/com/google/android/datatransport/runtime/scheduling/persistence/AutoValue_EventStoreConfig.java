...
final class AutoValue_EventStoreConfig extends EventStoreConfig {
    ...
    public static final class Builder extends EventStoreConfig.Builder {
        ...
        public EventStoreConfig build() {
            ...
            if (this.loadBatchSize == null) {
                str = o00oOoOo.o00oo.o00oOOo0(str, " loadBatchSize");
            }
            if (this.criticalSectionEnterTimeoutMs == null) {
                str = o00oOoOo.o00oo.o00oOOo0(str, " criticalSectionEnterTimeoutMs");
            }
            if (this.eventCleanUpAge == null) {
                str = o00oOoOo.o00oo.o00oOOo0(str, " eventCleanUpAge");
            }
            if (this.maxBlobByteSizePerRow == null) {
                str = o00oOoOo.o00oo.o00oOOo0(str, " maxBlobByteSizePerRow");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("EventStoreConfig{maxStorageSizeInBytes=");
        o00oOOo02.append(this.maxStorageSizeInBytes);
        o00oOOo02.append(", loadBatchSize=");
        o00oOOo02.append(this.loadBatchSize);
        o00oOOo02.append(", criticalSectionEnterTimeoutMs=");
        o00oOOo02.append(this.criticalSectionEnterTimeoutMs);
        o00oOOo02.append(", eventCleanUpAge=");
        o00oOOo02.append(this.eventCleanUpAge);
        o00oOOo02.append(", maxBlobByteSizePerRow=");
        return android.support.v4.media.o00oOo00.o00oOOo0(o00oOOo02, this.maxBlobByteSizePerRow, "}");
    }
}
