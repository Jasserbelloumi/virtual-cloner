...
public final class CctTransportBackend implements TransportBackend {
    ...
    public static final class HttpRequest {
        ...
        public HttpRequest(URL url, BatchedLogRequest batchedLogRequest, @o0OO00OO String str) {
            this.url = url;
    ...
    public static final class HttpResponse {
        ...
        public HttpResponse(int i, @o0OO00OO URL url, long j) {
            this.code = i;
    ...
    private static URL parseUrlOrThrow(String str) {
        try {
            ...
            throw new IllegalArgumentException(o00oo.o00oOOo0("Invalid url: ", str), e);
        }
    }
    ...
    public BackendResponse send(BackendRequest backendRequest) {
        ...
        try {
            HttpResponse httpResponse = (HttpResponse) Retries.retry(5, new HttpRequest(url, requestBody, r3), new Function() { // from class: com.google.android.datatransport.cct.o00oOOo0
            ...
            }, new RetryStrategy() { // from class: com.google.android.datatransport.cct.o00oOOoO
