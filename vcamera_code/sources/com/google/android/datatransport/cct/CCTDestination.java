...
public final class CCTDestination implements EncodedDestination {
    ...
    public CCTDestination(@oo0oO0 String str, @o0OO00OO String str2) {
        this.endPoint = str;
        this.apiKey = str2;
    }

    @oo0oO0
    public static String decodeExtras(@oo0oO0 byte[] bArr) {
        return new String(bArr, Charset.forName(C.UTF8_NAME));
    }

    @oo0oO0
    public static byte[] encodeString(@oo0oO0 String str) {
        return str.getBytes(Charset.forName(C.UTF8_NAME));
    }

    @oo0oO0
    public static CCTDestination fromByteArray(@oo0oO0 byte[] bArr) {
