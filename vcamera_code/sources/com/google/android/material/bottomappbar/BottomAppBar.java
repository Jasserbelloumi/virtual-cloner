...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.o00oOOoO {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
            ...
            this.fabLayoutListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.Behavior.1
                ...
                public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        ((ViewGroup.MarginLayoutParams) o00oo0Var).bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - height) / 2));
                        ((ViewGroup.MarginLayoutParams) o00oo0Var).leftMargin = bottomAppBar.getLeftInset();
                        ((ViewGroup.MarginLayoutParams) o00oo0Var).rightMargin = bottomAppBar.getRightInset();
                        if (ViewUtils.isLayoutRtl(floatingActionButton)) {
                            ((ViewGroup.MarginLayoutParams) o00oo0Var).leftMargin = bottomAppBar.fabOffsetEndMode + ((ViewGroup.MarginLayoutParams) o00oo0Var).leftMargin;
                            return;
                        }
                        ((ViewGroup.MarginLayoutParams) o00oo0Var).rightMargin = bottomAppBar.fabOffsetEndMode + ((ViewGroup.MarginLayoutParams) o00oo0Var).rightMargin;
                    }
                }
            };
        ...
        @Override // com.google.android.material.behavior.HideBottomViewOnScrollBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.o00oOo00
        public boolean onLayoutChild(@oo0oO0 CoordinatorLayout coordinatorLayout, @oo0oO0 BottomAppBar bottomAppBar, int i) {
            this.viewRef = new WeakReference<>(bottomAppBar);
            View findDependentView = bottomAppBar.findDependentView();
            if (findDependentView != null && !o0O0o00O.o0O0Oooo(findDependentView)) {
                CoordinatorLayout.o00oo0 o00oo0Var = (CoordinatorLayout.o00oo0) findDependentView.getLayoutParams();
                o00oo0Var.f2308o00oOooO = 49;
                this.originalBottomMargin = ((ViewGroup.MarginLayoutParams) o00oo0Var).bottomMargin;
        ...
        @Override // com.google.android.material.behavior.HideBottomViewOnScrollBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.o00oOo00
        public boolean onStartNestedScroll(@oo0oO0 CoordinatorLayout coordinatorLayout, @oo0oO0 BottomAppBar bottomAppBar, @oo0oO0 View view, @oo0oO0 View view2, int i, int i2) {
    ...
    public BottomAppBar(@oo0oO0 Context context) {
        this(context, null, 0);
    }

    public BottomAppBar(@oo0oO0 Context context, @o0OO00OO AttributeSet attributeSet) {
    ...
    */
    public BottomAppBar(@o00oOooO.oo0oO0 android.content.Context r11, @o00oOooO.o0OO00OO android.util.AttributeSet r12, int r13) {
        /*
            r10 = this;
            ...
            float r0 = (float) r2
            r10.setElevation(r0)
            o00oooo0.o0O0O0Oo.o00oOOoO.o00oOoO(r11, r1)
            o0O000oo.o0O0o00O.o0O0ooo0(r10, r11)
    ...
    public void addFabAnimationListeners(@oo0oO0 FloatingActionButton floatingActionButton) {
    ...
    private void createFabTranslationXAnimation(int i, @oo0oO0 List<Animator> list) {
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(findDependentFab(), o00oo0.f8125o00oo0o, getFabTranslationX(i));
        ofFloat.setDuration(300L);
        list.add(ofFloat);
    }

    private void createMenuViewTranslationAnimation(final int i, final boolean z, @oo0oO0 List<Animator> list) {
        final ActionMenuView actionMenuView = getActionMenuView();
        if (actionMenuView == null) {
            return;
        }
        Animator ofFloat = ObjectAnimator.ofFloat(actionMenuView, o00oo0.f8113o00oOoO0, 1.0f);
        ...
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(actionMenuView, o00oo0.f8113o00oOoO0, 0.0f);
    ...
    */
    ...
    private void maybeAnimateModeChange(int i) {
        if (this.fabAlignmentMode == i || !o0O0o00O.o0O0Oooo(this)) {
            return;
        }
    ...
    private void translateActionMenuView(@oo0oO0 ActionMenuView actionMenuView, int i, boolean z) {
        translateActionMenuView(actionMenuView, i, z, false);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@oo0oO0 final ActionMenuView actionMenuView, final int i, final boolean z, boolean z2) {
    ...
    public void addAnimationListener(@oo0oO0 AnimationListener animationListener) {
    ...
    public void createFabDefaultXAnimation(final int i, List<Animator> list) {
        ...
        findDependentFab.hide(new FloatingActionButton.OnVisibilityChangedListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.5
            ...
            public void onHidden(@oo0oO0 FloatingActionButton floatingActionButton) {
    ...
    public int getActionMenuViewTranslationX(@oo0oO0 ActionMenuView actionMenuView, int i, boolean z) {
        if (i == 1 && z) {
            boolean isLayoutRtl = ViewUtils.isLayoutRtl(this);
            int measuredWidth = isLayoutRtl ? getMeasuredWidth() : 0;
            for (int i2 = 0; i2 < getChildCount(); i2++) {
                View childAt = getChildAt(i2);
                if ((childAt.getLayoutParams() instanceof Toolbar.o00oo0) && (((Toolbar.o00oo0) childAt.getLayoutParams()).f371o00oOOo0 & o0.f10420o00oOooO) == 8388611) {
    ...
    public void removeAnimationListener(@oo0oO0 AnimationListener animationListener) {
    ...
    public void replaceMenu(@o0OO000 int i) {
        if (i != 0) {
    ...
    public void setBackgroundTint(@o0OO00OO ColorStateList colorStateList) {
        o0O0O0Oo.o00oOOoO.o00oOoO(this.materialShapeDrawable, colorStateList);
    }

    public void setCradleVerticalOffset(@o0O0O0O float f) {
    ...
    public void setFabAlignmentModeAndReplaceMenu(int i, @o0OO000 int i2) {
    ...
    public void setFabCradleMargin(@o0O0O0O float f) {
    ...
    public void setFabCradleRoundedCornerRadius(@o0O0O0O float f) {
    ...
    public boolean setFabDiameter(@o0OO0 int i) {
        float f = i;
