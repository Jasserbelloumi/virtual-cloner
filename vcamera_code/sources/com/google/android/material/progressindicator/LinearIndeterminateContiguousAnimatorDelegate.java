...
public final class LinearIndeterminateContiguousAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private o00oOOoO interpolator;
    private int newIndicatorColorIndex;

    public LinearIndeterminateContiguousAnimatorDelegate(@oo0oO0 LinearProgressIndicatorSpec linearProgressIndicatorSpec) {
        super(3);
    ...
    @Override // com.google.android.material.progressindicator.IndeterminateAnimatorDelegate
    public void registerAnimatorsCompleteCallback(@o0OO00OO o0O0OOO0.o00oOOo0 o00oooo02) {
    }
