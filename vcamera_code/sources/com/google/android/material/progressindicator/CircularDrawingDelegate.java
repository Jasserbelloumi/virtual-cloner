...
final class CircularDrawingDelegate extends DrawingDelegate<CircularProgressIndicatorSpec> {
    ...
    public CircularDrawingDelegate(@oo0oO0 CircularProgressIndicatorSpec circularProgressIndicatorSpec) {
    ...
    public void adjustCanvas(@oo0oO0 Canvas canvas, @o0O0OO0(from = 0.0d, to = 1.0d) float f) {
        S s;
        S s2 = this.spec;
    ...
    @Override // com.google.android.material.progressindicator.DrawingDelegate
    public void fillIndicator(@oo0oO0 Canvas canvas, @oo0oO0 Paint paint, @o0O0OO0(from = 0.0d, to = 1.0d) float f, @o0O0OO0(from = 0.0d, to = 1.0d) float f2, @o0O00O int i) {
        if (f == f2) {
            return;
        }
    ...
    @Override // com.google.android.material.progressindicator.DrawingDelegate
    public void fillTrack(@oo0oO0 Canvas canvas, @oo0oO0 Paint paint) {
