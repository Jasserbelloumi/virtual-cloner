...
public class InterpolateOnScrollPositionChangeHelper {
    ...
    public void startListeningForScrollChanges(@oo0oO0 ViewTreeObserver viewTreeObserver) {
        viewTreeObserver.addOnScrollChangedListener(this.scrollChangedListener);
    }

    public void stopListeningForScrollChanges(@oo0oO0 ViewTreeObserver viewTreeObserver) {
