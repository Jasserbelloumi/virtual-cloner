...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.o00oOOoO {
    ...
    @oo0oO0
    private final CoordinatorLayout.o00oOo00<ExtendedFloatingActionButton> behavior;
    ...
    public static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, "width") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.4
        ...
        @oo0oO0
        public Float get(@oo0oO0 View view) {
            return Float.valueOf(view.getLayoutParams().width);
        }

        @Override // android.util.Property
        public void set(@oo0oO0 View view, @oo0oO0 Float f) {
    ...
    public static final Property<View, Float> PADDING_START = new Property<View, Float>(Float.class, "paddingStart") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.6
        ...
        @oo0oO0
        public Float get(@oo0oO0 View view) {
            return Float.valueOf(o0O0o00O.o0O00O0o(view));
        }

        @Override // android.util.Property
        public void set(@oo0oO0 View view, @oo0oO0 Float f) {
            o0O0o00O.o00oo0O0.o00oOoo0(view, f.intValue(), view.getPaddingTop(), o0O0o00O.o0OoO00O(view), view.getPaddingBottom());
        }
    };
    public static final Property<View, Float> PADDING_END = new Property<View, Float>(Float.class, "paddingEnd") { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.7
        ...
        @oo0oO0
        public Float get(@oo0oO0 View view) {
            return Float.valueOf(o0O0o00O.o0OoO00O(view));
        }

        @Override // android.util.Property
        public void set(@oo0oO0 View view, @oo0oO0 Float f) {
            o0O0o00O.o00oo0O0.o00oOoo0(view, o0O0o00O.o0O00O0o(view), view.getPaddingTop(), f.intValue(), view.getPaddingBottom());
        }
    };
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues("paddingStart")) {
                ...
                propertyValues3[0].setFloatValues(o0O0o00O.o0O00O0o(ExtendedFloatingActionButton.this), this.size.getPaddingStart());
                currentMotionSpec.setPropertyValues("paddingStart", propertyValues3);
            }
            if (currentMotionSpec.hasPropertyValues("paddingEnd")) {
                PropertyValuesHolder[] propertyValues4 = currentMotionSpec.getPropertyValues("paddingEnd");
                propertyValues4[0].setFloatValues(o0O0o00O.o0OoO00O(ExtendedFloatingActionButton.this), this.size.getPaddingEnd());
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public void onChange(@o0OO00OO OnChangedCallback onChangedCallback) {
        ...
        public void performNow() {
            ...
            layoutParams.width = this.size.getLayoutParams().width;
            layoutParams.height = this.size.getLayoutParams().height;
            o0O0o00O.o0OO0o00(ExtendedFloatingActionButton.this, this.size.getPaddingStart(), ExtendedFloatingActionButton.this.getPaddingTop(), this.size.getPaddingEnd(), ExtendedFloatingActionButton.this.getPaddingBottom());
    ...
    /* loaded from: classes2.dex */
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.o00oOo00<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(@oo0oO0 Context context, @o0OO00OO AttributeSet attributeSet) {
        ...
        private boolean shouldUpdateVisibility(@oo0oO0 View view, @oo0oO0 ExtendedFloatingActionButton extendedFloatingActionButton) {
            return (this.autoHideEnabled || this.autoShrinkEnabled) && ((CoordinatorLayout.o00oo0) extendedFloatingActionButton.getLayoutParams()).o00oOo0O() == view.getId();
        }

        private boolean updateFabVisibilityForAppBarLayout(CoordinatorLayout coordinatorLayout, @oo0oO0 AppBarLayout appBarLayout, @oo0oO0 ExtendedFloatingActionButton extendedFloatingActionButton) {
        ...
        private boolean updateFabVisibilityForBottomSheet(@oo0oO0 View view, @oo0oO0 ExtendedFloatingActionButton extendedFloatingActionButton) {
            if (shouldUpdateVisibility(view, extendedFloatingActionButton)) {
                if (view.getTop() < (extendedFloatingActionButton.getHeight() / 2) + ((ViewGroup.MarginLayoutParams) ((CoordinatorLayout.o00oo0) extendedFloatingActionButton.getLayoutParams())).topMargin) {
                    shrinkOrHide(extendedFloatingActionButton);
                    return true;
                }
                extendOrShow(extendedFloatingActionButton);
        ...
        public void extendOrShow(@oo0oO0 ExtendedFloatingActionButton extendedFloatingActionButton) {
        ...
        public boolean getInsetDodgeRect(@oo0oO0 CoordinatorLayout coordinatorLayout, @oo0oO0 ExtendedFloatingActionButton extendedFloatingActionButton, @oo0oO0 Rect rect) {
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.o00oOo00
        public boolean onDependentViewChanged(CoordinatorLayout coordinatorLayout, @oo0oO0 ExtendedFloatingActionButton extendedFloatingActionButton, View view) {
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.o00oOo00
        public boolean onLayoutChild(@oo0oO0 CoordinatorLayout coordinatorLayout, @oo0oO0 ExtendedFloatingActionButton extendedFloatingActionButton, int i) {
        ...
        @o0o0000
        public void setInternalAutoHideCallback(@o0OO00OO OnChangedCallback onChangedCallback) {
            this.internalAutoHideCallback = onChangedCallback;
        }

        @o0o0000
        public void setInternalAutoShrinkCallback(@o0OO00OO OnChangedCallback onChangedCallback) {
            this.internalAutoShrinkCallback = onChangedCallback;
        }

        public void shrinkOrHide(@oo0oO0 ExtendedFloatingActionButton extendedFloatingActionButton) {
            boolean z = this.autoShrinkEnabled;
    ...
    public ExtendedFloatingActionButton(@oo0oO0 Context context) {
        this(context, null);
    }

    public ExtendedFloatingActionButton(@oo0oO0 Context context, @o0OO00OO AttributeSet attributeSet) {
    ...
    */
    public ExtendedFloatingActionButton(@o00oOooO.oo0oO0 android.content.Context r17, @o00oOooO.o0OO00OO android.util.AttributeSet r18, int r19) {
        /*
            r16 = this;
            r0 = r16
            r7 = r18
            ...
            r0.collapsedSize = r6
            int r6 = o0O000oo.o0O0o00O.o0O00O0o(r16)
            r0.extendedPaddingStart = r6
            int r6 = o0O000oo.o0O0o00O.o00oo0O0.o00oOo0O(r16)
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void performMotion(@oo0oO0 final MotionStrategy motionStrategy, @o0OO00OO final OnChangedCallback onChangedCallback) {
    ...
    private boolean shouldAnimateVisibilityChange() {
        return (o0O0o00O.o0O0Oooo(this) || (!isOrWillBeShown() && this.animateShowBeforeLayout)) && !isInEditMode();
    }

    public void addOnExtendAnimationListener(@oo0oO0 Animator.AnimatorListener animatorListener) {
    ...
    public void addOnShrinkAnimationListener(@oo0oO0 Animator.AnimatorListener animatorListener) {
    ...
    public void extend(@oo0oO0 OnChangedCallback onChangedCallback) {
        performMotion(this.extendStrategy, onChangedCallback);
    }

    @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.o00oOOoO
    @oo0oO0
    public CoordinatorLayout.o00oOo00<ExtendedFloatingActionButton> getBehavior() {
    ...
    public int getCollapsedSize() {
        ...
        return i < 0 ? (Math.min(o0O0o00O.o0O00O0o(this), o0O0o00O.o00oo0O0.o00oOo0O(this)) * 2) + getIconSize() : i;
    }
    ...
    public void hide(@oo0oO0 OnChangedCallback onChangedCallback) {
    ...
    public void removeOnExtendAnimationListener(@oo0oO0 Animator.AnimatorListener animatorListener) {
    ...
    public void removeOnShrinkAnimationListener(@oo0oO0 Animator.AnimatorListener animatorListener) {
    ...
    public void setExtendMotionSpec(@o0OO00OO MotionSpec motionSpec) {
        this.extendStrategy.setMotionSpec(motionSpec);
    }

    public void setExtendMotionSpecResource(@o0O0000O int i) {
    ...
    public void setPadding(int i, int i2, int i3, int i4) {
        ...
        this.extendedPaddingStart = o0O0o00O.o0O00O0o(this);
        this.extendedPaddingEnd = o0O0o00O.o00oo0O0.o00oOo0O(this);
    }
    ...
    public void setShrinkMotionSpec(@o0OO00OO MotionSpec motionSpec) {
        this.shrinkStrategy.setMotionSpec(motionSpec);
    }

    public void setShrinkMotionSpecResource(@o0O0000O int i) {
    ...
    @Override // android.widget.TextView
    public void setTextColor(@oo0oO0 ColorStateList colorStateList) {
    ...
    public void show(@oo0oO0 OnChangedCallback onChangedCallback) {
    ...
    public void shrink(@oo0oO0 OnChangedCallback onChangedCallback) {
        performMotion(this.shrinkStrategy, onChangedCallback);
    }

    public void silentlyUpdateTextColor(@oo0oO0 ColorStateList colorStateList) {
        super.setTextColor(colorStateList);
    }
}
