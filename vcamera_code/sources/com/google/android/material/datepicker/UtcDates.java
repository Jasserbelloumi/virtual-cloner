...
class UtcDates {
    ...
    private static int findCharactersInDateFormatPattern(@oo0oO0 String str, @oo0oO0 String str2, int i, int i2) {
    ...
    public static Calendar getUtcCalendarOf(@o0OO00OO Calendar calendar) {
    ...
    @oo0oO0
    private static String removeYearFromDateFormatPattern(@oo0oO0 String str) {
    ...
    public static void setTimeSource(@o0OO00OO TimeSource timeSource) {
