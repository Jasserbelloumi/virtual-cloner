...
public final class MaterialDatePicker<S> extends o00oOo00 {
    ...
    public static final class Builder<S> {
        ...
        public static <S> Builder<S> customDatePicker(@oo0oO0 DateSelector<S> dateSelector) {
        ...
        @oo0oO0
        public static Builder<oO0o0o<Long, Long>> dateRangePicker() {
        ...
        @oo0oO0
        public Builder<S> setTheme(@o0OOO0OO int i) {
            this.overrideThemeResId = i;
            return this;
        }

        @oo0oO0
        public Builder<S> setTitleText(@o0OOO0O int i) {
        ...
        @oo0oO0
        public Builder<S> setTitleText(@o0OO00OO CharSequence charSequence) {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{16842912}, o00oOo0o.o00oOo00.o00oOOoO(context, R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], o00oOo0o.o00oOo00.o00oOOoO(context, R.drawable.material_ic_edit_black_24dp));
        return stateListDrawable;
    }

    private static int getDialogPickerHeight(@oo0oO0 Context context) {
    ...
    private static int getPaddedPickerWidth(@oo0oO0 Context context) {
        Resources resources = context.getResources();
    ...
    private void initHeaderToggle(Context context) {
        ...
        o0O0o00O.o0O0oOo(this.headerToggleButton, null);
    ...
    public static boolean isFullscreen(@oo0oO0 Context context) {
        return readMaterialCalendarStyleBoolean(context, 16843277);
    }

    public static boolean isNestedScrollable(@oo0oO0 Context context) {
        return readMaterialCalendarStyleBoolean(context, R.attr.nestedScrollable);
    }

    @oo0oO0
    public static <S> MaterialDatePicker<S> newInstance(@oo0oO0 Builder<S> builder) {
    ...
    public static boolean readMaterialCalendarStyleBoolean(@oo0oO0 Context context, int i) {
    ...
    public void startPickerFragment() {
        ...
        updateHeader();
        o0O0oo0o o00oo0oO2 = getChildFragmentManager().o00oo0oO();
        o00oo0oO2.o00ooO0(R.id.mtrl_calendar_frame, this.pickerFragment);
        o00oo0oO2.o00oo0OO();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void updateToggleContentDescription(@oo0oO0 CheckableImageButton checkableImageButton) {
    ...
    @oo0oO0
    public final Dialog onCreateDialog(@o0OO00OO Bundle bundle) {
        ...
        this.background.setElevation(o0O0o00O.o00oooo(dialog.getWindow().getDecorView()));
        return dialog;
    }

    @Override // androidx.fragment.app.Fragment
    @oo0oO0
    public final View onCreateView(@oo0oO0 LayoutInflater layoutInflater, @o0OO00OO ViewGroup viewGroup, @o0OO00OO Bundle bundle) {
    ...
    public final void onDismiss(@oo0oO0 DialogInterface dialogInterface) {
