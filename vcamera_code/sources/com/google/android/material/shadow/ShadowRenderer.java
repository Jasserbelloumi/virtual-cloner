...
public class ShadowRenderer {
    ...
    public void drawCornerShadow(@oo0oO0 Canvas canvas, @o0OO00OO Matrix matrix, @oo0oO0 RectF rectF, int i, float f, float f2) {
        boolean z = f2 < 0.0f;
    ...
    public void drawEdgeShadow(@oo0oO0 Canvas canvas, @o0OO00OO Matrix matrix, @oo0oO0 RectF rectF, int i) {
        rectF.bottom += i;
        rectF.offset(0.0f, -i);
        int[] iArr = edgeColors;
    ...
    public void setShadowColor(int i) {
        this.shadowStartColor = oOO00OO.o00ooO(i, 68);
        this.shadowMiddleColor = oOO00OO.o00ooO(i, 20);
        this.shadowEndColor = oOO00OO.o00ooO(i, 0);
