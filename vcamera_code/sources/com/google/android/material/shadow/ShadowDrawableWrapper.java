...
public class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        ...
        this.shadowStartColor = o0.getColor(context, R.color.design_fab_shadow_start_color);
        this.shadowMiddleColor = o0.getColor(context, R.color.design_fab_shadow_mid_color);
        this.shadowEndColor = o0.getColor(context, R.color.design_fab_shadow_end_color);
    ...
    private void buildComponents(@oo0oO0 Rect rect) {
    ...
    private void drawShadow(@oo0oO0 Canvas canvas) {
        int i;
        float f;
        int i2;
        float f2;
