...
public class RippleUtils {
    ...
    @oo0oO0
    public static ColorStateList convertToRippleDrawableColor(@o0OO00OO ColorStateList colorStateList) {
    ...
    @o0O00O
    @TargetApi(21)
    private static int doubleAlpha(@o0O00O int i) {
        return oOO00OO.o00ooO(i, Math.min(Color.alpha(i) * 2, 255));
    }

    @o0O00O
    private static int getColorForState(@o0OO00OO ColorStateList colorStateList, int[] iArr) {
        int colorForState = colorStateList != null ? colorStateList.getColorForState(iArr, colorStateList.getDefaultColor()) : 0;
        return USE_FRAMEWORK_RIPPLE ? doubleAlpha(colorForState) : colorForState;
    }

    @oo0oO0
    public static ColorStateList sanitizeRippleDrawableColor(@o0OO00OO ColorStateList colorStateList) {
        return colorStateList != null ? colorStateList : ColorStateList.valueOf(0);
    }

    public static boolean shouldDrawRippleCompat(@oo0oO0 int[] iArr) {
        boolean z = false;
        boolean z2 = false;
        for (int i : iArr) {
            if (i == 16842910) {
