...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(@oo0oO0 Context context) {
        this(context, null);
    }

    public ForegroundLinearLayout(@oo0oO0 Context context, @o0OO00OO AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ForegroundLinearLayout(@oo0oO0 Context context, @o0OO00OO AttributeSet attributeSet, int i) {
    ...
    @Override // android.view.View
    public void setForeground(@o0OO00OO Drawable drawable) {
