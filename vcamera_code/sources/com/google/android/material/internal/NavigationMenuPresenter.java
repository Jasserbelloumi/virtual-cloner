...
public class NavigationMenuPresenter implements o00oo0O {
    private static final String STATE_ADAPTER = "android:menu:adapter";
    private static final String STATE_HEADER = "android:menu:header";
    private static final String STATE_HIERARCHY = "android:menu:list";
    public NavigationMenuAdapter adapter;
    private o00oo0O.o00oOOo0 callback;
    ...
    public final View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.google.android.material.internal.NavigationMenuPresenter.1
        ...
        public void onClick(View view) {
            ...
            o00oo0OO itemData = ((NavigationMenuItemView) view).getItemData();
    ...
    /* loaded from: classes2.dex */
    public class NavigationMenuAdapter extends RecyclerView.o00oo0OO<ViewHolder> {
        ...
        private void prepareMenuItems() {
            ...
            int i3 = 0;
            while (i2 < size) {
                o00oo0OO o00oo0oo = NavigationMenuPresenter.this.menu.getVisibleItems().get(i2);
                if (o00oo0oo.isChecked()) {
                    setCheckedItem(o00oo0oo);
                }
                if (o00oo0oo.isCheckable()) {
                    o00oo0oo.o00oo(false);
                }
                if (o00oo0oo.hasSubMenu()) {
                    o00ooO0 o00ooo02 = o00oo0oo.f700o00ooO0O;
                    if (o00ooo02.hasVisibleItems()) {
                        if (i2 != 0) {
                            this.items.add(new NavigationMenuSeparatorItem(NavigationMenuPresenter.this.paddingSeparator, 0));
                        }
                        this.items.add(new NavigationMenuTextItem(o00oo0oo));
                        int size2 = this.items.size();
                        int size3 = o00ooo02.size();
                        int i4 = 0;
                        boolean z3 = false;
                        while (i4 < size3) {
                            o00oo0OO o00oo0oo2 = (o00oo0OO) o00ooo02.getItem(i4);
                            if (o00oo0oo2.isVisible()) {
                                if (!z3 && o00oo0oo2.getIcon() != null) {
                                    z3 = z;
                                }
                                if (o00oo0oo2.isCheckable()) {
                                    o00oo0oo2.o00oo(false);
                                }
                                if (o00oo0oo.isChecked()) {
                                    setCheckedItem(o00oo0oo);
                                }
                                this.items.add(new NavigationMenuTextItem(o00oo0oo2));
                            }
                            i4++;
                            z = true;
                        }
                    ...
                    int i5 = o00oo0oo.f689o00oo00O;
                    if (i5 != i) {
                        i3 = this.items.size();
                        z2 = o00oo0oo.getIcon() != null;
                        if (i2 != 0) {
                            i3++;
                    ...
                    } else if (!z2 && o00oo0oo.getIcon() != null) {
                        appendTransparentIconIfMissing(i3, this.items.size());
                        z2 = true;
                    }
                    NavigationMenuTextItem navigationMenuTextItem = new NavigationMenuTextItem(o00oo0oo);
        ...
        public Bundle createInstanceState() {
            ...
            o00oo0OO o00oo0oo = this.checkedItem;
            if (o00oo0oo != null) {
                bundle.putInt(STATE_CHECKED_ITEM, o00oo0oo.f686o00oOooo);
            }
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (navigationMenuItem instanceof NavigationMenuTextItem) {
                    o00oo0OO menuItem = ((NavigationMenuTextItem) navigationMenuItem).getMenuItem();
                    View actionView = menuItem != null ? menuItem.getActionView() : null;
                    if (actionView != null) {
                        ParcelableSparseArray parcelableSparseArray = new ParcelableSparseArray();
                        actionView.saveHierarchyState(parcelableSparseArray);
                        sparseArray.put(menuItem.f686o00oOooo, parcelableSparseArray);
                    }
                }
            }
        ...
        public o00oo0OO getCheckedItem() {
        ...
        public void onBindViewHolder(@oo0oO0 ViewHolder viewHolder, int i) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    ((TextView) viewHolder.itemView).setText(((NavigationMenuTextItem) this.items.get(i)).getMenuItem().f691o00oo0O0);
                    return;
            ...
            o0O0o00O.o0O0ooo0(navigationMenuItemView, drawable != null ? drawable.getConstantState().newDrawable() : null);
        ...
        public void restoreInstanceState(@oo0oO0 Bundle bundle) {
            o00oo0OO menuItem;
            View actionView;
            ...
            if (i != 0) {
                ...
                while (true) {
                    ...
                    if ((navigationMenuItem instanceof NavigationMenuTextItem) && (menuItem2 = ((NavigationMenuTextItem) navigationMenuItem).getMenuItem()) != null && menuItem2.f686o00oOooo == i) {
            ...
            if (sparseParcelableArray != null) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if ((navigationMenuItem2 instanceof NavigationMenuTextItem) && (menuItem = ((NavigationMenuTextItem) navigationMenuItem2).getMenuItem()) != null && (actionView = menuItem.getActionView()) != null && (parcelableSparseArray = (ParcelableSparseArray) sparseParcelableArray.get(menuItem.f686o00oOooo)) != null) {
        ...
        public void setCheckedItem(@oo0oO0 o00oo0OO o00oo0oo) {
            if (this.checkedItem == o00oo0oo || !o00oo0oo.isCheckable()) {
                return;
            }
            o00oo0OO o00oo0oo2 = this.checkedItem;
            if (o00oo0oo2 != null) {
                o00oo0oo2.setChecked(false);
            }
            this.checkedItem = o00oo0oo;
            o00oo0oo.setChecked(true);
        }
    ...
    public static class NavigationMenuTextItem implements NavigationMenuItem {
        private final o00oo0OO menuItem;
        public boolean needsEmptyIcon;

        public NavigationMenuTextItem(o00oo0OO o00oo0oo) {
            this.menuItem = o00oo0oo;
        }

        public o00oo0OO getMenuItem() {
            return this.menuItem;
        }
    }

    /* loaded from: classes2.dex */
    public class NavigationMenuViewAccessibilityDelegate extends o0oO0Ooo {
        public NavigationMenuViewAccessibilityDelegate(@oo0oO0 RecyclerView recyclerView) {
            super(recyclerView);
        }

        @Override // androidx.recyclerview.widget.o0oO0Ooo, o0O000oo.o00oOOoO
        public void onInitializeAccessibilityNodeInfo(View view, @oo0oO0 o0O00.o00oo0O o00oo0o2) {
            super.onInitializeAccessibilityNodeInfo(view, o00oo0o2);
            o00oo0o2.o0O0OooO(o00oo0O.o00oOo00.o00oOo0O(NavigationMenuPresenter.this.adapter.getRowCount(), 0, false));
        }
    }

    /* loaded from: classes2.dex */
    public static class NormalViewHolder extends ViewHolder {
        public NormalViewHolder(@oo0oO0 LayoutInflater layoutInflater, ViewGroup viewGroup, View.OnClickListener onClickListener) {
    ...
    public static class SeparatorViewHolder extends ViewHolder {
        public SeparatorViewHolder(@oo0oO0 LayoutInflater layoutInflater, ViewGroup viewGroup) {
    ...
    public static class SubheaderViewHolder extends ViewHolder {
        public SubheaderViewHolder(@oo0oO0 LayoutInflater layoutInflater, ViewGroup viewGroup) {
            super(layoutInflater.inflate(R.layout.design_navigation_item_subheader, viewGroup, false));
        }
    }

    /* loaded from: classes2.dex */
    public static abstract class ViewHolder extends RecyclerView.o0O00oO0 {
    ...
    public void dispatchApplyWindowInsets(@oo0oO0 o0OOo000 o0ooo000) {
        int o00oo0Oo2 = o0ooo000.o00oo0Oo();
        if (this.paddingTopDefault != o00oo0Oo2) {
            this.paddingTopDefault = o00oo0Oo2;
            updateTopPadding();
        }
        NavigationMenuView navigationMenuView = this.menuView;
        navigationMenuView.setPadding(0, navigationMenuView.getPaddingTop(), 0, o0ooo000.o00oo0OO());
        o0O0o00O.o00oo0O0(this.headerLayout, o0ooo000);
    }
    ...
    @Override // androidx.appcompat.view.menu.o00oo0O
    public void initForMenu(@oo0oO0 Context context, @oo0oO0 o00oOoO o00oooo2) {
    ...
    public void onCloseMenu(o00oOoO o00oooo2, boolean z) {
        o00oo0O.o00oOOo0 o00oooo02 = this.callback;
        if (o00oooo02 != null) {
    ...
    public void setCallback(o00oo0O.o00oOOo0 o00oooo02) {
        this.callback = o00oooo02;
    }

    public void setCheckedItem(@oo0oO0 o00oo0OO o00oo0oo) {
        this.adapter.setCheckedItem(o00oo0oo);
    }
