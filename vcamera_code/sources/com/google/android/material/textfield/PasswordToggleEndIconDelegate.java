...
public class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    public PasswordToggleEndIconDelegate(@oo0oO0 TextInputLayout textInputLayout) {
    ...
    public void initialize() {
        this.textInputLayout.setEndIconDrawable(o00oOo00.o00oOOoO(this.context, R.drawable.design_password_eye));
