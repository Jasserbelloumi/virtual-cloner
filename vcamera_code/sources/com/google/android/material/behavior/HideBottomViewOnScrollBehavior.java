...
public class HideBottomViewOnScrollBehavior<V extends View> extends CoordinatorLayout.o00oOo00<V> {
    ...
    private void animateChildTo(@oo0oO0 V v, int i, long j, TimeInterpolator timeInterpolator) {
    ...
    @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.o00oOo00
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, @oo0oO0 V v, @oo0oO0 View view, int i, int i2, int i3, int i4, int i5, @oo0oO0 int[] iArr) {
        if (i2 > 0) {
            slideDown(v);
        } else if (i2 < 0) {
            slideUp(v);
    ...
    public void setAdditionalHiddenOffsetY(@oo0oO0 V v, @o0O0O0O int i) {
    ...
    public void slideDown(@oo0oO0 V v) {
        if (this.currentState == 1) {
            return;
        }
    ...
    public void slideUp(@oo0oO0 V v) {
