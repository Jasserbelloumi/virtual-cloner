...
public final class MaterialTimePicker extends o00oOo00 {
    ...
    public static final class Builder {
        ...
        @oo0oO0
        public Builder setHour(@o0O0o00O(from = 0, to = 23) int i) {
        ...
        @oo0oO0
        public Builder setMinute(@o0O0o00O(from = 0, to = 60) int i) {
        ...
        @oo0oO0
        public Builder setTitleText(@o0OOO0O int i) {
            this.titleTextResId = i;
            return this;
        }

        @oo0oO0
        public Builder setTitleText(@o0OO00OO CharSequence charSequence) {
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        if (i != 0) {
            ...
            throw new IllegalArgumentException(o00oOOo0.o00oOOo0("no icon for mode: ", i));
        }
    ...
    @oo0oO0
    public static MaterialTimePicker newInstance(@oo0oO0 Builder builder) {
    ...
    private void restoreState(@o0OO00OO Bundle bundle) {
        if (bundle == null) {
            return;
        }
    ...
    public boolean addOnCancelListener(@oo0oO0 DialogInterface.OnCancelListener onCancelListener) {
        return this.cancelListeners.add(onCancelListener);
    }

    public boolean addOnDismissListener(@oo0oO0 DialogInterface.OnDismissListener onDismissListener) {
        return this.dismissListeners.add(onDismissListener);
    }

    public boolean addOnNegativeButtonClickListener(@oo0oO0 View.OnClickListener onClickListener) {
        return this.negativeButtonListeners.add(onClickListener);
    }

    public boolean addOnPositiveButtonClickListener(@oo0oO0 View.OnClickListener onClickListener) {
    ...
    public boolean removeOnCancelListener(@oo0oO0 DialogInterface.OnCancelListener onCancelListener) {
        return this.cancelListeners.remove(onCancelListener);
    }

    public boolean removeOnDismissListener(@oo0oO0 DialogInterface.OnDismissListener onDismissListener) {
        return this.dismissListeners.remove(onDismissListener);
    }

    public boolean removeOnNegativeButtonClickListener(@oo0oO0 View.OnClickListener onClickListener) {
        return this.negativeButtonListeners.remove(onClickListener);
    }

    public boolean removeOnPositiveButtonClickListener(@oo0oO0 View.OnClickListener onClickListener) {
