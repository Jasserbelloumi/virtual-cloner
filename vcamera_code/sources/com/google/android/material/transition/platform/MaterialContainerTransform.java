...
public final class MaterialContainerTransform extends Transition {
    ...
    */
    private static void captureValues(@o00oOooO.oo0oO0 android.transition.TransitionValues r2, @o00oOooO.o0OO00OO android.view.View r3, @o00oOooO.oo0OOoo int r4, @o00oOooO.o0OO00OO com.google.android.material.shape.ShapeAppearanceModel r5) {
        /*
            r0 = -1
            if (r4 == r0) goto Lc
    ...
    public void captureEndValues(@oo0oO0 TransitionValues transitionValues) {
        captureValues(transitionValues, this.endView, this.endViewId, this.endShapeAppearanceModel);
    }

    @Override // android.transition.Transition
    public void captureStartValues(@oo0oO0 TransitionValues transitionValues) {
        captureValues(transitionValues, this.startView, this.startViewId, this.startShapeAppearanceModel);
    }

    @Override // android.transition.Transition
    @o0OO00OO
    public Animator createAnimator(@oo0oO0 ViewGroup viewGroup, @o0OO00OO TransitionValues transitionValues, @o0OO00OO TransitionValues transitionValues2) {
            ...
            if (rectF != null && shapeAppearanceModel != null) {
                ...
                if (rectF2 != null && shapeAppearanceModel2 != null) {
                    ...
                    addListener(new TransitionListenerAdapter() { // from class: com.google.android.material.transition.platform.MaterialContainerTransform.2
                        ...
                        public void onTransitionEnd(@oo0oO0 Transition transition) {
                        ...
                        @Override // com.google.android.material.transition.platform.TransitionListenerAdapter, android.transition.Transition.TransitionListener
                        public void onTransitionStart(@oo0oO0 Transition transition) {
