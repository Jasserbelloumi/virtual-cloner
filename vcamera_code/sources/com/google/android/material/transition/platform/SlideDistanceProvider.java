...
public final class SlideDistanceProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createTranslationAppearAnimator(View view, View view2, int i, @o0OO0 int i2) {
                ...
                if (i != 48) {
                    if (i != 80) {
                        if (i == 8388611) {
                            ...
                            throw new IllegalArgumentException(o00oOOo0.o00oOOo0("Invalid slide direction: ", i));
                        }
                    }
    ...
    private static Animator createTranslationDisappearAnimator(View view, View view2, int i, @o0OO0 int i2) {
        float translationX = view2.getTranslationX();
        float translationY = view2.getTranslationY();
        if (i != 3) {
            if (i != 5) {
    ...
    public void setSlideDistance(@o0OO0 int i) {
        if (i < 0) {
