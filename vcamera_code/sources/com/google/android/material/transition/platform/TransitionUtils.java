...
class TransitionUtils {
    ...
    public static void maybeAddTransition(TransitionSet transitionSet, @o0OO00OO Transition transition) {
        if (transition != null) {
            transitionSet.addTransition(transition);
        }
    }

    public static void maybeRemoveTransition(TransitionSet transitionSet, @o0OO00OO Transition transition) {
        if (transition != null) {
