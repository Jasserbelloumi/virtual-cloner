...
public class ChipGroup extends FlowLayout {
    ...
    public class CheckedStateTracker implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(@oo0oO0 CompoundButton compoundButton, boolean z) {
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(ChipGroup chipGroup, @oo0OOoo int i);
    }
    ...
    */
    public ChipGroup(android.content.Context r8, android.util.AttributeSet r9, int r10) {
        ...
        L69:
            ...
            r8 = 1
            o0O000oo.o0O0o00O.o0OO00OO(r7, r8)
            return
        */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setCheckedStateForView(@oo0OOoo int i, boolean z) {
    ...
    public int getIndexOfChip(@o0OO00OO View view) {
        if (view instanceof Chip) {
            int i = 0;
            for (int i2 = 0; i2 < getChildCount(); i2++) {
                if (getChildAt(i2) instanceof Chip) {
    ...
    public void onInitializeAccessibilityNodeInfo(@oo0oO0 AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        o00oo0O.o0OO0Ooo(accessibilityNodeInfo).o0O0OooO(o00oo0O.o00oOo00.o00oOo0o(getRowCount(), isSingleLine() ? getChipCount() : -1, false, isSingleSelection() ? 1 : 2));
    }

    public void setChipSpacing(@o0O0O0O int i) {
        setChipSpacingHorizontal(i);
        setChipSpacingVertical(i);
    }

    public void setChipSpacingHorizontal(@o0O0O0O int i) {
    ...
    public void setChipSpacingHorizontalResource(@o0O00oO0 int i) {
        setChipSpacingHorizontal(getResources().getDimensionPixelOffset(i));
    }

    public void setChipSpacingResource(@o0O00oO0 int i) {
        setChipSpacing(getResources().getDimensionPixelOffset(i));
    }

    public void setChipSpacingVertical(@o0O0O0O int i) {
    ...
    public void setChipSpacingVerticalResource(@o0O00oO0 int i) {
    ...
    @Deprecated
    public void setDividerDrawableVertical(@o0OO00OO Drawable drawable) {
        throw new UnsupportedOperationException("Changing divider drawables have no effect. ChipGroup do not use divider drawables as spacing.");
    }
    ...
    public void setSingleLine(@o0O00 int i) {
