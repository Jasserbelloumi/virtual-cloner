...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(@oo0oO0 View view, boolean z, boolean z2, @oo0oO0 List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    @oo0oO0
    public AnimatorSet onCreateExpandedStateChangeAnimation(@oo0oO0 View view, @oo0oO0 final View view2, final boolean z, boolean z2) {
    ...
    public boolean onTouchEvent(@oo0oO0 CoordinatorLayout coordinatorLayout, @oo0oO0 View view, @oo0oO0 MotionEvent motionEvent) {
