...
public class SignInClientImpl extends GmsClient<zaf> implements com.google.android.gms.signin.zae {
    ...
    public SignInClientImpl(@oo0oO0 Context context, @oo0oO0 Looper looper, boolean z, @oo0oO0 ClientSettings clientSettings, @oo0oO0 Bundle bundle, @oo0oO0 GoogleApiClient.ConnectionCallbacks connectionCallbacks, @oo0oO0 GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
    ...
    @oo0oO0
    @KeepForSdk
    public static Bundle createBundleFromClientSettings(@oo0oO0 ClientSettings clientSettings) {
        clientSettings.zaa();
    ...
    @oo0oO0
    public final /* synthetic */ IInterface createServiceInterface(@oo0oO0 IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
    ...
    @Override // com.google.android.gms.signin.zae
    public final void zac(@oo0oO0 IAccountAccessor iAccountAccessor, boolean z) {
        try {
