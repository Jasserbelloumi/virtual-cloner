...
public class ProviderInstaller {
    ...
    @o0O0OOOo("ProviderInstaller.lock")
    ...
    public interface ProviderInstallListener {
        void onProviderInstallFailed(int i, @o0OO00OO Intent intent);

        void onProviderInstalled();
    }

    public static void installIfNeeded(@oo0oO0 Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        Context context2;
    ...
    public static void installIfNeededAsync(@oo0oO0 Context context, @oo0oO0 ProviderInstallListener providerInstallListener) {
        Preconditions.checkNotNull(context, "Context must not be null");
