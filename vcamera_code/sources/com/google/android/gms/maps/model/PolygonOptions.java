...
public final class PolygonOptions extends AbstractSafeParcelable {
    ...
    @oo0oO0
    public PolygonOptions add(@oo0oO0 LatLng latLng) {
    ...
    @oo0oO0
    public PolygonOptions add(@oo0oO0 LatLng... latLngArr) {
    ...
    @oo0oO0
    public PolygonOptions addAll(@oo0oO0 Iterable<LatLng> iterable) {
    ...
    @oo0oO0
    public PolygonOptions addHole(@oo0oO0 Iterable<LatLng> iterable) {
        Preconditions.checkNotNull(iterable, "points must not be null.");
    ...
    @oo0oO0
    public PolygonOptions strokePattern(@o0OO00OO List<PatternItem> list) {
        this.zzk = list;
        return this;
    }
