...
public final class GroundOverlayOptions extends AbstractSafeParcelable {
    ...
    @oo0oO0
    public GroundOverlayOptions image(@oo0oO0 BitmapDescriptor bitmapDescriptor) {
    ...
    @oo0oO0
    public GroundOverlayOptions position(@oo0oO0 LatLng latLng, float f) {
    ...
    @oo0oO0
    public GroundOverlayOptions position(@oo0oO0 LatLng latLng, float f, float f2) {
        Preconditions.checkState(this.zze == null, "Position has already been set using positionFromBounds");
        Preconditions.checkArgument(latLng != null, "Location must be specified");
        Preconditions.checkArgument(f >= 0.0f, "Width must be non-negative");
    ...
    @oo0oO0
    public GroundOverlayOptions positionFromBounds(@oo0oO0 LatLngBounds latLngBounds) {
