...
public final class BitmapDescriptorFactory {
    ...
    @oo0oO0
    public static BitmapDescriptor fromAsset(@oo0oO0 String str) {
    ...
    @oo0oO0
    public static BitmapDescriptor fromBitmap(@oo0oO0 Bitmap bitmap) {
    ...
    @oo0oO0
    public static BitmapDescriptor fromFile(@oo0oO0 String str) {
    ...
    @oo0oO0
    public static BitmapDescriptor fromPath(@oo0oO0 String str) {
