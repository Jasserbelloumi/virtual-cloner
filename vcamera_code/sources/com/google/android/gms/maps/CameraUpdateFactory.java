...
public final class CameraUpdateFactory {
    ...
    @oo0oO0
    public static CameraUpdate newCameraPosition(@oo0oO0 CameraPosition cameraPosition) {
    ...
    @oo0oO0
    public static CameraUpdate newLatLng(@oo0oO0 LatLng latLng) {
    ...
    @oo0oO0
    public static CameraUpdate newLatLngBounds(@oo0oO0 LatLngBounds latLngBounds, int i) {
    ...
    @oo0oO0
    public static CameraUpdate newLatLngBounds(@oo0oO0 LatLngBounds latLngBounds, int i, int i2, int i3) {
        Preconditions.checkNotNull(latLngBounds, "bounds must not be null");
        try {
    ...
    @oo0oO0
    public static CameraUpdate newLatLngZoom(@oo0oO0 LatLng latLng, float f) {
        Preconditions.checkNotNull(latLng, "latLng must not be null");
        try {
    ...
    @oo0oO0
    public static CameraUpdate zoomBy(float f, @oo0oO0 Point point) {
    ...
    public static void zza(@oo0oO0 ICameraUpdateFactoryDelegate iCameraUpdateFactoryDelegate) {
