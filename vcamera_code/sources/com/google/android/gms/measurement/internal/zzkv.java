...
public final class zzkv extends zzkh {
    ...
    public final long zzd(byte[] bArr) {
        ...
        if (zzF == null) {
            o00oOOo0.o00oOOo0(this.zzt, "Failed to get MD5");
            return 0L;
        }
    ...
    public final String zzm(com.google.android.gms.internal.measurement.zzgb zzgbVar) {
        ...
        for (com.google.android.gms.internal.measurement.zzgd zzgdVar : zzgbVar.zzd()) {
            if (zzgdVar != null) {
                zzF(o00oOOo02, 1);
                o00oOOo02.append("bundle {\n");
                if (zzgdVar.zzbj()) {
                    zzI(o00oOOo02, 1, "protocol_version", Integer.valueOf(zzgdVar.zzd()));
                }
                zzpd.zzc();
                if (this.zzt.zzf().zzs(null, zzdu.zzal) && this.zzt.zzf().zzs(zzgdVar.zzx(), zzdu.zzan) && zzgdVar.zzbm()) {
                    zzI(o00oOOo02, 1, "session_stitching_token", zzgdVar.zzK());
                }
                zzI(o00oOOo02, 1, "platform", zzgdVar.zzI());
                if (zzgdVar.zzbf()) {
                    zzI(o00oOOo02, 1, "gmp_version", Long.valueOf(zzgdVar.zzm()));
                }
                if (zzgdVar.zzbq()) {
                    zzI(o00oOOo02, 1, "uploading_gmp_version", Long.valueOf(zzgdVar.zzr()));
                }
                if (zzgdVar.zzbd()) {
                    zzI(o00oOOo02, 1, "dynamite_version", Long.valueOf(zzgdVar.zzj()));
                }
                if (zzgdVar.zzba()) {
                    zzI(o00oOOo02, 1, "config_version", Long.valueOf(zzgdVar.zzh()));
                }
                zzI(o00oOOo02, 1, "gmp_app_id", zzgdVar.zzF());
                zzI(o00oOOo02, 1, "admob_app_id", zzgdVar.zzw());
                zzI(o00oOOo02, 1, "app_id", zzgdVar.zzx());
                zzI(o00oOOo02, 1, "app_version", zzgdVar.zzA());
                if (zzgdVar.zzaY()) {
                    zzI(o00oOOo02, 1, "app_version_major", Integer.valueOf(zzgdVar.zza()));
                }
                zzI(o00oOOo02, 1, "firebase_instance_id", zzgdVar.zzE());
                if (zzgdVar.zzbc()) {
                    zzI(o00oOOo02, 1, "dev_cert_hash", Long.valueOf(zzgdVar.zzi()));
                }
                zzI(o00oOOo02, 1, "app_store", zzgdVar.zzz());
                if (zzgdVar.zzbp()) {
                    zzI(o00oOOo02, 1, "upload_timestamp_millis", Long.valueOf(zzgdVar.zzq()));
                }
                if (zzgdVar.zzbn()) {
                    zzI(o00oOOo02, 1, "start_timestamp_millis", Long.valueOf(zzgdVar.zzp()));
                }
                if (zzgdVar.zzbe()) {
                    zzI(o00oOOo02, 1, "end_timestamp_millis", Long.valueOf(zzgdVar.zzk()));
                }
                if (zzgdVar.zzbi()) {
                    zzI(o00oOOo02, 1, "previous_bundle_start_timestamp_millis", Long.valueOf(zzgdVar.zzo()));
                }
                if (zzgdVar.zzbh()) {
                    zzI(o00oOOo02, 1, "previous_bundle_end_timestamp_millis", Long.valueOf(zzgdVar.zzn()));
                }
                zzI(o00oOOo02, 1, "app_instance_id", zzgdVar.zzy());
                zzI(o00oOOo02, 1, "resettable_device_id", zzgdVar.zzJ());
                zzI(o00oOOo02, 1, "ds_id", zzgdVar.zzD());
                if (zzgdVar.zzbg()) {
                    zzI(o00oOOo02, 1, "limited_ad_tracking", Boolean.valueOf(zzgdVar.zzaW()));
                }
                zzI(o00oOOo02, 1, "os_version", zzgdVar.zzH());
                zzI(o00oOOo02, 1, "device_model", zzgdVar.zzC());
                zzI(o00oOOo02, 1, "user_default_language", zzgdVar.zzL());
                if (zzgdVar.zzbo()) {
                    zzI(o00oOOo02, 1, "time_zone_offset_minutes", Integer.valueOf(zzgdVar.zzf()));
                }
                if (zzgdVar.zzaZ()) {
                    zzI(o00oOOo02, 1, "bundle_sequential_index", Integer.valueOf(zzgdVar.zzb()));
                }
                if (zzgdVar.zzbl()) {
                    zzI(o00oOOo02, 1, "service_upload", Boolean.valueOf(zzgdVar.zzaX()));
                }
                zzI(o00oOOo02, 1, "health_monitor", zzgdVar.zzG());
                if (zzgdVar.zzbk()) {
                    zzI(o00oOOo02, 1, "retry_counter", Integer.valueOf(zzgdVar.zze()));
                }
                if (zzgdVar.zzbb()) {
                    zzI(o00oOOo02, 1, "consent_signals", zzgdVar.zzB());
                }
                ...
                if (zzO != null) {
                    for (com.google.android.gms.internal.measurement.zzgm zzgmVar : zzO) {
                        if (zzgmVar != null) {
                            zzF(o00oOOo02, 2);
                            o00oOOo02.append("user_property {\n");
                            zzI(o00oOOo02, 2, "set_timestamp_millis", zzgmVar.zzs() ? Long.valueOf(zzgmVar.zzc()) : null);
                            zzI(o00oOOo02, 2, "name", this.zzt.zzj().zzf(zzgmVar.zzf()));
                            zzI(o00oOOo02, 2, "string_value", zzgmVar.zzg());
                            zzI(o00oOOo02, 2, "int_value", zzgmVar.zzr() ? Long.valueOf(zzgmVar.zzb()) : null);
                            zzI(o00oOOo02, 2, "double_value", zzgmVar.zzq() ? Double.valueOf(zzgmVar.zza()) : null);
                            zzF(o00oOOo02, 2);
                            o00oOOo02.append("}\n");
                        }
                    }
                ...
                if (zzM != null) {
                    for (com.google.android.gms.internal.measurement.zzfp zzfpVar : zzM) {
                        if (zzfpVar != null) {
                            zzF(o00oOOo02, 2);
                            o00oOOo02.append("audience_membership {\n");
                            if (zzfpVar.zzk()) {
                                zzI(o00oOOo02, 2, "audience_id", Integer.valueOf(zzfpVar.zza()));
                            }
                            if (zzfpVar.zzm()) {
                                zzI(o00oOOo02, 2, "new_audience", Boolean.valueOf(zzfpVar.zzj()));
                            }
                            zzH(o00oOOo02, 2, "current_data", zzfpVar.zzd());
                            if (zzfpVar.zzn()) {
                                zzH(o00oOOo02, 2, "previous_data", zzfpVar.zze());
                            }
                            zzF(o00oOOo02, 2);
                            o00oOOo02.append("}\n");
                        }
                ...
                if (zzN != null) {
                    for (com.google.android.gms.internal.measurement.zzft zzftVar : zzN) {
                        if (zzftVar != null) {
                            ...
                            zzI(o00oOOo02, 2, "name", this.zzt.zzj().zzd(zzftVar.zzh()));
                            if (zzftVar.zzu()) {
                                zzI(o00oOOo02, 2, "timestamp_millis", Long.valueOf(zzftVar.zzd()));
                            }
                            if (zzftVar.zzt()) {
                                zzI(o00oOOo02, 2, "previous_timestamp_millis", Long.valueOf(zzftVar.zzc()));
                            }
                            if (zzftVar.zzs()) {
                                zzI(o00oOOo02, 2, "count", Integer.valueOf(zzftVar.zza()));
                            }
                            if (zzftVar.zzb() != 0) {
                                zzD(o00oOOo02, 2, zzftVar.zzi());
                            }
                            zzF(o00oOOo02, 2);
                            o00oOOo02.append("}\n");
                        }
    ...
    public final String zzo(com.google.android.gms.internal.measurement.zzek zzekVar) {
        ...
        StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("\nevent_filter {\n");
        if (zzekVar.zzp()) {
            zzI(o00oOOo02, 0, "filter_id", Integer.valueOf(zzekVar.zzb()));
        }
        zzI(o00oOOo02, 0, "event_name", this.zzt.zzj().zzd(zzekVar.zzg()));
        String zzG = zzG(zzekVar.zzk(), zzekVar.zzm(), zzekVar.zzn());
        if (!zzG.isEmpty()) {
            zzI(o00oOOo02, 0, "filter_type", zzG);
        }
        if (zzekVar.zzo()) {
            zzJ(o00oOOo02, 1, "event_count_filter", zzekVar.zzf());
        }
        if (zzekVar.zza() > 0) {
            o00oOOo02.append("  filters {\n");
            for (com.google.android.gms.internal.measurement.zzem zzemVar : zzekVar.zzh()) {
                zzE(o00oOOo02, 2, zzemVar);
            }
        }
        zzF(o00oOOo02, 1);
        o00oOOo02.append("}\n}\n");
    ...
    public final String zzp(com.google.android.gms.internal.measurement.zzet zzetVar) {
        ...
        StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("\nproperty_filter {\n");
        if (zzetVar.zzj()) {
            zzI(o00oOOo02, 0, "filter_id", Integer.valueOf(zzetVar.zza()));
        }
        zzI(o00oOOo02, 0, "property_name", this.zzt.zzj().zzf(zzetVar.zze()));
        String zzG = zzG(zzetVar.zzg(), zzetVar.zzh(), zzetVar.zzi());
        if (!zzG.isEmpty()) {
            zzI(o00oOOo02, 0, "filter_type", zzG);
        }
        zzE(o00oOOo02, 1, zzetVar.zzb());
        o00oOOo02.append("}\n");
        return o00oOOo02.toString();
    }
