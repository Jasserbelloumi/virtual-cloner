...
public final class zzd extends zze {
    ...
    public static /* synthetic */ void zzb(zzd zzdVar, String str, long j) {
        ...
        if (l == null) {
            o00oOOo0.o00oOOo0(zzdVar.zzt, "First ad unit exposure time was never set");
        } else {
        ...
        if (zzdVar.zzb.isEmpty()) {
            long j2 = zzdVar.zzc;
            if (j2 == 0) {
                o00oOOo0.o00oOOo0(zzdVar.zzt, "First ad exposure time was never set");
                return;
            }
            zzdVar.zzh(j - j2, zzj);
            zzdVar.zzc = 0L;
    ...
    public final void zzd(String str, long j) {
        if (str == null || str.length() == 0) {
            o00oOOo0.o00oOOo0(this.zzt, "Ad unit id must be a non-empty string");
        } else {
