...
public final class zzgj extends zzdw {
    ...
    public final void zzv(zzaw zzawVar, zzq zzqVar) {
        ...
        String str3 = zzqVar.zza;
        com.google.android.gms.internal.measurement.zzc zzcVar = TextUtils.isEmpty(str3) ? null : (com.google.android.gms.internal.measurement.zzc) zzo.zzd.get(str3);
        if (zzcVar != null) {
            try {
                ...
                if (zzcVar.zze(new com.google.android.gms.internal.measurement.zzaa(zza, zzawVar.zzd, zzs))) {
                    if (zzcVar.zzg()) {
                        ...
                        zzawVar = this.zza.zzu().zzi(zzcVar.zza().zzb());
                    }
                    zzA(zzawVar, zzqVar);
                    if (zzcVar.zzf()) {
