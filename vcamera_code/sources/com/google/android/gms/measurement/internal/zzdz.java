...
public final class zzdz extends SQLiteOpenHelper {
    ...
    public final SQLiteDatabase getWritableDatabase() throws SQLiteException {
        try {
            ...
            o00oOOo0.o00oOOo0(this.zza.zzt, "Opening the local database failed, dropping and recreating it");
            this.zza.zzt.zzf();
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        zzan.zza(this.zza.zzt.zzay(), sQLiteDatabase, oOo000Oo.o00oo0OO.f9381o00oOoo0, "create table if not exists messages ( type INTEGER NOT NULL, entry BLOB NOT NULL)", "type,entry", null);
    }
