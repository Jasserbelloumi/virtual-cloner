...
public final class zzam extends zzkh {
                        ...
                        try {
                            ...
                            try {
                                try {
                                    ...
                                    Cursor query2 = zzh2.query("raw_events", new String[]{"rowid", "name", oOo000Oo.o00oo0OO.f9386o00oo0O0, "data"}, str2, strArr, null, null, "rowid", null);
    ...
    */
    ...
    public final Object zzq(Cursor cursor, int i) {
        ...
        if (type == 0) {
            o00oOOo0.o00oOOo0(this.zzt, "Loaded invalid null value from database");
            return null;
        } else if (type != 1) {
            if (type != 2) {
                if (type != 3) {
                    ...
                    o00oOOo0.o00oOOo0(this.zzt, "Loaded invalid blob type value, ignoring it");
                    return null;
                }
    ...
    */
    ...
    public final void zzy(List list) {
        ...
        if (zzI()) {
            String o00oOOo02 = o00oOoO.o00oOOo0("(", TextUtils.join(",", list), ")");
            if (zzZ(o00oOoO.o00oOOo0("SELECT COUNT(1) FROM queue WHERE rowid IN ", o00oOOo02, " AND retry_count =  2147483647 LIMIT 1"), null) > 0) {
                this.zzt.zzay().zzk().zza("The number of upload retries exceeds the limit. Will remain unchanged.");
            }
            try {
                SQLiteDatabase zzh2 = zzh();
                zzh2.execSQL("UPDATE queue SET retry_count = IFNULL(retry_count, 0) + 1 WHERE rowid IN " + o00oOOo02 + " AND (retry_count IS NULL OR retry_count < 2147483647)");
            } catch (SQLiteException e) {
