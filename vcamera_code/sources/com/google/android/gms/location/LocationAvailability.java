...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = SessionDescription.SUPPORTED_SDP_VERSION, getter = "getElapsedRealtimeNs", id = 3)
    ...
    @o0OO00OO
    public static LocationAvailability extractLocationAvailability(@oo0oO0 Intent intent) {
    ...
    public static boolean hasLocationAvailability(@o0OO00OO Intent intent) {
