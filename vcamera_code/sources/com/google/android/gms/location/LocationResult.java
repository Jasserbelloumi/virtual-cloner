...
public final class LocationResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @oo0oO0
    public static LocationResult create(@oo0oO0 List<Location> list) {
        if (list == null) {
            list = zza;
        }
    ...
    @o0OO00OO
    public static LocationResult extractResult(@oo0oO0 Intent intent) {
        if (hasResult(intent)) {
    ...
    public static boolean hasResult(@oo0oO0 Intent intent) {
        if (intent == null) {
            return false;
        }
    ...
    */
    public boolean equals(@o00oOooO.o0OO00OO java.lang.Object r9) {
        /*
            r8 = this;
