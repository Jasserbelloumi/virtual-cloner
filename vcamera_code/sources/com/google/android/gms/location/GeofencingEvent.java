...
public class GeofencingEvent {
    ...
    private GeofencingEvent(int i, @Geofence.GeofenceTransition int i2, @o0OO00OO List list, @o0OO00OO Location location) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = list;
        this.zzd = location;
    ...
    */
    public static com.google.android.gms.location.GeofencingEvent fromIntent(@o00oOooO.oo0oO0 android.content.Intent r12) {
        /*
            r0 = 0
            if (r12 != 0) goto L4
            return r0
