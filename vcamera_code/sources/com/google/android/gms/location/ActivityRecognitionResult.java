...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @VisibleForTesting
    public ActivityRecognitionResult(@oo0oO0 DetectedActivity detectedActivity, long j, long j2) {
        this(Collections.singletonList(detectedActivity), j, j2, 0, null);
    }

    public ActivityRecognitionResult(@oo0oO0 List<DetectedActivity> list, long j, long j2) {
        this(list, j, j2, 0, null);
    }

    @ShowFirstParty
    @SafeParcelable.Constructor
    public ActivityRecognitionResult(@SafeParcelable.Param(id = 1) @oo0oO0 List list, @SafeParcelable.Param(id = 2) long j, @SafeParcelable.Param(id = 3) long j2, @SafeParcelable.Param(id = 4) int i, @SafeParcelable.Param(id = 5) @o0OO00OO Bundle bundle) {
        boolean z = true;
    ...
    */
    public static com.google.android.gms.location.ActivityRecognitionResult extractResult(@o00oOooO.oo0oO0 android.content.Intent r3) {
        /*
    ...
    @o0OO00OO
    public static List zza(@oo0oO0 Intent intent) {
    ...
    private static boolean zzb(@o0OO00OO Bundle bundle, @o0OO00OO Bundle bundle2) {
        int length;
        if (bundle == null) {
            return bundle2 == null;
