...
public abstract class zzcb<MessageType extends zzcb<MessageType, BuilderType>, BuilderType extends zzbx<MessageType, BuilderType>> extends zzak<MessageType, BuilderType> {
    ...
    public final int zza(zzdp zzdpVar) {
        if (zzt()) {
            ...
            throw new IllegalStateException(o00oOOo0.o00oOOo0("serialized size must be non-negative, was ", zzv));
        }
        int i = this.zzd & Integer.MAX_VALUE;
        if (i != Integer.MAX_VALUE) {
            return i;
        }
        int zzv2 = zzv(zzdpVar);
        if (zzv2 >= 0) {
            this.zzd = (this.zzd & Integer.MIN_VALUE) | zzv2;
            return zzv2;
        }
        throw new IllegalStateException(o00oOOo0.o00oOOo0("serialized size must be non-negative, was ", zzv2));
    }
    ...
    public final int zze() {
        ...
        if (zzt()) {
            i = zzv(null);
            if (i < 0) {
                throw new IllegalStateException(o00oOOo0.o00oOOo0("serialized size must be non-negative, was ", i));
            }
        } else {
