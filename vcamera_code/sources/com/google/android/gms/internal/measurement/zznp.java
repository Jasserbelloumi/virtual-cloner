...
public final class zznp implements zzno {
    ...
    static {
        ...
        zzi = zza2.zzd("measurement.store.max_stored_events_per_app", IndexSeeker.MIN_TIME_BETWEEN_POINTS_US);
        ...
        zzE = zza2.zzd("measurement.upload.max_events_per_day", IndexSeeker.MIN_TIME_BETWEEN_POINTS_US);
