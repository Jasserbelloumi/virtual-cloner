...
public final class zzhf implements zzhk {
    ...
    @o0O0OOOo("ConfigurationContentLoader.class")
    private static final Map zzb = new androidx.collection.o00oOOo0();
    ...
    public final /* synthetic */ Map zzd() {
        ...
        try {
            ...
            Map o00oooo02 = count <= 256 ? new androidx.collection.o00oOOo0(count) : new HashMap(count, 1.0f);
            while (query.moveToNext()) {
                o00oooo02.put(query.getString(0), query.getString(1));
            }
            return o00oooo02;
        } finally {
            query.close();
