...
final class zzfzx extends zzgct {
    public final /* synthetic */ zzfzy zza;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public zzfzx(zzfzy zzfzyVar, Class cls) {
        super(cls);
        this.zza = zzfzyVar;
    }
