...
public final class zzfhp {
    ...
    public zzfhp(@oo0oO0 Context context, @oo0oO0 Executor executor, @oo0oO0 Task task, boolean z) {
        this.zzb = context;
        this.zzc = executor;
        this.zzd = task;
        this.zze = z;
    ...
    public static zzfhp zza(@oo0oO0 final Context context, @oo0oO0 Executor executor, boolean z) {
