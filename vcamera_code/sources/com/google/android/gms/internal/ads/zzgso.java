...
public final class zzgso extends zzgpe {
    ...
    public static zzgpe zzG(zzgpe zzgpeVar, zzgpe zzgpeVar2) {
        ...
        return zzd >= zzc(Math.max(zzgpeVar.zzf(), zzgpeVar2.zzf()) + 1) ? new zzgso(zzgpeVar, zzgpeVar2) : zzgsk.zza(new zzgsk(null), zzgpeVar, zzgpeVar2);
    }
    ...
    public final zzgpe zzk(int i, int i2) {
        int zzq = zzgpe.zzq(i, i2, this.zzc);
        if (zzq == 0) {
            return zzgpe.zzb;
        }
        if (zzq == this.zzc) {
    ...
    public final zzgpm zzl() {
        ...
        return z ? new zzgpi(arrayList, i2, true, null) : zzgpm.zzH(new zzgqz(arrayList), 4096);
    }
