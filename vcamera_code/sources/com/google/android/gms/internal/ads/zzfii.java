...
public final class zzfii {
    ...
    public static zzfii zze(@oo0oO0 Context context, @oo0oO0 Executor executor, @oo0oO0 zzfhp zzfhpVar, @oo0oO0 zzfhr zzfhrVar) {
    ...
    private static zzans zzg(@oo0oO0 Task task, @oo0oO0 zzans zzansVar) {
        return !task.isSuccessful() ? zzansVar : (zzans) task.getResult();
    }

    private final Task zzh(@oo0oO0 Callable callable) {
