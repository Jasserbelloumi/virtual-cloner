...
public final class zzgsr {
    ...
    public static int zzd(int i, List list, boolean z) {
        ...
        return (zzgpt.zzD(i) * size) + zze(list);
    }
    ...
    public static int zzk(int i, List list, boolean z) {
        ...
        return (zzgpt.zzD(i) * size) + zzl(list);
    }
    ...
    public static int zzm(int i, List list, boolean z) {
        ...
        return (zzgpt.zzD(i) * list.size()) + zzn(list);
    }
    ...
    public static int zzp(int i, List list, zzgsp zzgspVar) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            zzD = (obj instanceof zzgrc ? zzgpt.zzz((zzgrc) obj) : zzgpt.zzA((zzgrw) obj, zzgspVar)) + zzD;
        }
        return zzD;
    }
    ...
    public static int zzq(int i, List list, boolean z) {
        ...
        return (zzgpt.zzD(i) * size) + zzr(list);
    }
    ...
    public static int zzs(int i, List list, boolean z) {
        ...
        return (zzgpt.zzD(i) * size) + zzt(list);
    }
    ...
    public static int zzu(int i, List list) {
        ...
        if (z) {
            ...
            while (i2 < size) {
                ...
                zzD = (zzf instanceof zzgpe ? zzgpt.zzw((zzgpe) zzf) : zzgpt.zzC((String) zzf)) + zzD;
                i2++;
            }
        } else {
            while (i2 < size) {
                Object obj = list.get(i2);
                zzD = (obj instanceof zzgpe ? zzgpt.zzw((zzgpe) obj) : zzgpt.zzC((String) obj)) + zzD;
                i2++;
            }
        }
        return zzD;
    ...
    public static int zzv(int i, List list, boolean z) {
        ...
        return (zzgpt.zzD(i) * size) + zzw(list);
    }
    ...
    public static int zzx(int i, List list, boolean z) {
        ...
        return (zzgpt.zzD(i) * size) + zzy(list);
    }
