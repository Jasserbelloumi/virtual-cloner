...
final class zzajk {
    ...
    public static zzaji zzb(zzzv zzzvVar) throws IOException {
        ...
        zzajj zzd = zzd(WavUtil.FMT_FOURCC, zzzvVar, zzenVar);
        zzdl.zzf(zzd.zzb >= 16);
        ...
        if (i > 0) {
            ...
            zzzkVar.zzm(bArr2, 0, i, false);
            bArr = bArr2;
        } else {
            bArr = zzew.zzf;
        }
        ((zzzk) zzzvVar).zzo((int) (zzzvVar.zze() - zzzvVar.zzf()), false);
        return new zzaji(zzi, zzi2, zzh, zzh2, zzi3, zzi4, bArr);
    }
