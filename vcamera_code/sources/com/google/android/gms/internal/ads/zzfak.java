            ...
            if (size == zzfaqVar2.zzc) {
                ...
                if (i2 == 0) {
                    ...
                    if (zzfatVar2 != null) {
                        ...
                        concurrentHashMap.remove(zzfatVar2);
                    }
                    this.zzc.zzg();
                } else if (i2 != 1) {
                    if (i2 == 2) {
                        ...
                        for (Map.Entry entry2 : this.zza.entrySet()) {
                            if (((zzfai) entry2.getValue()).zza() < i3) {
                                i3 = ((zzfai) entry2.getValue()).zza();
                    ...
                    for (Map.Entry entry3 : this.zza.entrySet()) {
                        if (((zzfai) entry3.getValue()).zzd() < j) {
                            j = ((zzfai) entry3.getValue()).zzd();
