...
final class zzgge implements zzfws {
    ...
    public final void zza(byte[] bArr, byte[] bArr2) throws GeneralSecurityException {
        ...
        for (zzfwx zzfwxVar : this.zza.zze(copyOf)) {
            try {
                ((zzfws) zzfwxVar.zze()).zza(copyOfRange, zzfwxVar.zzc().equals(zzgme.LEGACY) ? zzgmv.zzb(bArr2, zzggf.zzf()) : bArr2);
                zzfwxVar.zza();
                return;
            } catch (GeneralSecurityException e) {
                zzggf.zzd().logp(Level.INFO, "com.google.crypto.tink.mac.MacWrapper$WrappedMac", "verifyMac", "tag prefix matches a key, but cannot verify: ".concat(e.toString()));
            }
        }
