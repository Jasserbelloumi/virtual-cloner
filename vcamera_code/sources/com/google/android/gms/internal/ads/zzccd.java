...
public final class zzccd implements zzfg {
    ...
    public final long zzb(zzfl zzflVar) throws IOException {
        ...
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbar.zzdQ)).booleanValue()) {
            ...
            this.zzi.zzi = zzfoj.zzc(this.zzc);
            this.zzi.zzj = this.zzd;
            long longValue = ((Long) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(this.zzi.zzg ? zzbar.zzdS : zzbar.zzdR)).longValue();
        ...
        if (this.zzi != null) {
            this.zzm = new zzfl(Uri.parse(this.zzi.zza), null, zzflVar.zze, zzflVar.zzf, zzflVar.zzg, null, zzflVar.zzi);
        }
