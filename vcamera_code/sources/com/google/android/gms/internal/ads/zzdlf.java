...
public final class zzdlf {
    ...
    public zzdlf(zzdlc zzdlcVar) {
        this.zzd = zzdlc.zza(zzdlcVar);
        this.zzg = zzdlc.zzj(zzdlcVar);
        this.zzh = zzdlc.zzb(zzdlcVar);
        this.zzi = zzdlc.zzd(zzdlcVar);
        this.zzb = zzdlc.zzc(zzdlcVar);
        this.zzc = zzdlc.zze(zzdlcVar);
        this.zzk = zzdlc.zzg(zzdlcVar);
        this.zzl = zzdlc.zzi(zzdlcVar);
        this.zze = zzdlc.zzf(zzdlcVar);
        this.zzf = zzdlc.zzh(zzdlcVar);
    }
