...
final class zzgbq {
    ...
    public static zzgbq zzc(byte[] bArr, byte[] bArr2, zzgbt zzgbtVar, zzgbo zzgboVar, zzgbp zzgbpVar, byte[] bArr3) throws GeneralSecurityException {
        ...
        byte[] bArr5 = zza;
        byte[] zzb2 = zzgmv.zzb(zzgcc.zza, zzgboVar.zze(bArr4, bArr5, "psk_id_hash", zzb), zzgboVar.zze(bArr4, bArr3, "info_hash", zzb));
        byte[] zze = zzgboVar.zze(bArr2, bArr5, "secret", zzb);
        byte[] zzd = zzgboVar.zzd(zze, zzb2, "key", zzb, zzgbpVar.zza());
        byte[] zzd2 = zzgboVar.zzd(zze, zzb2, "base_nonce", zzb, 12);
        BigInteger bigInteger = BigInteger.ONE;
        return new zzgbq(bArr, zzd, zzd2, bigInteger.shiftLeft(96).subtract(bigInteger), zzgbpVar);
    }
