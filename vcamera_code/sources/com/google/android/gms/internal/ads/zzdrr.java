...
public final class zzdrr implements SensorEventListener {
    ...
    public final void onSensorChanged(SensorEvent sensorEvent) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbar.zzio)).booleanValue()) {
            ...
            if (floatValue > ((Float) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbajVar)).floatValue() + f) {
                this.zzc = this.zzd.floatValue();
                this.zzh = true;
            } else if (this.zzd.floatValue() < this.zzc - ((Float) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbajVar)).floatValue()) {
                this.zzc = this.zzd.floatValue();
                this.zzg = true;
            }
