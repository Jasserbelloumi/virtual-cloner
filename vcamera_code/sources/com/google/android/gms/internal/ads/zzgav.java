...
final class zzgav extends zzgct {
    public final /* synthetic */ zzgaw zza;
    ...
    public final /* bridge */ /* synthetic */ void zzd(zzgrw zzgrwVar) throws GeneralSecurityException {
        ...
        if (zzgisVar.zza() != 64) {
            throw new InvalidAlgorithmParameterException(o00ooO0.o00oOoO.o00oOOo0("invalid key size: ", zzgisVar.zza(), ". Valid keys must have 64 bytes."));
        }
    }
}
