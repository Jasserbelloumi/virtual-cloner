...
public final class zzaiv implements zzzu {
    ...
    public zzaiv(int i) {
        this(1, new zzeu(0L), new zzahk(0), TsExtractor.DEFAULT_TIMESTAMP_SEARCH_BYTES);
    }
    ...
    public zzaiv(int i, zzeu zzeuVar, zzaiy zzaiyVar, int i2) {
        ...
        this.zzi = new zzair(TsExtractor.DEFAULT_TIMESTAMP_SEARCH_BYTES);
        this.zzk = zzzx.zza;
        this.zzq = -1;
