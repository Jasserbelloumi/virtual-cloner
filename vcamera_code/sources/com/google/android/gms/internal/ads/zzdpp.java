...
public class zzdpp {
    ...
    public final String zza = (String) zzbce.zzb.zze();
    public final Map zzb = new HashMap();
    public final boolean zze = ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbar.zzbN)).booleanValue();
