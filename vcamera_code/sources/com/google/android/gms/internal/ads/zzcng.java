...
public final class zzcng implements zzatf, zzcvj, com.google.android.gms.ads.internal.overlay.zzo, zzcvi {
    ...
    public zzcng(zzbmo zzbmoVar, zzcnc zzcncVar, Executor executor, zzcnb zzcnbVar, Clock clock) {
        ...
        this.zzd = zzbmoVar.zza("google.afma.activeView.handleUpdate", zzblzVar, zzblzVar);
        this.zzb = zzcncVar;
        this.zze = executor;
        this.zzf = clock;
    }
    ...
    public final synchronized void zzbn(@o0OO00OO Context context) {
        this.zzh.zze = "u";
        zzg();
        zzk();
        this.zzi = true;
    ...
    @Override // com.google.android.gms.internal.ads.zzcvj
    public final synchronized void zzbp(@o0OO00OO Context context) {
        this.zzh.zzb = true;
        zzg();
    }

    @Override // com.google.android.gms.internal.ads.zzcvj
    public final synchronized void zzbq(@o0OO00OO Context context) {
        this.zzh.zzb = false;
        zzg();
    }
