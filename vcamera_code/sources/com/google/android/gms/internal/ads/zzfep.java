...
public final class zzfep implements Runnable {
        ...
        synchronized (zzfep.class) {
            if (zza == null) {
                if (((Boolean) zzbcd.zzb.zze()).booleanValue()) {
                    valueOf = Boolean.valueOf(Math.random() < ((Double) zzbcd.zza.zze()).doubleValue());
                } else {
    ...
    public final synchronized void zzb(@o0OO00OO zzfeg zzfegVar) {
        if (!this.zzh) {
            zzc();
        }
        if (zza()) {
