...
public final class zzean extends zzbqu {
    ...
    public static void zzd(Context context, zzdpi zzdpiVar, zzfdk zzfdkVar, zzeaf zzeafVar, String str, String str2, Map map) {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbar.zzhS)).booleanValue()) {
            ...
            zzb.zza("gqi", str);
            zzb.zza("device_connectivity", true == com.google.android.gms.ads.internal.zzt.zzo().zzx(context) ? o00oo0O.o00oOOoO.f7289o00oOoO0 : "offline");
            ...
            zza.zzb("gqi", str);
            zza.zzb("action", str2);
            zza.zzb("device_connectivity", true == com.google.android.gms.ads.internal.zzt.zzo().zzx(context) ? o00oo0O.o00oOOoO.f7289o00oOoO0 : "offline");
    ...
    public static void zzh(final Activity activity, @o0OO00OO final com.google.android.gms.ads.internal.overlay.zzl zzlVar, final com.google.android.gms.ads.internal.util.zzbr zzbrVar, final zzeaf zzeafVar, final zzdpi zzdpiVar, final zzfdk zzfdkVar, final String str, final String str2) {
    ...
    public final void zzg(IObjectWrapper iObjectWrapper, String str, String str2) {
        ...
        oOo000Oo.o00oo0 o0O00o0O2 = new oOo000Oo.o00oo0(context, "offline_notification_channel").o00oooOo(zzd == null ? "View the ad you saved when you were offline" : zzd.getString(R.string.offline_notification_title)).o00oooOO(zzd == null ? "Tap to open ad" : zzd.getString(R.string.offline_notification_text)).o00ooOO(true).o0(zzj2).o00oooO(zzj).o0O00o0O(context.getApplicationInfo().icon);
        NotificationManager notificationManager = (NotificationManager) context.getSystemService("notification");
        HashMap hashMap = new HashMap();
        try {
            notificationManager.notify(str2, 54321, o0O00o0O2.o00oOoO());
