...
public final class zzdyd implements zzfcd {
    ...
    public final zzbtz zzc;

    public zzdyd(Context context, String str, zzbtz zzbtzVar, int i, byte[] bArr) {
        this.zza = context;
        this.zzb = str;
        this.zzc = zzbtzVar;
    }
