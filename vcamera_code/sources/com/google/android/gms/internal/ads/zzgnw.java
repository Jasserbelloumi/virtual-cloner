...
final class zzgnw {
    ...
    public static void zzg(long[] jArr, long[] jArr2) {
        ...
        long j7 = jArr2[3];
        long j8 = (j5 * j5) + (j3 * 4 * j7);
        long j9 = jArr2[4];
        long j10 = (j5 * j7) + (j3 * j9) + (jArr2[5] * j2);
        long j11 = jArr2[5];
        long j12 = (j7 * j7) + (j5 * j9) + (jArr2[6] * j2) + ((j3 + j3) * j11);
        long j13 = jArr2[6];
        long j14 = (j7 * j9) + (j5 * j11) + (j3 * j13) + (jArr2[7] * j2);
        long j15 = jArr2[7];
        long j16 = (j7 * j11) + (j3 * j15);
        long j17 = j16 + j16 + (j5 * j13) + (jArr2[8] * j2);
        long j18 = j17 + j17;
        long j19 = jArr2[8];
        long j20 = (j9 * j11) + (j7 * j13) + (j5 * j15) + (j3 * j19) + (j2 * jArr2[9]);
        long j21 = jArr2[9];
        long j22 = (j3 * j21) + (j7 * j15);
        long j23 = j22 + j22 + (j11 * j11) + (j9 * j13) + (j5 * j19);
        long j24 = (j11 * j13) + (j9 * j15) + (j7 * j19) + (j5 * j21);
        long j25 = (j7 * j21) + (j11 * j15);
        long j26 = j25 + j25 + (j9 * j19);
        long j27 = (j13 * j15) + (j11 * j19) + (j9 * j21);
        long j28 = (j15 * j15) + (j13 * j19) + ((j11 + j11) * j21);
        long j29 = (j13 * j21) + (j15 * j19);
        zzc(new long[]{j * j, (j2 + j2) * jArr2[1], j4 + j4, j6 + j6, j8 + ((j2 + j2) * jArr2[4]), j10 + j10, j12 + j12, j14 + j14, j18 + (j9 * j9), j20 + j20, j23 + j23, j24 + j24, j26 + j26 + (j13 * j13), j27 + j27, j28 + j28, j29 + j29, (j15 * 4 * j21) + (j19 * j19), (j19 + j19) * j21, (j21 + j21) * j21}, jArr);
    }
