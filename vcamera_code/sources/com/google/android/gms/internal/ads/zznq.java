...
public final class zznq {
    ...
    public zznq(@o0OO00OO int[] iArr, int i) {
    ...
    public final String toString() {
        return android.support.v4.media.o00oOoO.o00oOOo0("AudioCapabilities[maxChannelCount=8, supportedEncodings=", Arrays.toString(this.zzd), "]");
    }
