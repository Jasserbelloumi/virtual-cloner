...
public final class zzavn extends AbstractSafeParcelable {
    ...
    public zzavn(@SafeParcelable.Param(id = 2) @o0OO00OO ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(id = 3) boolean z, @SafeParcelable.Param(id = 4) boolean z2, @SafeParcelable.Param(id = 5) long j, @SafeParcelable.Param(id = 6) boolean z3) {
