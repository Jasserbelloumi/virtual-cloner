...
public final class zzjc extends zzm implements zzhu {
    ...
    public zzjc(zzht zzhtVar, @o0OO00OO zzcg zzcgVar) {
        Object obj;
        ...
        try {
            ...
            zzkn[] zza = ((zzhn) zzhtVar.zzc).zza.zza(handler, zziyVar, zziyVar, zziyVar, zziyVar);
            this.zzh = zza;
            ...
            int i = zzew.zza;
            this.zzk = new zzjm(zza, zzwkVar, zzwlVar, (zzjp) zzhtVar.zzf.zza(), zzg, 0, false, apply, this.zzH, zzhtVar.zzr, zzhtVar.zzn, false, looper, zzdmVar, zzipVar, i < 31 ? new zzno() : zzir.zza(applicationContext, this, zzhtVar.zzp), null, null);
            this.zzW = 1.0f;
            ...
            if (i >= 21) {
                ...
                if (this.zzN == null) {
                    this.zzN = new AudioTrack(3, oO0000o0.f16600o00oOoo0, 4, 2, 2, 0, 0);
                }
    ...
    public static /* bridge */ /* synthetic */ zzt zzG(zzjc zzjcVar) {
        return zzjcVar.zzab;
    }

    public static /* bridge */ /* synthetic */ zzt zzH(zzky zzkyVar) {
        return zzal(zzkyVar);
    }

    public static /* bridge */ /* synthetic */ zzeb zzI(zzjc zzjcVar) {
        return zzjcVar.zzl;
    }

    public static /* bridge */ /* synthetic */ zzky zzK(zzjc zzjcVar) {
        return zzjcVar.zzz;
    }

    public static /* bridge */ /* synthetic */ void zzP(zzjc zzjcVar, zzt zztVar) {
        zzjcVar.zzab = zztVar;
    }
    ...
    private final zzkh zzam(zzkh zzkhVar, zzcn zzcnVar, @o0OO00OO Pair pair) {
        int i;
        long j;
        zzkh zzb;
        ...
        zzss zzssVar = z ? new zzss(pair.first) : zzf.zzb;
        ...
        if (z || longValue < zzv2) {
            zzdl.zzf(!zzssVar.zzb());
            zzkh zza2 = zzf.zzb(zzssVar, longValue, longValue, longValue, 0L, z ? zzur.zza : zzf.zzh, z ? this.zzb : zzf.zzi, z ? zzfqk.zzo() : zzf.zzj).zza(zzssVar);
            zza2.zzp = longValue;
            return zza2;
        }
        if (i == 0) {
            int zza3 = zzcnVar.zza(zzf.zzk.zza);
            if (zza3 != -1 && zzcnVar.zzd(zza3, this.zzn, false).zzd == zzcnVar.zzn(zzssVar.zza, this.zzn).zzd) {
                return zzf;
            }
            zzcnVar.zzn(zzssVar.zza, this.zzn);
            j = zzssVar.zzb() ? this.zzn.zzg(zzssVar.zzb, zzssVar.zzc) : this.zzn.zze;
            zzb = zzf.zzb(zzssVar, zzf.zzr, zzf.zzr, zzf.zzd, j - zzf.zzr, zzf.zzh, zzf.zzi, zzf.zzj).zza(zzssVar);
        } else {
            zzdl.zzf(!zzssVar.zzb());
            ...
            zzb = zzf.zzb(zzssVar, longValue, longValue, longValue, max, zzf.zzh, zzf.zzi, zzf.zzj);
        }
        zzb.zzp = j;
        return zzb;
    }
    ...
    private final zzkk zzan(zzkj zzkjVar) {
        ...
        return new zzkk(zzjmVar, zzkjVar, zzcnVar, zzaf, this.zzu, zzjmVar.zzb());
    }
    ...
    private final void zzap(int i, int i2, @o0OO00OO Object obj) {
    ...
    public final void zzar(@o0OO00OO Object obj) {
        boolean z;
    ...
    private final void zzas(boolean z, @o0OO00OO zzhj zzhjVar) {
        zzkh zzkhVar = this.zzae;
    ...
    */
    private final void zzau(final com.google.android.gms.internal.ads.zzkh r43, final int r44, final int r45, boolean r46, boolean r47, final int r48, long r49, int r51, boolean r52) {
        /*
    ...
    public final void zzE(zzsu zzsuVar) {
        ...
        if (!zzklVar.zzo() && zzklVar.zzc() < 0) {
            throw new zzag(zzklVar, -1, C.TIME_UNSET);
        }
        int zzg = zzklVar.zzg(false);
        zzkh zzam = zzam(this.zzae, zzklVar, zzak(zzklVar, zzg, C.TIME_UNSET));
        int i3 = zzam.zze;
        if (zzg != -1 && i3 != 1) {
            i3 = (zzklVar.zzo() || zzg >= zzklVar.zzc()) ? 4 : 2;
        }
        zzkh zze = zzam.zze(i3);
        this.zzk.zzq(arrayList, zzg, zzew.zzv(C.TIME_UNSET), this.zzai);
    ...
    public final long zzm() {
        ...
        if (zzA()) {
            ...
            long j = zzkhVar2.zzc;
            if (j == C.TIME_UNSET) {
                long j2 = zzkhVar2.zza.zze(zzg(), this.zza, 0L).zzm;
                return zzew.zzz(0L);
            }
            int i = zzew.zza;
            return zzew.zzz(j) + zzew.zzz(0L);
        }
        return zzn();
    }
    ...
    public final long zzo() {
        ...
        if (zzA()) {
            ...
            zzg = this.zzn.zzg(zzssVar.zzb, zzssVar.zzc);
        } else {
            zzcn zzq = zzq();
            if (zzq.zzo()) {
                return C.TIME_UNSET;
            }
            zzg = zzq.zze(zzg(), this.zza, 0L).zzn;
        }
        return zzew.zzz(zzg);
    }
    ...
    public final void zzt() {
        ...
        String str = zzew.zze;
        String zza = zzbh.zza();
        StringBuilder o00oOOo02 = oO0OoOO0.o00oOOo0("Release ", hexString, " [AndroidXMedia3/1.0.0-beta03] [", str, "] [");
        o00oOOo02.append(zza);
        o00oOOo02.append("]");
        zzee.zzd("ExoPlayerImpl", o00oOOo02.toString());
        zzaw();
    ...
    @Override // com.google.android.gms.internal.ads.zzcg
    public final void zzv(@o0OO00OO Surface surface) {
        zzaw();
        zzar(surface);
