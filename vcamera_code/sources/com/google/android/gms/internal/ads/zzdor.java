...
public final class zzdor implements zzczg, com.google.android.gms.ads.internal.client.zza, zzcvi, zzcus {
    ...
    private final zzdph zzf(String str) {
        ...
        if (this.zze.zzaj) {
            zza.zzb("device_connectivity", true != com.google.android.gms.ads.internal.zzt.zzo().zzx(this.zza) ? "offline" : o00oo0O.o00oOOoO.f7289o00oOoO0);
    ...
    public final void zzc(zzded zzdedVar) {
        if (this.zzh) {
            ...
            if (!TextUtils.isEmpty(zzdedVar.getMessage())) {
                zzf.zzb(oOo000Oo.f9215o0O00o00, zzdedVar.getMessage());
            }
            zzf.zzg();
        }
    }
