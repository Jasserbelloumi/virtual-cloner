...
final class zzgpi extends zzgpm {
    ...
    public final int zzi() throws IOException {
        ...
        this.zzm = 4 + j2;
        return (zzgtq.zza(j2) & 255) | ((zzgtq.zza(1 + j2) & 255) << 8) | ((zzgtq.zza(2 + j2) & 255) << 16) | ((zzgtq.zza(j2 + 3) & 255) << 24);
    }
    ...
    */
    ...
    public final long zzq() throws IOException {
        ...
        this.zzm = 8 + j2;
        long zza2 = zzgtq.zza(j2) & 255;
        long zza3 = (zzgtq.zza(1 + j2) & 255) << 8;
        return ((zzgtq.zza(j2 + 4) & 255) << 32) | zza2 | zza3 | ((zzgtq.zza(j2 + 2) & 255) << 16) | ((zzgtq.zza(3 + j2) & 255) << 24) | ((zzgtq.zza(j2 + 5) & 255) << 40) | ((zzgtq.zza(j2 + 6) & 255) << 48) | ((zzgtq.zza(j2 + 7) & 255) << 56);
    }
    ...
    public final long zzr() throws IOException {
        ...
        if (this.zzo != j3) {
            ...
            if (zza2 >= 0) {
                ...
                if (zza3 >= 0) {
                    long j6 = j5 + 1;
                    int zza4 = zza3 ^ (zzgtq.zza(j5) << Ascii.SO);
                    if (zza4 >= 0) {
                        zza = zza4 ^ 16256;
                    } else {
                        j5 = j6 + 1;
                        int zza5 = zza4 ^ (zzgtq.zza(j6) << Ascii.NAK);
                        if (zza5 < 0) {
                            i = zza5 ^ (-2080896);
                        } else {
                            j6 = j5 + 1;
