...
public final class zzcdv extends zzcba implements zzgi, zzle {
    ...
    */
    ...
    public final /* synthetic */ zzkn[] zzaa(Handler handler, zzyp zzypVar, zzoc zzocVar, zzuu zzuuVar, zzrs zzrsVar) {
        ...
        zzpf zzd = zzotVar.zzd();
        zzqt zzqtVar = zzqt.zza;
        return new zzkn[]{new zzpl(context, zzqtVar, zzrcVar, false, handler, zzocVar, zzd), new zzxs(this.zzb, zzqtVar, zzrcVar, 0L, false, handler, zzypVar, -1, 30.0f)};
    }
    ...
    public final void zze(zzlc zzlcVar, zzaf zzafVar, @o0OO00OO zzhc zzhcVar) {
    ...
    @Override // com.google.android.gms.internal.ads.zzle
    public final void zzp(zzlc zzlcVar, zzaf zzafVar, @o0OO00OO zzhc zzhcVar) {
        zzcbj zzcbjVar = (zzcbj) this.zzf.get();
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbar.zzbG)).booleanValue() || zzcbjVar == null || zzafVar == null) {
            return;
        }
