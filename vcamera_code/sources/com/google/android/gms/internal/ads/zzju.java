...
public final class zzju {
    ...
    private final zzjs zzt(zzcn zzcnVar, zzjr zzjrVar, long j) {
        ...
        if (!zzjsVar.zzg) {
            ...
            int zzf = this.zza.zzf(i, zzssVar.zzc);
            if (zzf < 0) {
                return zzv(zzcnVar, zzssVar.zza, i, zzf, zzjsVar.zzc, zzssVar.zzd);
            }
            long j3 = zzjsVar.zzc;
            if (j3 == C.TIME_UNSET) {
                zzcm zzcmVar = this.zzb;
                zzck zzckVar = this.zza;
                Pair zzm = zzcnVar.zzm(zzcmVar, zzckVar, zzckVar.zzd, C.TIME_UNSET, Math.max(0L, zze));
                if (zzm == null) {
                    return null;
                }
            ...
            return zzw(zzcnVar, zzssVar.zza, Math.max(0L, j3), zzjsVar.zzc, zzssVar.zzd);
        }
        long j4 = 0;
        ...
        obj.getClass();
        long j5 = zzjsVar.zza.zzd;
        if (zzcnVar.zze(i2, this.zzb, 0L).zzo == zzi) {
            Pair zzm2 = zzcnVar.zzm(this.zzb, this.zza, i2, C.TIME_UNSET, Math.max(0L, zze));
            if (zzm2 == null) {
                return null;
            }
            obj = zzm2.first;
        ...
        zzss zzx = zzx(zzcnVar, obj, j2, j5, this.zzb, this.zza);
        if (j4 != C.TIME_UNSET && zzjsVar.zzc != C.TIME_UNSET) {
    ...
    private final zzjs zzu(zzcn zzcnVar, zzss zzssVar, long j, long j2) {
        zzcnVar.zzn(zzssVar.zza, this.zza);
        boolean zzb = zzssVar.zzb();
        Object obj = zzssVar.zza;
        return zzb ? zzv(zzcnVar, obj, zzssVar.zzb, zzssVar.zzc, j, zzssVar.zzd) : zzw(zzcnVar, obj, j2, j, zzssVar.zzd);
    }
    ...
    private final zzjs zzv(zzcn zzcnVar, Object obj, int i, int i2, long j, long j2) {
        ...
        return new zzjs(zzssVar, (zzg == C.TIME_UNSET || zzg > 0) ? 0L : Math.max(0L, (-1) + zzg), j, C.TIME_UNSET, zzg, false, false, false, false);
    }
    ...
    private static zzss zzx(zzcn zzcnVar, Object obj, long j, long j2, zzcm zzcmVar, zzck zzckVar) {
        ...
        return zzd == -1 ? new zzss(obj, j2, zzckVar.zzc(j)) : new zzss(obj, zzd, zzckVar.zze(zzd), j2);
    }
    ...
    */
        ...
        if (obj2 == null || (zza = zzcnVar.zza(obj2)) == -1 || zzcnVar.zzd(zza, this.zza, false).zzd != i) {
            ...
            while (true) {
                if (zzjrVar == null) {
                    zzjrVar = this.zzh;
                    while (zzjrVar != null) {
                        int zza2 = zzcnVar.zza(zzjrVar.zzb);
    ...
    public final boolean zzn() {
        zzjr zzjrVar = this.zzj;
        if (zzjrVar != null) {
            if (zzjrVar.zzf.zzi || !zzjrVar.zzr() || this.zzj.zzf.zze == C.TIME_UNSET) {
                return false;
            }
            return this.zzk < 100;
        }
    ...
    public final boolean zzo(zzcn zzcnVar, long j, long j2) {
        ...
        for (zzjr zzjrVar2 = this.zzh; zzjrVar2 != null; zzjrVar2 = zzjrVar2.zzg()) {
            ...
            if (i != 0 && j3 != j4) {
                zzjrVar2.zzq();
                long j5 = zzjsVar.zze;
                long zze = j5 == C.TIME_UNSET ? Long.MAX_VALUE : j5 + zzjrVar2.zze();
