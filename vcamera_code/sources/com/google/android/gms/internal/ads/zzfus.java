...
public abstract class zzfus extends AtomicReference implements Runnable {
    ...
    public final String toString() {
        Runnable runnable = (Runnable) get();
        return android.support.v4.media.o00oOoO.o00oOOo0(runnable == zza ? "running=[DONE]" : runnable instanceof zzfup ? "running=[INTERRUPTED]" : runnable instanceof Thread ? android.support.v4.media.o00oOoO.o00oOOo0("running=[RUNNING ON ", ((Thread) runnable).getName(), "]") : "running=[NOT STARTED YET]", ", ", zzb());
    }
