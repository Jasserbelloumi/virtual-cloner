...
final class zzaip implements zzzf {
    ...
    public final zzze zza(zzzv zzzvVar, long j) throws IOException {
        ...
        long j5 = -1;
        while (zzenVar.zza() >= 188 && (zza2 = (zza = zzajb.zza(zzenVar.zzH(), zzenVar.zzc(), zzd)) + TsExtractor.TS_PACKET_SIZE) <= zzd) {
            ...
            if (zzb != C.TIME_UNSET) {
                ...
                if (zzb2 > j) {
                    ...
                    j2 = zzf + j5;
                } else if (IndexSeeker.MIN_TIME_BETWEEN_POINTS_US + zzb2 > j) {
                    j2 = zzf + zza;
                } else {
                    j5 = zza;
                    j4 = zzb2;
        ...
        return j4 != C.TIME_UNSET ? zzze.zzf(j4, zzf + j3) : zzze.zza;
    }
