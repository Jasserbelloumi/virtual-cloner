...
public final class zzeyn {
    ...
    public zzeyn(JsonReader jsonReader) throws IllegalStateException, IOException, JSONException, NumberFormatException, AssertionError {
        ...
        while (jsonReader.hasNext()) {
            ...
            } else if (nextName.equals(oOo000Oo.o0O000.f9434o00ooO0)) {
                jsonReader.beginArray();
                while (jsonReader.hasNext()) {
                    jsonReader.beginObject();
                    String str = null;
