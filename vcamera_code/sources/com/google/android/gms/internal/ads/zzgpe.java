...
public abstract class zzgpe implements Iterable, Serializable {
    ...
    private static zzgpe zzc(Iterator it, int i) {
        if (i > 0) {
            ...
            throw new IllegalArgumentException(o0oO0Ooo.o00oOOo0("ByteString would be too long: ", zzc.zzd(), BadgeDrawable.DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX, zzc2.zzd()));
        }
    ...
    public static int zzq(int i, int i2, int i3) {
        ...
        if ((i | i2 | i4 | (i3 - i2)) < 0) {
            if (i >= 0) {
                if (i2 < i) {
                    throw new IndexOutOfBoundsException(o0oO0Ooo.o00oOOo0("Beginning index larger than ending index: ", i, ", ", i2));
                }
                throw new IndexOutOfBoundsException(o0oO0Ooo.o00oOOo0("End index: ", i2, " >= ", i3));
            }
            throw new IndexOutOfBoundsException(o00ooO0.o00oOoO.o00oOOo0("Beginning index: ", i, " < 0"));
        }
        return i4;
    }
