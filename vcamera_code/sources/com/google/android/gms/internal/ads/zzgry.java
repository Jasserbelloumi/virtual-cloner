    ...
    private static void zzd(zzgrw zzgrwVar, StringBuilder sb, int i) {
        ...
        for (Map.Entry entry : treeMap.entrySet()) {
            ...
            if (substring2.endsWith("List") && !substring2.endsWith("OrBuilderList") && !substring2.equals("List") && (method2 = (Method) entry.getValue()) != null && method2.getReturnType().equals(List.class)) {
                ...
                zzaP = zzgqm.zzaP(method2, zzgrwVar, new Object[0]);
                ...
                if (hashSet.contains("set".concat(substring2)) && (!substring2.endsWith("Bytes") || !treeMap.containsKey("get".concat(String.valueOf(substring2.substring(0, substring2.length() - 5)))))) {
                    ...
                    if (method4 != null) {
                        Object zzaP2 = zzgqm.zzaP(method4, zzgrwVar, new Object[0]);
                        if (method5 != null) {
                            if (!((Boolean) zzgqm.zzaP(method5, zzgrwVar, new Object[0])).booleanValue()) {
                            }
                            zzb(sb, i, substring2, zzaP2);
                        } else if (zzaP2 instanceof Boolean) {
                            if (!((Boolean) zzaP2).booleanValue()) {
                            }
                            zzb(sb, i, substring2, zzaP2);
                        } else if (zzaP2 instanceof Integer) {
                            if (((Integer) zzaP2).intValue() == 0) {
                            }
                            zzb(sb, i, substring2, zzaP2);
                        } else if (zzaP2 instanceof Float) {
                            if (Float.floatToRawIntBits(((Float) zzaP2).floatValue()) == 0) {
                            }
                            zzb(sb, i, substring2, zzaP2);
                        } else if (zzaP2 instanceof Double) {
                            if (Double.doubleToRawLongBits(((Double) zzaP2).doubleValue()) == 0) {
                            }
                            zzb(sb, i, substring2, zzaP2);
                        } else {
                            if (zzaP2 instanceof String) {
                                obj = "";
                            } else if (zzaP2 instanceof zzgpe) {
                                obj = zzgpe.zzb;
                            } else if (zzaP2 instanceof zzgrw) {
                                if (zzaP2 == ((zzgrw) zzaP2).zzbf()) {
                                }
                                zzb(sb, i, substring2, zzaP2);
                            } else {
                                if ((zzaP2 instanceof Enum) && ((Enum) zzaP2).ordinal() == 0) {
                                }
                                zzb(sb, i, substring2, zzaP2);
                            }
                            if (zzaP2.equals(obj)) {
                ...
                zzaP = zzgqm.zzaP(method, zzgrwVar, new Object[0]);
            }
            zzb(sb, i, substring, zzaP);
            i2 = 3;
        }
        if (zzgrwVar instanceof zzgqj) {
            zzgqj zzgqjVar = (zzgqj) zzgrwVar;
            throw null;
        }
