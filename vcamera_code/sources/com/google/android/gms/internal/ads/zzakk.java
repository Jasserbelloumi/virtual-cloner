...
public final class zzakk {
    ...
    private zzakk(int i, byte[] bArr, @o0OO00OO Map map, @o0OO00OO List list, boolean z, long j) {
        this.zza = i;
        this.zzb = bArr;
        this.zzc = map;
    ...
    @Deprecated
    public zzakk(int i, byte[] bArr, @o0OO00OO Map map, boolean z, long j) {
    ...
    */
    public zzakk(int r9, byte[] r10, boolean r11, long r12, @o00oOooO.o0OO00OO java.util.List r14) {
        /*
            r8 = this;
            if (r14 != 0) goto L5
            r0 = 0
    ...
    @Deprecated
    public zzakk(byte[] bArr, @o0OO00OO Map map) {
        this(200, bArr, map, zza(map), false, 0L);
    }

    @o0OO00OO
    private static List zza(@o0OO00OO Map map) {
        if (map == null) {
            return null;
        }
        if (map.isEmpty()) {
