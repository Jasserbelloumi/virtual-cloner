...
public final class zzagc implements zzzu, zzaax {
    ...
    private final void zzl(long j) throws zzbu {
        ...
        while (!this.zzf.isEmpty() && ((zzafh) this.zzf.peek()).zza == j) {
            ...
            if (zzafhVar.zzd == 1836019574) {
                ...
                zzafi zzb = zzafhVar.zzb(Atom.TYPE_udta);
                if (zzb != null) {
                ...
                List zzc = zzafr.zzc(zzafhVar, zzaajVar, C.TIME_UNSET, null, false, i3 == 1, new zzfnj() { // from class: com.google.android.gms.internal.ads.zzaga
                ...
                while (true) {
                    ...
                    zzagj zzagjVar = (zzagj) zzc.get(i5);
                    if (zzagjVar.zzb == 0) {
                        list = zzc;
                        i = size;
                        j3 = j4;
                        ...
                        zzagb zzagbVar = new zzagb(zzaggVar, zzagjVar, this.zzr.zzv(i5, zzaggVar.zzb));
                        int i6 = MimeTypes.AUDIO_TRUEHD.equals(zzaggVar.zzf.zzm) ? zzagjVar.zze * 16 : zzagjVar.zze + 30;
                        zzad zzb3 = zzaggVar.zzf.zzb();
                        zzb3.zzL(i6);
                        if (zzaggVar.zzb == 2 && j6 > 0 && (i2 = zzagjVar.zzb) > 1) {
                            zzb3.zzE(i2 / (((float) j6) / 1000000.0f));
                        }
                        int i7 = zzaggVar.zzb;
                        int i8 = zzafy.zzb;
                        ...
                        zzbqVar3 = zzbqVar6;
                        zzbq zzbqVar7 = new zzbq(C.TIME_UNSET, new zzbp[0]);
                        if (i9 == 1) {
                            if (zzbqVar2 != null) {
                                zzbqVar7 = zzbqVar2;
                            }
                            ...
                            for (int i10 = 0; i10 < zzb2.zza(); i10++) {
                                ...
                                if (zzb4 instanceof zzaec) {
                                    ...
                                    if (MdtaMetadataEntry.KEY_ANDROID_CAPTURE_FPS.equals(zzaecVar.zza)) {
                                        zzbqVar7 = new zzbq(C.TIME_UNSET, zzaecVar);
    ...
    /* JADX WARN: Removed duplicated region for block: B:218:0x03fa A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:240:0x0085 A[SYNTHETIC] */
    ...
    */
    ...
    public final zzaav zzg(long j) {
        ...
        return j3 == C.TIME_UNSET ? new zzaav(zzaayVar3, zzaayVar3) : new zzaav(zzaayVar3, new zzaay(j3, j4));
    }
