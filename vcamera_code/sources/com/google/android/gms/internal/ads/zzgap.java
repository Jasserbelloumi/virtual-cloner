...
public final class zzgap {
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i2 >= length) {
                ...
                long zzc = (((j14 & j21) | (j15 & 67108863 & j22) | (j23 << 26)) & UnsignedInts.INT_MASK) + zzc(bArr, 16);
                long zzc2 = (((j23 >> 6) | (j24 << 20)) & UnsignedInts.INT_MASK) + zzc(bArr, 20);
                long zzc3 = (((j25 << 14) | (j24 >> 12)) & UnsignedInts.INT_MASK) + zzc(bArr, 24);
                long zzc4 = (((j25 >> 18) | (j26 << 8)) & UnsignedInts.INT_MASK) + zzc(bArr, 28);
                byte[] bArr4 = new byte[16];
                zzd(bArr4, zzc & UnsignedInts.INT_MASK, 0);
                long j27 = zzc2 + (zzc >> 32);
                zzd(bArr4, j27 & UnsignedInts.INT_MASK, 4);
                long j28 = zzc3 + (j27 >> 32);
                zzd(bArr4, j28 & UnsignedInts.INT_MASK, 8);
                zzd(bArr4, (zzc4 + (j28 >> 32)) & UnsignedInts.INT_MASK, 12);
                return bArr4;
            }
    ...
    private static long zzc(byte[] bArr, int i) {
        ...
        return (((bArr[i + 3] & 255) << 24) | i2 | (bArr[i] & 255) | ((bArr[i + 2] & 255) << 16)) & UnsignedInts.INT_MASK;
    }
