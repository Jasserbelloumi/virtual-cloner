...
public class zzzg {
    ...
    public static final int zzf(zzzv zzzvVar, long j, zzaau zzaauVar) {
        if (j == zzzvVar.zzf()) {
            return 0;
        }
        zzaauVar.zza = j;
    ...
    public static final boolean zzg(zzzv zzzvVar, long j) throws IOException {
