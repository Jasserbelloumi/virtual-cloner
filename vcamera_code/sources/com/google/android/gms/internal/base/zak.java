...
public final class zak extends Drawable implements Drawable.Callback {
    ...
    public zak(@o0OO00OO Drawable drawable, @o0OO00OO Drawable drawable2) {
        this(null);
    ...
    public zak(@o0OO00OO zaj zajVar) {
        this.zaa = 0;
        this.zad = 255;
        this.zaf = 0;
        this.zag = true;
    ...
    */
    ...
    @Override // android.graphics.drawable.Drawable
    public final void setColorFilter(@o0OO00OO ColorFilter colorFilter) {
