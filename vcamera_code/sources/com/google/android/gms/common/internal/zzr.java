...
public final class zzr extends GmsClientSupervisor {
    ...
    public final void zza(zzn zznVar, ServiceConnection serviceConnection, String str) {
        ...
        synchronized (this.zzb) {
            ...
            if (zzoVar == null) {
                ...
                throw new IllegalStateException("Nonexistent connection status for service config: " + zznVar2);
            } else if (!zzoVar.zzh(serviceConnection)) {
                String zznVar3 = zznVar.toString();
                throw new IllegalStateException("Trying to unbind a GmsServiceConnection  that was not bound before.  config=" + zznVar3);
            } else {
    ...
    @Override // com.google.android.gms.common.internal.GmsClientSupervisor
    public final boolean zzc(zzn zznVar, ServiceConnection serviceConnection, String str, @o0OO00OO Executor executor) {
        boolean zzj;
        Preconditions.checkNotNull(serviceConnection, "ServiceConnection must not be null");
        synchronized (this.zzb) {
            zzo zzoVar = (zzo) this.zzb.get(zznVar);
