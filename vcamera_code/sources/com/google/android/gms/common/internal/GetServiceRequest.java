...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    public boolean zzm;
    @SafeParcelable.Field(defaultValue = SessionDescription.SUPPORTED_SDP_VERSION, id = 13)
    public int zzn;
