...
public final class zaaa extends Button {
    public zaaa(Context context, @o0OO00OO AttributeSet attributeSet) {
    ...
    private static final int zab(int i, int i2, int i3, int i4) {
        if (i != 0) {
            if (i != 1) {
                ...
                throw new IllegalStateException(android.support.v4.media.o00oOOo0.o00oOOo0("Unknown color scheme: ", i));
            }
            return i3;
        }
        return i2;
    ...
    */
    public final void zaa(android.content.res.Resources r6, int r7, int r8) {
        ...
        L38:
            ...
            java.lang.String r7 = android.support.v4.media.o00oOOo0.o00oOOo0(r2, r7)
            r6.<init>(r7)
            throw r6
        L42:
            r0 = r1
        L43:
            ...
            o00oooo0.o0O0O0Oo.o00oOOoO.o00oOoO(r0, r1)
            android.graphics.PorterDuff$Mode r1 = android.graphics.PorterDuff.Mode.SRC_ATOP
            o00oooo0.o0O0O0Oo.o00oOOoO.o00oOoOO(r0, r1)
