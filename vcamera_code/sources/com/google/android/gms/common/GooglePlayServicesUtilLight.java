...
public class GooglePlayServicesUtilLight {
    ...
    @KeepForSdk
    @Deprecated
    public static void cancelAvailabilityErrorNotifications(@oo0oO0 Context context) {
    ...
    @KeepForSdk
    @Deprecated
    public static void ensurePlayServicesAvailable(@oo0oO0 Context context, int i) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
    ...
    @KeepForSdk
    @Deprecated
    public static int getApkVersion(@oo0oO0 Context context) {
        try {
    ...
    @KeepForSdk
    @Deprecated
    public static int getClientVersion(@oo0oO0 Context context) {
    ...
    @ShowFirstParty
    @KeepForSdk
    public static boolean honorsDebugCertificates(@oo0oO0 Context context) {
        if (!zza) {
            try {
    ...
    @KeepForSdk
    @Deprecated
    public static boolean isGooglePlayServicesUid(@oo0oO0 Context context, int i) {
    ...
    @KeepForSdk
    @Deprecated
    public static boolean isPlayServicesPossiblyUpdating(@oo0oO0 Context context, int i) {
        if (i == 18) {
            return true;
        }
        if (i == 1) {
    ...
    @KeepForSdk
    @Deprecated
    public static boolean isPlayStorePossiblyUpdating(@oo0oO0 Context context, int i) {
        if (i == 9) {
    ...
    @KeepForSdk
    @TargetApi(18)
    public static boolean isRestrictedUserProfile(@oo0oO0 Context context) {
    ...
    @ShowFirstParty
    @KeepForSdk
    public static boolean isSidewinderDevice(@oo0oO0 Context context) {
    ...
    @TargetApi(19)
    @Deprecated
    public static boolean uidHasPackageName(@oo0oO0 Context context, int i, @oo0oO0 String str) {
