...
public class PackageVerificationResult {
    ...
    @oo0oO0
    public static PackageVerificationResult zza(@oo0oO0 String str, @oo0oO0 String str2, @Nullable Throwable th) {
        return new PackageVerificationResult(str, 1, false, str2, th);
    }

    @oo0oO0
    public static PackageVerificationResult zzd(@oo0oO0 String str, int i) {
