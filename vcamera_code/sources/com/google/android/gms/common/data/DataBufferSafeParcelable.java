...
public class DataBufferSafeParcelable<T extends SafeParcelable> extends AbstractDataBuffer<T> {
    ...
    @KeepForSdk
    public DataBufferSafeParcelable(@oo0oO0 DataHolder dataHolder, @oo0oO0 Parcelable.Creator<T> creator) {
        super(dataHolder);
        this.zab = creator;
    }

    @KeepForSdk
    public static <T extends SafeParcelable> void addValue(@oo0oO0 DataHolder.Builder builder, @oo0oO0 T t) {
