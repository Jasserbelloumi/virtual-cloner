...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    public static class Builder {
        ...
        @oo0oO0
        @KeepForSdk
        public DataHolder build(int i, @oo0oO0 Bundle bundle) {
            return new DataHolder(this, i, bundle);
        }

        @oo0oO0
        @KeepForSdk
        public Builder withRow(@oo0oO0 ContentValues contentValues) {
        ...
        @oo0oO0
        public Builder zaa(@oo0oO0 HashMap hashMap) {
    ...
    public DataHolder(@SafeParcelable.Param(id = 1000) int i, @SafeParcelable.Param(id = 1) String[] strArr, @SafeParcelable.Param(id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(id = 3) int i2, @SafeParcelable.Param(id = 4) @o0OO00OO Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = i;
        this.zag = strArr;
    ...
    */
    public DataHolder(@o00oOooO.oo0oO0 android.database.Cursor r8, int r9, @o00oOooO.o0OO00OO android.os.Bundle r10) {
        /*
            r7 = this;
    ...
    private DataHolder(Builder builder, int i, @o0OO00OO Bundle bundle) {
        this(builder.zaa, zaf(builder, -1), i, (Bundle) null);
    }

    @KeepForSdk
    public DataHolder(@oo0oO0 String[] strArr, @oo0oO0 CursorWindow[] cursorWindowArr, int i, @o0OO00OO Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = 1;
    ...
    @oo0oO0
    @KeepForSdk
    public static Builder builder(@oo0oO0 String[] strArr) {
                    ...
                    if (i3 < builder.zaa.length) {
                        ...
                        if (obj == null) {
                            ...
                            if (obj instanceof Long) {
                                ...
                                j = true != ((Boolean) obj).booleanValue() ? 0L : 1L;
    ...
    @KeepForSdk
    public boolean getBoolean(@oo0oO0 String str, int i, int i2) {
        zae(str, i);
    ...
    @oo0oO0
    @KeepForSdk
    public byte[] getByteArray(@oo0oO0 String str, int i, int i2) {
        zae(str, i);
    ...
    @KeepForSdk
    public int getInteger(@oo0oO0 String str, int i, int i2) {
        zae(str, i);
        return this.zah[i2].getInt(i, this.zab.getInt(str));
    }

    @KeepForSdk
    public long getLong(@oo0oO0 String str, int i, int i2) {
        zae(str, i);
    ...
    @oo0oO0
    @KeepForSdk
    public String getString(@oo0oO0 String str, int i, int i2) {
        zae(str, i);
    ...
    @KeepForSdk
    public boolean hasNull(@oo0oO0 String str, int i, int i2) {
        zae(str, i);
    ...
    public final double zaa(@oo0oO0 String str, int i, int i2) {
        zae(str, i);
        return this.zah[i2].getDouble(i, this.zab.getInt(str));
    }

    public final float zab(@oo0oO0 String str, int i, int i2) {
        zae(str, i);
        return this.zah[i2].getFloat(i, this.zab.getInt(str));
    }

    public final void zac(@oo0oO0 String str, int i, int i2, @oo0oO0 CharArrayBuffer charArrayBuffer) {
        zae(str, i);
