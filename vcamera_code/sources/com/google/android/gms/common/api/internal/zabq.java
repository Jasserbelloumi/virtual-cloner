...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    @o0OO00OO
    @oO0Oo
    private final Feature zaB(@o0OO00OO Feature[] featureArr) {
        if (featureArr != null && featureArr.length != 0) {
            Feature[] availableFeatures = this.zac.getAvailableFeatures();
            if (availableFeatures == null) {
                availableFeatures = new Feature[0];
            }
            o00oOOo0 o00oooo02 = new o00oOOo0(availableFeatures.length);
            for (Feature feature : availableFeatures) {
                o00oooo02.put(feature.getName(), Long.valueOf(feature.getVersion()));
            }
            for (Feature feature2 : featureArr) {
                Long l = (Long) o00oooo02.getOrDefault(feature2.getName(), null);
    ...
    @oO0Oo
    private final void zaE(@o0OO00OO Status status, @o0OO00OO Exception exc, boolean z) {
        Handler handler;
        handler = this.zaa.zat;
        Preconditions.checkHandlerThread(handler);
    ...
    @oO0Oo
    private final boolean zaM(@oo0oO0 ConnectionResult connectionResult) {
        Object obj;
        zaae zaaeVar;
        Set set;
        zaae zaaeVar2;
    ...
    @oO0Oo
    public final void zar(@oo0oO0 ConnectionResult connectionResult, @o0OO00OO Exception exc) {
        Handler handler;
        com.google.android.gms.common.internal.zal zalVar;
        boolean z;
        Status zaH;
    ...
    @oO0Oo
    public final void zas(@oo0oO0 ConnectionResult connectionResult) {
        Handler handler;
        handler = this.zaa.zat;
        Preconditions.checkHandlerThread(handler);
        Api.Client client = this.zac;
