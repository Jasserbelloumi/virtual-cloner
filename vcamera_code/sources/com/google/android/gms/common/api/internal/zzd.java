...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = Collections.synchronizedMap(new o00oOOo0());
    private int zzc = 0;
    @o0OO00OO
    private Bundle zzd;
    ...
    public static zzd zzc(FragmentActivity fragmentActivity) {
        ...
        if (weakReference == null || (zzdVar = (zzd) weakReference.get()) == null) {
            try {
                zzd zzdVar2 = (zzd) fragmentActivity.o00ooo0().o0O00o00("SupportLifecycleFragmentImpl");
                if (zzdVar2 == null || zzdVar2.isRemoving()) {
                    zzdVar2 = new zzd();
                    fragmentActivity.o00ooo0().o00oo0oO().o00oOoO0(zzdVar2, "SupportLifecycleFragmentImpl").o00oo0();
                }
    ...
    public final void addCallback(String str, @oo0oO0 LifecycleCallback lifecycleCallback) {
        if (this.zzb.containsKey(str)) {
            throw new IllegalArgumentException(o00oOoO.o00oOOo0("LifecycleCallback with tag ", str, " already added to this fragment."));
        }
    ...
    @Override // androidx.fragment.app.Fragment
    public final void onActivityResult(int i, int i2, @o0OO00OO Intent intent) {
