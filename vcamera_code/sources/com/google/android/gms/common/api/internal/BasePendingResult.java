...
public abstract class BasePendingResult<R extends Result> extends PendingResult<R> {
    ...
    public static class CallbackHandler<R extends Result> extends com.google.android.gms.internal.base.zau {
        ...
        public CallbackHandler(@oo0oO0 Looper looper) {
            super(looper);
        }

        /* JADX WARN: Multi-variable type inference failed */
        @Override // android.os.Handler
        public final void handleMessage(@oo0oO0 Message message) {
            int i = message.what;
            if (i == 1) {
        ...
        public final void zaa(@oo0oO0 ResultCallback resultCallback, @oo0oO0 Result result) {
    ...
    @KeepForSdk
    @Deprecated
    public BasePendingResult(@oo0oO0 Looper looper) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    @KeepForSdk
    public BasePendingResult(@o0OO00OO GoogleApiClient googleApiClient) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    @VisibleForTesting
    @KeepForSdk
    public BasePendingResult(@oo0oO0 CallbackHandler<R> callbackHandler) {
        this.zae = new Object();
        this.zaf = new CountDownLatch(1);
        this.zag = new ArrayList();
        this.zai = new AtomicReference();
    ...
    public static void zal(@o0OO00OO Result result) {
    ...
    @oo0oO0
    @KeepForSdk
    public abstract R createFailedResult(@oo0oO0 Status status);

    @KeepForSdk
    @Deprecated
    public final void forceFailureUnlessReady(@oo0oO0 Status status) {
        synchronized (this.zae) {
            if (!isReady()) {
    ...
    @KeepForSdk
    public final void setCancelToken(@oo0oO0 ICancelToken iCancelToken) {
        synchronized (this.zae) {
    ...
    @KeepForSdk
    public final void setResult(@oo0oO0 R r) {
        synchronized (this.zae) {
    ...
    @Override // com.google.android.gms.common.api.PendingResult
    @KeepForSdk
    public final void setResultCallback(@o0OO00OO ResultCallback<? super R> resultCallback) {
        synchronized (this.zae) {
            if (resultCallback == null) {
                this.zah = null;
                return;
    ...
    public final void zan(@o0OO00OO zadb zadbVar) {
