...
public class GoogleApiManager implements Handler.Callback {
    ...
    @GuardedBy("lock")
    private final Set zar = new o00oOo00();
    private final Set zas = new o00oOo00();
    ...
    public static Status zaH(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, o0O00.o00oOOo0("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
    ...
    @oo0oO0
    public static GoogleApiManager zam(@oo0oO0 Context context) {
        GoogleApiManager googleApiManager;
        synchronized (zac) {
            if (zad == null) {
    ...
    @oO0Oo
    public final boolean handleMessage(@oo0oO0 Message message) {
        zabq zabqVar;
        ...
        switch (message.what) {
            ...
            case 5:
                ...
                if (zabqVar != null) {
                    if (connectionResult.getErrorCode() == 13) {
                        zabq.zai(zabqVar, new Status(17, o0O00.o00oOOo0("Error resolution was canceled by the user, original error message: ", this.zal.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                        break;
                    } else {
                    ...
                    Log.wtf("GoogleApiManager", oO00O0oO.o00oOOo0("Could not find API instance ", i, " while trying to fail enqueued calls.").toString(), new Exception());
                    break;
                }
            case 6:
            ...
            case 14:
                ...
                if (this.zap.containsKey(zaa2)) {
                    boolean zax = zabq.zax((zabq) this.zap.get(zaa2), false);
                    zab2 = zaafVar.zab();
    ...
    public final void zaB(@oo0oO0 GoogleApi googleApi) {
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(7, googleApi));
    }

    public final void zaC(@oo0oO0 zaae zaaeVar) {
        synchronized (zac) {
            if (this.zaq != zaaeVar) {
                this.zaq = zaaeVar;
                this.zar.clear();
    ...
    public final void zaD(@oo0oO0 zaae zaaeVar) {
        synchronized (zac) {
            if (this.zaq == zaaeVar) {
                this.zaq = null;
                this.zar.clear();
    ...
    @oo0oO0
    public final Task zao(@oo0oO0 Iterable iterable) {
    ...
    @oo0oO0
    public final Task zap(@oo0oO0 GoogleApi googleApi) {
    ...
    @oo0oO0
    public final Task zaq(@oo0oO0 GoogleApi googleApi, @oo0oO0 RegisterListenerMethod registerListenerMethod, @oo0oO0 UnregisterListenerMethod unregisterListenerMethod, @oo0oO0 Runnable runnable) {
    ...
    @oo0oO0
    public final Task zar(@oo0oO0 GoogleApi googleApi, @oo0oO0 ListenerHolder.ListenerKey listenerKey, int i) {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
    ...
    public final void zaw(@oo0oO0 GoogleApi googleApi, int i, @oo0oO0 BaseImplementation.ApiMethodImpl apiMethodImpl) {
        zae zaeVar = new zae(i, apiMethodImpl);
        Handler handler = this.zat;
        handler.sendMessage(handler.obtainMessage(4, new zach(zaeVar, this.zao.get(), googleApi)));
    }

    public final void zax(@oo0oO0 GoogleApi googleApi, int i, @oo0oO0 TaskApiCall taskApiCall, @oo0oO0 TaskCompletionSource taskCompletionSource, @oo0oO0 StatusExceptionMapper statusExceptionMapper) {
    ...
    public final void zaz(@oo0oO0 ConnectionResult connectionResult, int i) {
