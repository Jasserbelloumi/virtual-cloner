...
public final class NonGmsServiceBrokerClient implements Api.Client, ServiceConnection {
    ...
    @KeepForSdk
    public NonGmsServiceBrokerClient(@oo0oO0 Context context, @oo0oO0 Looper looper, @oo0oO0 ComponentName componentName, @oo0oO0 ConnectionCallbacks connectionCallbacks, @oo0oO0 OnConnectionFailedListener onConnectionFailedListener) {
    ...
    */
    ...
    @KeepForSdk
    public NonGmsServiceBrokerClient(@oo0oO0 Context context, @oo0oO0 Looper looper, @oo0oO0 String str, @oo0oO0 String str2, @oo0oO0 ConnectionCallbacks connectionCallbacks, @oo0oO0 OnConnectionFailedListener onConnectionFailedListener) {
    ...
    @oO0Oo
    public final void connect(@oo0oO0 BaseGmsClient.ConnectionProgressReportCallbacks connectionProgressReportCallbacks) {
        zad();
    ...
    @Override // com.google.android.gms.common.api.Api.Client
    @oO0Oo
    public final void disconnect(@oo0oO0 String str) {
        zad();
        this.zak = str;
        disconnect();
    }
    ...
    @Override // com.google.android.gms.common.api.Api.Client
    public final void dump(@oo0oO0 String str, @o0OO00OO FileDescriptor fileDescriptor, @oo0oO0 PrintWriter printWriter, @o0OO00OO String[] strArr) {
    }
    ...
    @Override // com.google.android.gms.common.api.Api.Client
    public final void getRemoteService(@o0OO00OO IAccountAccessor iAccountAccessor, @o0OO00OO Set<Scope> set) {
    }
    ...
    public final void onServiceConnected(@oo0oO0 ComponentName componentName, @oo0oO0 final IBinder iBinder) {
    ...
    @Override // com.google.android.gms.common.api.Api.Client
    public final void onUserSignOut(@oo0oO0 BaseGmsClient.SignOutCallbacks signOutCallbacks) {
    }
    ...
    public final void zac(@o0OO00OO String str) {
        this.zal = str;
    }
}
