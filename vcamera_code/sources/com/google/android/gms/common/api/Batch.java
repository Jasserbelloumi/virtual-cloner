...
public final class Batch extends BasePendingResult<BatchResult> {
    ...
    public static final class Builder {
        ...
        public Builder(@oo0oO0 GoogleApiClient googleApiClient) {
            this.zab = googleApiClient;
        }

        @oo0oO0
        public <R extends Result> BatchResultToken<R> add(@oo0oO0 PendingResult<R> pendingResult) {
    ...
    @oo0oO0
    public BatchResult createFailedResult(@oo0oO0 Status status) {
