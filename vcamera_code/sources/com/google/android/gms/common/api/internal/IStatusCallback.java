...
public interface IStatusCallback extends IInterface {
    ...
    public static abstract class Stub extends com.google.android.gms.internal.base.zab implements IStatusCallback {
        ...
        @oo0oO0
        public static IStatusCallback asInterface(@oo0oO0 IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
        ...
        public final boolean zaa(int i, @oo0oO0 Parcel parcel, @oo0oO0 Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
    ...
    void onResult(@oo0oO0 Status status) throws RemoteException;
}
