...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    public SignInButton(@oo0oO0 Context context) {
        this(context, null);
    }

    public SignInButton(@oo0oO0 Context context, @o0OO00OO AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public SignInButton(@oo0oO0 Context context, @o0OO00OO AttributeSet attributeSet, int i) {
    ...
    @Deprecated
    public void setScopes(@oo0oO0 Scope[] scopeArr) {
        setStyle(this.zaa, this.zab);
    }
    ...
    @Deprecated
    public void setStyle(int i, int i2, @oo0oO0 Scope[] scopeArr) {
        setStyle(i, i2);
    }
}
