...
public class GoogleSignatureVerifier {
    ...
    public GoogleSignatureVerifier(@oo0oO0 Context context) {
        this.zzc = context.getApplicationContext();
    }

    @oo0oO0
    @KeepForSdk
    public static GoogleSignatureVerifier getInstance(@oo0oO0 Context context) {
    ...
    public static final boolean zzb(@oo0oO0 PackageInfo packageInfo, boolean z) {
    ...
    @KeepForSdk
    public boolean isGooglePublicSignedPackage(@oo0oO0 PackageInfo packageInfo) {
        if (packageInfo == null) {
            return false;
        }
    ...
    @ShowFirstParty
    @KeepForSdk
    public boolean isPackageGoogleSigned(@oo0oO0 String str) {
