...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    public ConnectionResult(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) int i2, @SafeParcelable.Param(id = 3) @o0OO00OO PendingIntent pendingIntent, @SafeParcelable.Param(id = 4) @o0OO00OO String str) {
        this.zza = i;
        this.zzb = i2;
    ...
    public ConnectionResult(int i, @o0OO00OO PendingIntent pendingIntent) {
        this(i, pendingIntent, null);
    }

    public ConnectionResult(int i, @o0OO00OO PendingIntent pendingIntent, @o0OO00OO String str) {
                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            default:
                                return o00oOoO.o00oOOo0("UNKNOWN_ERROR_CODE(", i, ")");
                        }
                }
            }
