...
public final class WebImage extends AbstractSafeParcelable {
    ...
    public WebImage(@oo0oO0 Uri uri) throws IllegalArgumentException {
        this(uri, 0, 0);
    }

    public WebImage(@oo0oO0 Uri uri, int i, int i2) throws IllegalArgumentException {
        this(1, uri, i, i2);
        if (uri == null) {
    ...
    */
    public WebImage(@o00oOooO.oo0oO0 org.json.JSONObject r5) throws java.lang.IllegalArgumentException {
        /*
            r4 = this;
