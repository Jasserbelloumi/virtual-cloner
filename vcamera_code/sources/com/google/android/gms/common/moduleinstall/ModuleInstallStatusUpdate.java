...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    public ModuleInstallStatusUpdate(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) @InstallState int i2, @SafeParcelable.Param(id = 3) @o0OO00OO Long l, @SafeParcelable.Param(id = 4) @o0OO00OO Long l2, @SafeParcelable.Param(id = 5) int i3) {
        this.zaa = i;
        this.zab = i2;
        this.zac = l;
        this.zad = l2;
