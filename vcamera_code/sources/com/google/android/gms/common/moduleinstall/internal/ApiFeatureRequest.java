...
public class ApiFeatureRequest extends AbstractSafeParcelable {
    ...
    public ApiFeatureRequest(@SafeParcelable.Param(id = 1) @oo0oO0 List list, @SafeParcelable.Param(id = 2) boolean z, @SafeParcelable.Param(id = 3) @o0OO00OO String str, @SafeParcelable.Param(id = 4) @o0OO00OO String str2) {
    ...
    @oo0oO0
    @KeepForSdk
    public static ApiFeatureRequest fromModuleInstallRequest(@oo0oO0 ModuleInstallRequest moduleInstallRequest) {
