...
public final class Tasks {
    ...
    public static <TResult> TResult await(@oo0oO0 Task<TResult> task) throws ExecutionException, InterruptedException {
    ...
    public static <TResult> TResult await(@oo0oO0 Task<TResult> task, long j, @oo0oO0 TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        Preconditions.checkNotMainThread();
        Preconditions.checkNotNull(task, "Task must not be null");
    ...
    @oo0oO0
    @Deprecated
    public static <TResult> Task<TResult> call(@oo0oO0 Callable<TResult> callable) {
        return call(TaskExecutors.MAIN_THREAD, callable);
    }

    @oo0oO0
    @Deprecated
    public static <TResult> Task<TResult> call(@oo0oO0 Executor executor, @oo0oO0 Callable<TResult> callable) {
    ...
    @oo0oO0
    public static <TResult> Task<TResult> forException(@oo0oO0 Exception exc) {
        zzw zzwVar = new zzw();
        zzwVar.zza(exc);
        return zzwVar;
    }
    ...
    @oo0oO0
    public static Task<Void> whenAll(@o0OO00OO Collection<? extends Task<?>> collection) {
    ...
    @oo0oO0
    public static Task<Void> whenAll(@o0OO00OO Task<?>... taskArr) {
        return (taskArr == null || taskArr.length == 0) ? forResult(null) : whenAll(Arrays.asList(taskArr));
    }

    @oo0oO0
    public static Task<List<Task<?>>> whenAllComplete(@o0OO00OO Collection<? extends Task<?>> collection) {
        if (collection == null || collection.isEmpty()) {
    ...
    @oo0oO0
    public static Task<List<Task<?>>> whenAllComplete(@o0OO00OO Task<?>... taskArr) {
        return (taskArr == null || taskArr.length == 0) ? forResult(Collections.emptyList()) : whenAllComplete(Arrays.asList(taskArr));
    }

    @oo0oO0
    public static <TResult> Task<List<TResult>> whenAllSuccess(@o0OO00OO Collection<? extends Task> collection) {
        if (collection == null || collection.isEmpty()) {
            return forResult(Collections.emptyList());
        }
    ...
    @oo0oO0
    public static <TResult> Task<List<TResult>> whenAllSuccess(@o0OO00OO Task... taskArr) {
        return (taskArr == null || taskArr.length == 0) ? forResult(Collections.emptyList()) : whenAllSuccess(Arrays.asList(taskArr));
    }

    @oo0oO0
    public static <T> Task<T> withTimeout(@oo0oO0 Task<T> task, long j, @oo0oO0 TimeUnit timeUnit) {
        Preconditions.checkNotNull(task, "Task must not be null");
    ...
    private static Object zza(@oo0oO0 Task task) throws ExecutionException {
