...
public abstract class AdManagerInterstitialAd extends InterstitialAd {
    public static void load(@oo0oO0 final Context context, @oo0oO0 final String str, @oo0oO0 final AdManagerAdRequest adManagerAdRequest, @oo0oO0 final AdManagerInterstitialAdLoadCallback adManagerInterstitialAdLoadCallback) {
    ...
    public abstract void setAppEventListener(@o0OO00OO AppEventListener appEventListener);
}
