...
final class zzx implements zzfuf {
    ...
    @Override // com.google.android.gms.internal.ads.zzfuf
    public final /* bridge */ /* synthetic */ void zzb(@o0OO00OO Object obj) {
        zzfec zzfecVar;
        zzdpn zzdpnVar;
        zzdpd zzdpdVar;
        zzdpd zzdpdVar2;
        ...
        if (((Boolean) zzba.zzc().zzb(zzbar.zzhd)).booleanValue()) {
                        ...
                        try {
                            ...
                            if (TextUtils.isEmpty(optString)) {
                                ...
                                if (((Boolean) zzba.zzc().zzb(zzbar.zziK)).booleanValue()) {
                                    try {
                                        str8 = jSONObject.getJSONObject("extras").getBoolean("accept_3p_cookie") ? "1" : SessionDescription.SUPPORTED_SDP_VERSION;
                                    } catch (JSONException e) {
                                        zzbza.zzh("Error retrieving JSONObject from the requestJson, ", e);
                                    }
                                }
            ...
            try {
                ...
                zzbza.zzg("QueryInfo generation has been disabled.".concat(e4.toString()));
            }
            if (!((Boolean) zzbcd.zze.zze()).booleanValue() || zzr == null) {
                return;
            }
