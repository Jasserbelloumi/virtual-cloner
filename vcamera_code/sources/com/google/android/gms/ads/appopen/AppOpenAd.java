...
public abstract class AppOpenAd {
    ...
    @Deprecated
    public static void load(@oo0oO0 final Context context, @oo0oO0 final String str, @oo0oO0 final AdRequest adRequest, @AppOpenAdOrientation final int i, @oo0oO0 final AppOpenAdLoadCallback appOpenAdLoadCallback) {
    ...
    public static void load(@oo0oO0 final Context context, @oo0oO0 final String str, @oo0oO0 final AdRequest adRequest, @oo0oO0 final AppOpenAdLoadCallback appOpenAdLoadCallback) {
        Preconditions.checkNotNull(context, "Context cannot be null.");
        Preconditions.checkNotNull(str, "adUnitId cannot be null.");
        Preconditions.checkNotNull(adRequest, "AdRequest cannot be null.");
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
    ...
    @Deprecated
    public static void load(@oo0oO0 final Context context, @oo0oO0 final String str, @oo0oO0 final AdManagerAdRequest adManagerAdRequest, @AppOpenAdOrientation final int i, @oo0oO0 final AppOpenAdLoadCallback appOpenAdLoadCallback) {
        Preconditions.checkNotNull(context, "Context cannot be null.");
        Preconditions.checkNotNull(str, "adUnitId cannot be null.");
    ...
    public abstract void show(@oo0oO0 Activity activity);
}
