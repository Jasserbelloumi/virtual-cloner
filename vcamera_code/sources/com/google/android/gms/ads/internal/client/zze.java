...
public final class zze extends AbstractSafeParcelable {
    ...
    public zze(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) String str2, @SafeParcelable.Param(id = 4) @o0OO00OO zze zzeVar, @SafeParcelable.Param(id = 5) @o0OO00OO IBinder iBinder) {
        this.zza = i;
        this.zzb = str;
        this.zzc = str2;
        this.zzd = zzeVar;
