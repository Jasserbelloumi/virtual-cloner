...
public abstract class BaseAdView extends ViewGroup {
    ...
    public BaseAdView(@oo0oO0 Context context, int i) {
        super(context);
        this.zza = new zzea(this, i);
    }

    public BaseAdView(@oo0oO0 Context context, @oo0oO0 AttributeSet attributeSet, int i) {
        super(context, attributeSet);
        this.zza = new zzea(this, attributeSet, false, i);
    }

    public BaseAdView(@oo0oO0 Context context, @oo0oO0 AttributeSet attributeSet, int i, int i2) {
        super(context, attributeSet, i);
        this.zza = new zzea(this, attributeSet, false, i2);
    }

    public BaseAdView(@oo0oO0 Context context, @oo0oO0 AttributeSet attributeSet, int i, int i2, boolean z) {
        super(context, attributeSet, i);
        this.zza = new zzea(this, attributeSet, z, i2);
    }

    public BaseAdView(@oo0oO0 Context context, @oo0oO0 AttributeSet attributeSet, boolean z) {
        super(context, attributeSet);
    ...
    public void setAdListener(@oo0oO0 AdListener adListener) {
    ...
    public void setAdSize(@oo0oO0 AdSize adSize) {
        this.zza.zzs(adSize);
    }

    public void setAdUnitId(@oo0oO0 String str) {
        this.zza.zzu(str);
    }

    public void setOnPaidEventListener(@o0OO00OO OnPaidEventListener onPaidEventListener) {
