...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    public MediaCodecAudioRenderer(Context context, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, boolean z, @o0OO00OO Handler handler, @o0OO00OO AudioRendererEventListener audioRendererEventListener, AudioSink audioSink) {
    ...
    public MediaCodecAudioRenderer(Context context, MediaCodecSelector mediaCodecSelector, @o0OO00OO Handler handler, @o0OO00OO AudioRendererEventListener audioRendererEventListener) {
    ...
    public MediaCodecAudioRenderer(Context context, MediaCodecSelector mediaCodecSelector, @o0OO00OO Handler handler, @o0OO00OO AudioRendererEventListener audioRendererEventListener, AudioCapabilities audioCapabilities, AudioProcessor... audioProcessorArr) {
    ...
    public MediaCodecAudioRenderer(Context context, MediaCodecSelector mediaCodecSelector, @o0OO00OO Handler handler, @o0OO00OO AudioRendererEventListener audioRendererEventListener, AudioSink audioSink) {
        this(context, MediaCodecAdapter.Factory.DEFAULT, mediaCodecSelector, false, handler, audioRendererEventListener, audioSink);
    }

    public MediaCodecAudioRenderer(Context context, MediaCodecSelector mediaCodecSelector, boolean z, @o0OO00OO Handler handler, @o0OO00OO AudioRendererEventListener audioRendererEventListener, AudioSink audioSink) {
    ...
    @Override // com.google.android.exoplayer2.mediacodec.MediaCodecRenderer
    public void onOutputFormatChanged(Format format, @o0OO00OO MediaFormat mediaFormat) throws ExoPlaybackException {
        int i;
