...
public abstract class DecoderAudioRenderer<T extends Decoder<DecoderInputBuffer, ? extends SimpleDecoderOutputBuffer, ? extends DecoderException>> extends BaseRenderer implements MediaClock {
    ...
    public DecoderAudioRenderer(@o0OO00OO Handler handler, @o0OO00OO AudioRendererEventListener audioRendererEventListener, AudioCapabilities audioCapabilities, AudioProcessor... audioProcessorArr) {
        this(handler, audioRendererEventListener, new DefaultAudioSink.Builder().setAudioCapabilities((AudioCapabilities) MoreObjects.firstNonNull(audioCapabilities, AudioCapabilities.DEFAULT_AUDIO_CAPABILITIES)).setAudioProcessors(audioProcessorArr).build());
    }

    public DecoderAudioRenderer(@o0OO00OO Handler handler, @o0OO00OO AudioRendererEventListener audioRendererEventListener, AudioSink audioSink) {
        super(1);
    ...
    public DecoderAudioRenderer(@o0OO00OO Handler handler, @o0OO00OO AudioRendererEventListener audioRendererEventListener, AudioProcessor... audioProcessorArr) {
    ...
    public abstract T createDecoder(Format format, @o0OO00OO CryptoConfig cryptoConfig) throws DecoderException;
