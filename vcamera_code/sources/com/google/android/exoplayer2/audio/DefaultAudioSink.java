...
public final class DefaultAudioSink implements AudioSink {
    ...
    public final class PositionTrackerListener implements AudioTrackPositionTracker.Listener {
        ...
        public void onPositionFramesMismatch(long j, long j2, long j3, long j4) {
            StringBuilder o00oOOo02 = androidx.concurrent.futures.o00oOOo0.o00oOOo0("Spurious audio timestamp (frame position mismatch): ", j, ", ");
            o00oOOo02.append(j2);
            o00oOOo02.append(", ");
            o00oOOo02.append(j3);
            o00oOOo02.append(", ");
            o00oOOo02.append(j4);
            o00oOOo02.append(", ");
            o00oOOo02.append(DefaultAudioSink.this.getSubmittedFrames());
            o00oOOo02.append(", ");
            o00oOOo02.append(DefaultAudioSink.this.getWrittenFrames());
        ...
        public void onSystemTimeUsMismatch(long j, long j2, long j3, long j4) {
            StringBuilder o00oOOo02 = androidx.concurrent.futures.o00oOOo0.o00oOOo0("Spurious audio timestamp (system clock mismatch): ", j, ", ");
            o00oOOo02.append(j2);
            o00oOOo02.append(", ");
            o00oOOo02.append(j3);
            o00oOOo02.append(", ");
    ...
    public final class StreamEventCallbackV29 {
        ...
        public void register(AudioTrack audioTrack) {
            ...
            audioTrack.registerStreamEventCallback(new androidx.emoji2.text.o00oOOoO(handler), this.callback);
        }
    ...
    @Deprecated
    public DefaultAudioSink(@o0OO00OO AudioCapabilities audioCapabilities, AudioProcessorChain audioProcessorChain, boolean z, boolean z2, int i) {
    ...
    @InlineMeValidationDisabled("Migrate constructor to Builder")
    @Deprecated
    public DefaultAudioSink(@o0OO00OO AudioCapabilities audioCapabilities, AudioProcessor[] audioProcessorArr) {
    ...
    @InlineMeValidationDisabled("Migrate constructor to Builder")
    @Deprecated
    public DefaultAudioSink(@o0OO00OO AudioCapabilities audioCapabilities, AudioProcessor[] audioProcessorArr, boolean z) {
    ...
    */
    ...
    private static int getFramesPerEncodedSample(int i, ByteBuffer byteBuffer) {
        switch (i) {
            ...
            case 13:
            default:
                throw new IllegalStateException(android.support.v4.media.o00oOOo0.o00oOOo0("Unexpected audio encoding: ", i));
            case 14:
    ...
    public void configure(Format format, int i, @o0OO00OO int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if (MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            i5 = 0;
            i3 = Util.getPcmFrameSize(i9, audioFormat.channelCount);
            i6 = i9;
            i4 = i10;
        ...
        if (i != 0) {
            ...
            i7 = i6;
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i4, intValue, i6), i6, i5, i3, i4, this.enableAudioTrackPlaybackParams ? 8.0d : 1.0d);
        }
        if (i7 == 0) {
            ...
            Configuration configuration = new Configuration(format, i2, i5, i3, i4, intValue, i7, bufferSizeInBytes, audioProcessorArr);
            if (isAudioTrackInitialized()) {
    ...
    public int getFormatSupport(Format format) {
        if (!MimeTypes.AUDIO_RAW.equals(format.sampleMimeType)) {
            ...
            StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("Invalid PCM encoding: ");
            o00oOOo02.append(format.pcmEncoding);
    ...
    @Override // com.google.android.exoplayer2.audio.AudioSink
    public void setPlayerId(@o0OO00OO PlayerId playerId) {
