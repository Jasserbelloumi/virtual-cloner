...
public final class AacUtil {
    ...
    public static byte[] buildAacLcAudioSpecificConfig(int i, int i2) {
        ...
        if (i == -1 || i6 == -1) {
            throw new IllegalArgumentException(o0oO0Ooo.o00oOOo0("Invalid sample rate or number of channels: ", i, ", ", i2));
        }
    ...
    public static Config parseAudioSpecificConfig(ParsableBitArray parsableBitArray, boolean z) throws ParserException {
        ...
        int readBits = parsableBitArray.readBits(4);
        String o00oOOo02 = android.support.v4.media.o00oOOo0.o00oOOo0(CODECS_STRING_PREFIX, audioObjectType);
        ...
        if (i != -1) {
            return new Config(samplingFrequency, i, o00oOOo02);
        }
        throw ParserException.createForMalformedContainer(null, null);
    }
