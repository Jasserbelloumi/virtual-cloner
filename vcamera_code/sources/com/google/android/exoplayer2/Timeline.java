...
public abstract class Timeline implements Bundleable {
    ...
    public static final Bundleable.Creator<Timeline> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.oO000O0
    ...
    public static final class Period implements Bundleable {
        public static final Bundleable.Creator<Period> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.oO000O0O
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public int hashCode() {
            ...
            return this.adPlaybackState.hashCode() + ((((((((((hashCode + hashCode2) * 31) + this.windowIndex) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31) + (this.isPlaceholder ? 1 : 0)) * 31);
        }
        ...
        public Period set(@o00oOooO.o0OO00OO Object obj, @o00oOooO.o0OO00OO Object obj2, int i, long j, long j2) {
            return set(obj, obj2, i, j, j2, AdPlaybackState.NONE, false);
        }

        public Period set(@o00oOooO.o0OO00OO Object obj, @o00oOooO.o0OO00OO Object obj2, int i, long j, long j2, AdPlaybackState adPlaybackState, boolean z) {
            this.id = obj;
            this.uid = obj2;
            this.windowIndex = i;
            this.durationUs = j;
    ...
    public static final class Window implements Bundleable {
        ...
        public static final Bundleable.Creator<Window> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.oO0Ooooo
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public Window set(Object obj, @o00oOooO.o0OO00OO MediaItem mediaItem, @o00oOooO.o0OO00OO Object obj2, long j, long j2, long j3, boolean z, boolean z2, @o00oOooO.o0OO00OO MediaItem.LiveConfiguration liveConfiguration, long j4, long j5, int i, int i2, long j6) {
    ...
    private static <T extends Bundleable> ImmutableList<T> fromBundleListRetriever(Bundleable.Creator<T> creator, @o00oOooO.o0OO00OO IBinder iBinder) {
        if (iBinder == null) {
