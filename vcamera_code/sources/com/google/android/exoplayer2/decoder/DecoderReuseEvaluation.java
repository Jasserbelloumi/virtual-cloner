...
public final class DecoderReuseEvaluation {
    ...
    public int hashCode() {
        int o00oOOo02 = o00oo0O0.o00oOOo0(this.decoderName, (((this.result + 527) * 31) + this.discardReasons) * 31, 31);
        return this.newFormat.hashCode() + ((this.oldFormat.hashCode() + o00oOOo02) * 31);
    }
}
