...
public final class AviExtractor implements Extractor {
    ...
    public static class ChunkHeaderHolder {
        ...
        public void populateWithListHeaderFrom(ParsableByteArray parsableByteArray) throws ParserException {
            ...
            StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("LIST expected, found: ");
            o00oOOo02.append(this.chunkType);
    ...
    private void parseHdrlBody(ParsableByteArray parsableByteArray) throws IOException {
        ...
        if (parseFrom.getType() != 1819436136) {
            StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("Unexpected header list type ");
            o00oOOo02.append(parseFrom.getType());
            throw ParserException.createForMalformedContainer(o00oOOo02.toString(), null);
        }
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        switch (this.state) {
            ...
            case 1:
                ...
                StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("hdrl expected, found: ");
                o00oOOo02.append(this.chunkHeaderHolder.listType);
                throw ParserException.createForMalformedContainer(o00oOOo02.toString(), null);
            case 2:
