...
public final class VorbisUtil {
    ...
    private static CodeBook readBook(VorbisBitArray vorbisBitArray) throws ParserException {
        if (vorbisBitArray.readBits(24) != 5653314) {
            StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("expected code book to start with [0x56, 0x43, 0x42] at ");
            o00oOOo02.append(vorbisBitArray.getPosition());
    ...
    public static boolean verifyVorbisHeaderCapturePattern(int i, ParsableByteArray parsableByteArray, boolean z) throws ParserException {
        if (parsableByteArray.bytesLeft() < 7) {
            ...
            StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("too short header: ");
            o00oOOo02.append(parsableByteArray.bytesLeft());
            throw ParserException.createForMalformedContainer(o00oOOo02.toString(), null);
        } else if (parsableByteArray.readUnsignedByte() != i) {
            if (z) {
                return false;
            }
            StringBuilder o00oOOo03 = android.support.v4.media.o00oOo0O.o00oOOo0("expected header type ");
            o00oOOo03.append(Integer.toHexString(i));
            throw ParserException.createForMalformedContainer(o00oOOo03.toString(), null);
