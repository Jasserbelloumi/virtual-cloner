...
public final class WavExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.wav.o00oOOo0
    ...
    public static final class PassthroughOutputWriter implements OutputWriter {
        ...
        public PassthroughOutputWriter(ExtractorOutput extractorOutput, TrackOutput trackOutput, WavFormat wavFormat, String str, int i) throws ParserException {
            ...
            if (wavFormat.blockSize != i2) {
                StringBuilder o00oOOo02 = oO00O0oO.o00oOOo0("Expected block size: ", i2, "; got: ");
                o00oOOo02.append(wavFormat.blockSize);
    ...
    private void readFormat(ExtractorInput extractorInput) throws IOException {
        ...
        if (i == 17) {
            ...
            passthroughOutputWriter = new PassthroughOutputWriter(this.extractorOutput, this.trackOutput, readFormat, MimeTypes.AUDIO_ALAW, -1);
        } else if (i == 7) {
            passthroughOutputWriter = new PassthroughOutputWriter(this.extractorOutput, this.trackOutput, readFormat, MimeTypes.AUDIO_MLAW, -1);
        } else {
            int pcmEncodingForType = WavUtil.getPcmEncodingForType(i, readFormat.bitsPerSample);
            if (pcmEncodingForType == 0) {
                StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("Unsupported WAV format type: ");
                o00oOOo02.append(readFormat.formatType);
                throw ParserException.createForUnsupportedContainerFeature(o00oOOo02.toString());
            }
            passthroughOutputWriter = new PassthroughOutputWriter(this.extractorOutput, this.trackOutput, readFormat, MimeTypes.AUDIO_RAW, pcmEncodingForType);
        }
    ...
    private void skipToSampleData(ExtractorInput extractorInput) throws IOException {
        ...
        if (j != -1 && longValue == UnsignedInts.INT_MASK) {
            longValue = j;
        }
        this.dataEndPosition = this.dataStartPosition + longValue;
        long length = extractorInput.getLength();
        if (length != -1 && this.dataEndPosition > length) {
            StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("Data exceeds input length: ");
            o00oOOo02.append(this.dataEndPosition);
            o00oOOo02.append(", ");
