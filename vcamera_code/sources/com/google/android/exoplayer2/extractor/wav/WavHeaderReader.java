...
final class WavHeaderReader {
    ...
    private static ChunkHeader skipToChunk(int i, ExtractorInput extractorInput, ParsableByteArray parsableByteArray) throws IOException {
        while (true) {
            ...
            StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("Ignoring unknown WAV chunk: ");
            o00oOOo02.append(peek.id);
            Log.w(TAG, o00oOOo02.toString());
            long j = peek.size + 8;
            if (j > 2147483647L) {
                StringBuilder o00oOOo03 = o00oOo0O.o00oOOo0("Chunk is too large (~2GB+) to skip; id: ");
                o00oOOo03.append(peek.id);
                throw ParserException.createForUnsupportedContainerFeature(o00oOOo03.toString());
            }
