        ...
        if (this.isLastScrValueRead) {
            ...
            if (this.isFirstScrValueRead) {
                ...
                if (adjustTsTimestamp < 0) {
                    StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("Invalid duration: ");
                    o00oOOo02.append(this.durationUs);
                    o00oOOo02.append(". Using TIME_UNSET instead.");
