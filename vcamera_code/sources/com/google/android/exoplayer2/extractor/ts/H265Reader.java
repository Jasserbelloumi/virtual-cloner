...
public final class H265Reader implements ElementaryStreamReader {
    ...
    private static Format parseMediaFormat(@o0OO00OO String str, NalUnitTargetBuffer nalUnitTargetBuffer, NalUnitTargetBuffer nalUnitTargetBuffer2, NalUnitTargetBuffer nalUnitTargetBuffer3) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (readBits5 == 255) {
                    ...
                    if (readBits5 < fArr.length) {
                        ...
                        com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Unexpected aspect_ratio_idc value: ", readBits5, TAG);
                    }
                }
            }
            if (parsableNalUnitBitArray.readBit()) {
