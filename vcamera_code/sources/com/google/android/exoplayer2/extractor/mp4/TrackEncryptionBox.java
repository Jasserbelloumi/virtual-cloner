...
public final class TrackEncryptionBox {
    ...
    public TrackEncryptionBox(boolean z, @o0OO00OO String str, int i, byte[] bArr, int i2, int i3, @o0OO00OO byte[] bArr2) {
    ...
    private static int schemeToCryptoMode(@o0OO00OO String str) {
        if (str == null) {
            return 1;
        }
        char c = 65535;
