...
public final class AtomParsers {
    ...
    */
    private static void parseAudioSampleEntry(com.google.android.exoplayer2.util.ParsableByteArray r22, int r23, int r24, int r25, int r26, java.lang.String r27, boolean r28, @o00oOooO.o0OO00OO com.google.android.exoplayer2.drm.DrmInitData r29, com.google.android.exoplayer2.extractor.mp4.AtomParsers.StsdData r30, int r31) throws com.google.android.exoplayer2.ParserException {
        /*
    ...
    private static Pair<Long, String> parseMdhd(ParsableByteArray parsableByteArray) {
        ...
        o00oOOo02.append((char) (((readUnsignedShort >> 10) & 31) + 96));
        o00oOOo02.append((char) (((readUnsignedShort >> 5) & 31) + 96));
        o00oOOo02.append((char) ((readUnsignedShort & 31) + 96));
        return Pair.create(Long.valueOf(readUnsignedInt), o00oOOo02.toString());
    }
    ...
    public static Metadata parseMdtaFromMeta(Atom.ContainerAtom containerAtom) {
        ...
        while (parsableByteArray2.bytesLeft() > 8) {
            ...
            if (readInt4 < 0 || readInt4 >= readInt) {
                com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Skipped metadata with unknown key index: ", readInt4, TAG);
            } else {
    ...
    /* JADX WARN: Removed duplicated region for block: B:207:0x040e A[EDGE_INSN: B:207:0x040e->B:168:0x040e ?: BREAK  , SYNTHETIC] */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private static com.google.android.exoplayer2.extractor.mp4.TrackSampleTable parseStbl(com.google.android.exoplayer2.extractor.mp4.Track r35, com.google.android.exoplayer2.extractor.mp4.Atom.ContainerAtom r36, com.google.android.exoplayer2.extractor.GaplessInfoHolder r37) throws com.google.android.exoplayer2.ParserException {
        /*
    ...
    private static StsdData parseStsd(ParsableByteArray parsableByteArray, int i, int i2, String str, @o0OO00OO DrmInitData drmInitData, boolean z) throws ParserException {
        int i3;
        parsableByteArray.setPosition(12);
        int readInt = parsableByteArray.readInt();
    ...
    @o0OO00OO
    private static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j, @o0OO00OO DrmInitData drmInitData, boolean z, boolean z2) throws ParserException {
    ...
    public static List<TrackSampleTable> parseTraks(Atom.ContainerAtom containerAtom, GaplessInfoHolder gaplessInfoHolder, long j, @o0OO00OO DrmInitData drmInitData, boolean z, boolean z2, Function<Track, Track> function) throws ParserException {
        Track apply;
        ArrayList arrayList = new ArrayList();
    ...
    private static void parseVideoSampleEntry(ParsableByteArray parsableByteArray, int i, int i2, int i3, int i4, int i5, @o0OO00OO DrmInitData drmInitData, StsdData stsdData, int i6) throws ParserException {
        ...
        String str2 = i15 == 1831958048 ? MimeTypes.VIDEO_MPEG : i15 == 1211250227 ? MimeTypes.VIDEO_H263 : null;
        float f3 = 1.0f;
        byte[] bArr3 = null;
        String str3 = null;
                ...
                if (readInt2 == 1685480259 || readInt2 == 1685485123) {
                    ...
                    if (readInt2 == 1987076931) {
                        ...
                        if (readInt2 == 1681012275) {
                            ...
                            String str4 = parseEsdsFromParent.mimeType;
                            byte[] bArr4 = parseEsdsFromParent.initializationData;
                            ...
                            if (readInt3 == TYPE_nclx || readInt3 == TYPE_nclc) {
                                ...
                                StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("Unsupported color type: ");
                                o00oOOo02.append(Atom.getAtomTypeString(readInt3));
        ...
        Format.Builder drmInitData4 = new Format.Builder().setId(i4).setSampleMimeType(str2).setCodecs(str3).setWidth(readUnsignedShort).setHeight(i7).setPixelWidthHeightRatio(f).setRotationDegrees(i5).setProjectionData(bArr).setStereoMode(i20).setInitializationData(list).setDrmInitData(drmInitData2);
        int i21 = i17;
        int i22 = i18;
        int i23 = i19;
        if (i21 != -1 || i22 != -1 || i23 != -1 || byteBuffer != null) {
            drmInitData4.setColorInfo(new ColorInfo(i21, i22, i23, byteBuffer != null ? byteBuffer.array() : null));
        }
        if (esdsData != null) {
