...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.mp4.o00oOOoO
    ...
    public FragmentedMp4Extractor(int i, @o0OO00OO TimestampAdjuster timestampAdjuster) {
        this(i, timestampAdjuster, null, Collections.emptyList());
    }

    public FragmentedMp4Extractor(int i, @o0OO00OO TimestampAdjuster timestampAdjuster, @o0OO00OO Track track) {
        this(i, timestampAdjuster, track, Collections.emptyList());
    }

    public FragmentedMp4Extractor(int i, @o0OO00OO TimestampAdjuster timestampAdjuster, @o0OO00OO Track track, List<Format> list) {
        this(i, timestampAdjuster, track, list, null);
    }

    public FragmentedMp4Extractor(int i, @o0OO00OO TimestampAdjuster timestampAdjuster, @o0OO00OO Track track, List<Format> list, @o0OO00OO TrackOutput trackOutput) {
        this.flags = i;
    ...
    private void onEmsgLeafAtomRead(ParsableByteArray parsableByteArray) {
        ...
        if (parseFullAtomVersion == 0) {
            ...
            com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Skipping unsupported emsg version: ", parseFullAtomVersion, TAG);
            return;
        } else {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), j, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: com.google.android.exoplayer2.extractor.mp4.o00oOOo0
    ...
    private static void parseSaiz(TrackEncryptionBox trackEncryptionBox, ParsableByteArray parsableByteArray, TrackFragment trackFragment) throws ParserException {
        ...
        if (readUnsignedIntToInt > trackFragment.sampleCount) {
            StringBuilder o00oOOo02 = oO00O0oO.o00oOOo0("Saiz sample count ", readUnsignedIntToInt, " is greater than fragment sample count");
            o00oOOo02.append(trackFragment.sampleCount);
            throw ParserException.createForMalformedContainer(o00oOOo02.toString(), null);
        }
    ...
    private static void parseSampleGroups(Atom.ContainerAtom containerAtom, @o0OO00OO String str, TrackFragment trackFragment) throws ParserException {
        byte[] bArr = null;
    ...
    private static void parseSenc(ParsableByteArray parsableByteArray, int i, TrackFragment trackFragment) throws ParserException {
        ...
        if (readUnsignedIntToInt == 0) {
            ...
            StringBuilder o00oOOo02 = oO00O0oO.o00oOOo0("Senc sample count ", readUnsignedIntToInt, " is different from fragment sample count");
            o00oOOo02.append(trackFragment.sampleCount);
            throw ParserException.createForMalformedContainer(o00oOOo02.toString(), null);
        } else {
    ...
    private static Pair<Long, ChunkIndex> parseSidx(ParsableByteArray parsableByteArray, long j) throws ParserException {
        ...
        long j3 = readUnsignedLongToLong2 + j;
    ...
    */
    private static int parseTrun(com.google.android.exoplayer2.extractor.mp4.FragmentedMp4Extractor.TrackBundle r33, int r34, int r35, com.google.android.exoplayer2.util.ParsableByteArray r36, int r37) throws com.google.android.exoplayer2.ParserException {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    private boolean readAtomHeader(com.google.android.exoplayer2.extractor.ExtractorInput r12) throws java.io.IOException {
        /*
    ...
    @o0OO00OO
    public Track modifyTrack(@o0OO00OO Track track) {
        return track;
    }
