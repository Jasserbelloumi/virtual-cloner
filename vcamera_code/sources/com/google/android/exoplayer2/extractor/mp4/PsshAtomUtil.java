...
public final class PsshAtomUtil {
    ...
    public static byte[] buildPsshAtom(UUID uuid, @o0OO00OO byte[] bArr) {
        return buildPsshAtom(uuid, null, bArr);
    }

    public static byte[] buildPsshAtom(UUID uuid, @o0OO00OO UUID[] uuidArr, @o0OO00OO byte[] bArr) {
        int length = (bArr != null ? bArr.length : 0) + 32;
        if (uuidArr != null) {
            length = o0oO0Ooo.o00oOOo0(uuidArr.length, 16, 4, length);
        }
    ...
    private static PsshAtom parsePsshAtom(byte[] bArr) {
        ...
        if (parsableByteArray.readInt() == parsableByteArray.bytesLeft() + 4 && parsableByteArray.readInt() == 1886614376) {
            ...
            if (parseFullAtomVersion > 1) {
                com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Unsupported pssh version: ", parseFullAtomVersion, TAG);
                return null;
            }
