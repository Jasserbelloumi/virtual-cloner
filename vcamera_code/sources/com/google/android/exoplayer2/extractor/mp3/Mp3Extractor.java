...
public final class Mp3Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = new ExtractorsFactory() { // from class: com.google.android.exoplayer2.extractor.mp3.o00oOOo0
    ...
    private static final Id3Decoder.FramePredicate REQUIRED_ID3_FRAME_PREDICATE = new Id3Decoder.FramePredicate() { // from class: com.google.android.exoplayer2.extractor.mp3.o00oOOoO
    ...
    private static long getId3TlenUs(@o0OO00OO Metadata metadata) {
        if (metadata != null) {
    ...
    @o0OO00OO
    private static MlltSeeker maybeHandleSeekMetadata(@o0OO00OO Metadata metadata, long j) {
        if (metadata != null) {
            int length = metadata.length();
            for (int i = 0; i < length; i++) {
                Metadata.Entry entry = metadata.get(i);
