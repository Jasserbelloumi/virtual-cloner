...
public final class FlacStreamMetadata {
    ...
    private FlacStreamMetadata(int i, int i2, int i3, int i4, int i5, int i6, int i7, long j, @o0OO00OO SeekTable seekTable, @o0OO00OO Metadata metadata) {
    ...
    public FlacStreamMetadata copyWithSeekTable(@o0OO00OO SeekTable seekTable) {
    ...
    public Format getFormat(byte[] bArr, @o0OO00OO Metadata metadata) {
    ...
    @o0OO00OO
    public Metadata getMetadataCopyWithAppendedEntriesFrom(@o0OO00OO Metadata metadata) {
