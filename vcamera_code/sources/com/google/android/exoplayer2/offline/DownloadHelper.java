...
public final class DownloadHelper {
    ...
    public static final class MediaPreparer implements MediaSource.MediaSourceCaller, MediaPeriod.Callback, Handler.Callback {
        ...
        private final Handler downloadHelperHandler = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: com.google.android.exoplayer2.offline.o00oo0OO
    ...
    public DownloadHelper(MediaItem mediaItem, @o0OO00OO MediaSource mediaSource, TrackSelectionParameters trackSelectionParameters, RendererCapabilities[] rendererCapabilitiesArr) {
        ...
        defaultTrackSelector.init(new TrackSelector.InvalidationListener() { // from class: com.google.android.exoplayer2.offline.o00oOo00
    ...
    public static MediaSource createMediaSource(DownloadRequest downloadRequest, DataSource.Factory factory, @o0OO00OO DrmSessionManager drmSessionManager) {
        return createMediaSourceInternal(downloadRequest.toMediaItem(), factory, drmSessionManager);
    }

    private static MediaSource createMediaSourceInternal(MediaItem mediaItem, DataSource.Factory factory, @o0OO00OO final DrmSessionManager drmSessionManager) {
        DefaultMediaSourceFactory defaultMediaSourceFactory = new DefaultMediaSourceFactory(factory, ExtractorsFactory.EMPTY);
        if (drmSessionManager != null) {
            defaultMediaSourceFactory.setDrmSessionManagerProvider(new DrmSessionManagerProvider() { // from class: com.google.android.exoplayer2.offline.o00oOOo0
    ...
    @Deprecated
    public static DownloadHelper forDash(Uri uri, DataSource.Factory factory, RenderersFactory renderersFactory, @o0OO00OO DrmSessionManager drmSessionManager, TrackSelectionParameters trackSelectionParameters) {
    ...
    @Deprecated
    public static DownloadHelper forHls(Uri uri, DataSource.Factory factory, RenderersFactory renderersFactory, @o0OO00OO DrmSessionManager drmSessionManager, TrackSelectionParameters trackSelectionParameters) {
    ...
    public static DownloadHelper forMediaItem(Context context, MediaItem mediaItem, @o0OO00OO RenderersFactory renderersFactory, @o0OO00OO DataSource.Factory factory) {
        return forMediaItem(mediaItem, getDefaultTrackSelectorParameters(context), renderersFactory, factory, null);
    }

    public static DownloadHelper forMediaItem(MediaItem mediaItem, TrackSelectionParameters trackSelectionParameters, @o0OO00OO RenderersFactory renderersFactory, @o0OO00OO DataSource.Factory factory) {
        return forMediaItem(mediaItem, trackSelectionParameters, renderersFactory, factory, null);
    }

    public static DownloadHelper forMediaItem(MediaItem mediaItem, TrackSelectionParameters trackSelectionParameters, @o0OO00OO RenderersFactory renderersFactory, @o0OO00OO DataSource.Factory factory, @o0OO00OO DrmSessionManager drmSessionManager) {
    ...
    @Deprecated
    public static DownloadHelper forProgressive(Context context, Uri uri, @o0OO00OO String str) {
    ...
    @Deprecated
    public static DownloadHelper forSmoothStreaming(Uri uri, DataSource.Factory factory, RenderersFactory renderersFactory, @o0OO00OO DrmSessionManager drmSessionManager, TrackSelectionParameters trackSelectionParameters) {
    ...
    public static RendererCapabilities[] getRendererCapabilities(RenderersFactory renderersFactory) {
        ...
        }, new TextOutput() { // from class: com.google.android.exoplayer2.offline.o00oOo0O
            @Override // com.google.android.exoplayer2.text.TextOutput
            public final void onCues(CueGroup cueGroup) {
                DownloadHelper.lambda$getRendererCapabilities$0(cueGroup);
            }
        }, new MetadataOutput() { // from class: com.google.android.exoplayer2.offline.o00oOoO
    ...
    public void onMediaPreparationFailed(final IOException iOException) {
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: com.google.android.exoplayer2.offline.o00oOOoO
    ...
    public void onMediaPrepared() throws ExoPlaybackException {
        ...
        ((Handler) Assertions.checkNotNull(this.callbackHandler)).post(new Runnable() { // from class: com.google.android.exoplayer2.offline.o00oo00O
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public DownloadRequest getDownloadRequest(String str, @o0OO00OO byte[] bArr) {
    ...
    public DownloadRequest getDownloadRequest(@o0OO00OO byte[] bArr) {
    ...
    public void prepare(final Callback callback) {
        ...
        if (mediaSource != null) {
            ...
            this.callbackHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.offline.o00oo0
                @Override // java.lang.Runnable
                public final void run() {
