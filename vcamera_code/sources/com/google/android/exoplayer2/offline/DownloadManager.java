...
public final class DownloadManager {
    ...
    public static final class DownloadUpdate {
        ...
        public DownloadUpdate(Download download, boolean z, List<Download> list, @o0OO00OO Exception exc) {
    ...
    public static final class InternalHandler extends Handler {
        ...
        private void onDownloadTaskStopped(Download download, @o0OO00OO Exception exc) {
        ...
        private void onTaskStopped(Task task) {
            ...
            if (exc != null) {
                StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("Task failed: ");
                o00oOOo02.append(task.request);
                o00oOOo02.append(", ");
                o00oOOo02.append(z);
                Log.e(DownloadManager.TAG, o00oOOo02.toString(), exc);
            }
        ...
        */
        private com.google.android.exoplayer2.offline.Download putDownload(com.google.android.exoplayer2.offline.Download r8) {
            /*
                r7 = this;
                int r0 = r8.state
                r1 = 1
            ...
            Ld:
                ...
                int r0 = r7.getDownloadIndex(r0)
                r3 = -1
                if (r0 != r3) goto L2b
                java.util.ArrayList<com.google.android.exoplayer2.offline.Download> r0 = r7.downloads
                r0.add(r8)
                java.util.ArrayList<com.google.android.exoplayer2.offline.Download> r0 = r7.downloads
                com.google.android.exoplayer2.offline.o0O0o r1 = new com.google.android.exoplayer2.offline.o0O0o
                r1.<init>()
            L27:
            ...
            L2b:
                ...
                java.util.ArrayList<com.google.android.exoplayer2.offline.Download> r5 = r7.downloads
            ...
            L3c:
                r1 = r2
            L3d:
                java.util.ArrayList<com.google.android.exoplayer2.offline.Download> r3 = r7.downloads
                r3.set(r0, r8)
                if (r1 == 0) goto L4c
                java.util.ArrayList<com.google.android.exoplayer2.offline.Download> r0 = r7.downloads
                com.google.android.exoplayer2.offline.o0O0o r1 = new com.google.android.exoplayer2.offline.o0O0o
                ...
                goto L27
            L4c:
                com.google.android.exoplayer2.offline.WritableDownloadIndex r0 = r7.downloadIndex     // Catch: java.io.IOException -> L52
                r0.putDownload(r8)     // Catch: java.io.IOException -> L52
                goto L5a
            L52:
                r0 = move-exception
        ...
        private void removeAllDownloads() {
            ...
            Collections.sort(this.downloads, new o0O0o());
            try {
        ...
        private void setStopReason(@o0OO00OO String str, int i) {
            if (str == null) {
        ...
        @o0OO00OO
        @o0OoO00O
        private Task syncQueuedDownload(@o0OO00OO Task task, Download download) {
            if (task != null) {
                Assertions.checkState(!task.isRemove);
                task.cancel(false);
                return task;
        ...
        private void syncRemovingDownload(@o0OO00OO Task task, Download download) {
            if (task != null) {
                if (task.isRemove) {
                    return;
                }
        ...
        private void syncStoppedDownload(@o0OO00OO Task task) {
            if (task != null) {
                Assertions.checkState(!task.isRemove);
                task.cancel(false);
            }
    ...
    public interface Listener {
        default void onDownloadChanged(DownloadManager downloadManager, Download download, @o0OO00OO Exception exc) {
        }
    ...
    public DownloadManager(Context context, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context, databaseProvider, cache, factory, new o0O0OO0.o00oo00O());
    }
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler createHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: com.google.android.exoplayer2.offline.o00oo0O0
        ...
        this.internalHandler = internalHandler;
        RequirementsWatcher.Listener listener = new RequirementsWatcher.Listener() { // from class: com.google.android.exoplayer2.offline.o00oo0O
    ...
    public void setMaxParallelDownloads(@o0O0o00O(from = 1) int i) {
    ...
    public void setStopReason(@o0OO00OO String str, int i) {
        this.pendingMessages++;
