...
public final class DefaultDownloadIndex implements WritableDownloadIndex {
    ...
    public DefaultDownloadIndex(DatabaseProvider databaseProvider, String str) {
        ...
        this.tableName = o00oOoOo.o00oo.o00oOOo0(TABLE_PREFIX, str);
        this.initializationLock = new Object();
    }

    private static List<StreamKey> decodeStreamKeys(@o0OO00OO String str) {
    ...
    private Cursor getCursor(String str, @o0OO00OO String[] strArr) throws DatabaseIOException {
        try {
    ...
    private static String getStateQuery(int... iArr) {
        ...
        StringBuilder o00oOOo02 = androidx.appcompat.widget.o00oOo0O.o00oOOo0("state", " IN (");
        for (int i = 0; i < iArr.length; i++) {
            if (i > 0) {
                o00oOOo02.append(',');
            }
            o00oOOo02.append(iArr[i]);
        }
        o00oOOo02.append(')');
        return o00oOOo02.toString();
    }

    private static String inferMimeType(@o0OO00OO String str) {
