...
public class DefaultDownloaderFactory implements DownloaderFactory {
    ...
    public DefaultDownloaderFactory(CacheDataSource.Factory factory) {
        this(factory, new o0O0OO0.o00oo00O());
    }
    ...
    public Downloader createDownloader(DownloadRequest downloadRequest) {
        ...
        throw new IllegalArgumentException(android.support.v4.media.o00oOOo0.o00oOOo0("Unsupported type: ", inferContentTypeForUriAndMimeType));
    }
    ...
    private Downloader createDownloader(DownloadRequest downloadRequest, int i) {
        ...
        if (constructor != null) {
            try {
                ...
                throw new IllegalStateException(android.support.v4.media.o00oOOo0.o00oOOo0("Failed to instantiate downloader for content type ", i));
            }
        }
        throw new IllegalStateException(android.support.v4.media.o00oOOo0.o00oOOo0("Module missing for content type ", i));
    }
}
