...
public final class ProgressiveDownloader implements Downloader {
    ...
    public ProgressiveDownloader(MediaItem mediaItem, CacheDataSource.Factory factory) {
        this(mediaItem, factory, new o0O0OO0.o00oo00O());
    }
    ...
    public ProgressiveDownloader(MediaItem mediaItem, CacheDataSource.Factory factory, Executor executor) {
        ...
        this.cacheWriter = new CacheWriter(createDataSourceForDownloading, build, null, new CacheWriter.ProgressListener() { // from class: com.google.android.exoplayer2.offline.o00ooO
    ...
    @Override // com.google.android.exoplayer2.offline.Downloader
    public void download(@o0OO00OO Downloader.ProgressListener progressListener) throws IOException, InterruptedException {
