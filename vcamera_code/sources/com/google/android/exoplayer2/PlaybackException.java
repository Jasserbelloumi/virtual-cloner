...
public class PlaybackException extends Exception implements Bundleable {
    public static final Bundleable.Creator<PlaybackException> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.ooo0Oo0
    ...
    public PlaybackException(@o00oOooO.o0OO00OO String str, @o00oOooO.o0OO00OO Throwable th, int i) {
        this(str, th, i, Clock.DEFAULT.elapsedRealtime());
    }

    public PlaybackException(@o00oOooO.o0OO00OO String str, @o00oOooO.o0OO00OO Throwable th, int i, long j) {
        super(str, th);
        this.errorCode = i;
        this.timestampMs = j;
    }

    private static RemoteException createRemoteException(@o00oOooO.o0OO00OO String str) {
        return new RemoteException(str);
    }

    private static Throwable createThrowable(Class<?> cls, @o00oOooO.o0OO00OO String str) throws Exception {
    ...
    */
    public boolean errorInfoEquals(@o00oOooO.o0OO00OO com.google.android.exoplayer2.PlaybackException r7) {
        /*
            r6 = this;
            r0 = 1
            if (r6 != r7) goto L4
