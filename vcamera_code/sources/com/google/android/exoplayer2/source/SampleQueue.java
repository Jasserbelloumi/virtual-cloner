...
public class SampleQueue implements TrackOutput {
    ...
    private final SpannedData<SharedSampleMetadata> sharedSampleMetadata = new SpannedData<>(new Consumer() { // from class: com.google.android.exoplayer2.source.o0O000Oo
    ...
    public SampleQueue(Allocator allocator, @o0OO00OO DrmSessionManager drmSessionManager, @o0OO00OO DrmSessionEventListener.EventDispatcher eventDispatcher) {
    ...
    private synchronized void commitSample(long j, int i, long j2, int i2, @o0OO00OO TrackOutput.CryptoData cryptoData) {
        int i3 = this.length;
        if (i3 > 0) {
    ...
    */
    public void sampleMetadata(long r12, int r14, int r15, int r16, @o00oOooO.o0OO00OO com.google.android.exoplayer2.extractor.TrackOutput.CryptoData r17) {
        /*
            r11 = this;
            r8 = r11
    ...
    public final void setUpstreamFormatChangeListener(@o0OO00OO UpstreamFormatChangedListener upstreamFormatChangedListener) {
