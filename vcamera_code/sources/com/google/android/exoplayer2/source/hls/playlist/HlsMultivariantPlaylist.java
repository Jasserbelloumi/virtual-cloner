...
public class HlsMultivariantPlaylist extends HlsPlaylist {
    ...
    public static final class Rendition {
        ...
        public Rendition(@o0OO00OO Uri uri, Format format, String str, String str2) {
            this.url = uri;
            this.format = format;
            this.groupId = str;
            this.name = str2;
    ...
    public static final class Variant {
        ...
        public Variant(Uri uri, Format format, @o0OO00OO String str, @o0OO00OO String str2, @o0OO00OO String str3, @o0OO00OO String str4) {
            this.url = uri;
            this.format = format;
    ...
    public HlsMultivariantPlaylist(String str, List<String> list, List<Variant> list2, List<Rendition> list3, List<Rendition> list4, List<Rendition> list5, List<Rendition> list6, @o0OO00OO Format format, @o0OO00OO List<Format> list7, boolean z, Map<String, String> map, List<DrmInitData> list8) {
        super(str, list, z);
