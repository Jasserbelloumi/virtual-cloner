...
public final class HlsMediaChunk extends MediaChunk {
    ...
    private HlsMediaChunk(HlsExtractorFactory hlsExtractorFactory, DataSource dataSource, DataSpec dataSpec, Format format, boolean z, @o0OO00OO DataSource dataSource2, @o0OO00OO DataSpec dataSpec2, boolean z2, Uri uri, @o0OO00OO List<Format> list, int i, @o0OO00OO Object obj, long j, long j2, long j3, int i2, boolean z3, int i3, boolean z4, boolean z5, TimestampAdjuster timestampAdjuster, @o0OO00OO DrmInitData drmInitData, @o0OO00OO HlsMediaChunkExtractor hlsMediaChunkExtractor, Id3Decoder id3Decoder, ParsableByteArray parsableByteArray, boolean z6, PlayerId playerId) {
    ...
    private static DataSource buildDataSource(DataSource dataSource, @o0OO00OO byte[] bArr, @o0OO00OO byte[] bArr2) {
        if (bArr != null) {
    ...
    public static HlsMediaChunk createInstance(HlsExtractorFactory hlsExtractorFactory, DataSource dataSource, Format format, long j, HlsMediaPlaylist hlsMediaPlaylist, HlsChunkSource.SegmentBaseHolder segmentBaseHolder, Uri uri, @o0OO00OO List<Format> list, int i, @o0OO00OO Object obj, boolean z, TimestampAdjusterProvider timestampAdjusterProvider, @o0OO00OO HlsMediaChunk hlsMediaChunk, @o0OO00OO byte[] bArr, @o0OO00OO byte[] bArr2, boolean z2, PlayerId playerId) {
        boolean z3;
    ...
    private DefaultExtractorInput prepareExtraction(DataSource dataSource, DataSpec dataSpec, boolean z) throws IOException {
        ...
        if (this.extractor == null) {
            ...
            if (recreate.isPackedAudioExtractor()) {
                ...
                j = peekId3PrivTimestamp != C.TIME_UNSET ? this.timestampAdjuster.adjustTsTimestamp(peekId3PrivTimestamp) : this.startTimeUs;
            } else {
                hlsSampleStreamWrapper = this.output;
                j = 0;
            }
    ...
    public static boolean shouldSpliceIn(@o0OO00OO HlsMediaChunk hlsMediaChunk, Uri uri, HlsMediaPlaylist hlsMediaPlaylist, HlsChunkSource.SegmentBaseHolder segmentBaseHolder, long j) {
        if (hlsMediaChunk == null) {
            return false;
        }
