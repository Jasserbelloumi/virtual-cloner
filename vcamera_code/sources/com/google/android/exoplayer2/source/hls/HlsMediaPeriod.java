...
public final class HlsMediaPeriod implements MediaPeriod, HlsSampleStreamWrapper.Callback, HlsPlaylistTracker.PlaylistEventListener {
    ...
    private void buildAndPrepareAudioSampleStreamWrappers(long j, List<HlsMultivariantPlaylist.Rendition> list, List<HlsSampleStreamWrapper> list2, List<int[]> list3, Map<String, DrmInitData> map) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (hashSet.add(str)) {
                ...
                String o00oOOo02 = o00oo.o00oOOo0("audio:", str);
                HlsSampleStreamWrapper buildSampleStreamWrapper = buildSampleStreamWrapper(o00oOOo02, 1, (Uri[]) arrayList.toArray((Uri[]) Util.castNonNullTypeArray(new Uri[0])), (Format[]) arrayList2.toArray(new Format[0]), null, Collections.emptyList(), map, j);
                list3.add(Ints.toArray(arrayList3));
                list2.add(buildSampleStreamWrapper);
                if (this.allowChunklessPreparation && z) {
                    buildSampleStreamWrapper.prepareWithMultivariantPlaylistInfo(new TrackGroup[]{new TrackGroup(o00oOOo02, (Format[]) arrayList2.toArray(new Format[0]))}, 0, new int[0]);
                }
            }
        }
    }
    ...
    private void buildAndPrepareSampleStreamWrappers(long j) {
        ...
        while (i < list2.size()) {
            ...
            StringBuilder o00oOOo02 = oO00O0oO.o00oOOo0("subtitle:", i, ":");
            o00oOOo02.append(rendition.name);
            String sb = o00oOOo02.toString();
            ArrayList arrayList3 = arrayList2;
            int i2 = i;
            HlsSampleStreamWrapper buildSampleStreamWrapper = buildSampleStreamWrapper(sb, 3, new Uri[]{rendition.url}, new Format[]{rendition.format}, null, Collections.emptyList(), deriveOverridingDrmInitData, j);
    ...
    private HlsSampleStreamWrapper buildSampleStreamWrapper(String str, int i, Uri[] uriArr, Format[] formatArr, @o0OO00OO Format format, @o0OO00OO List<Format> list, Map<String, DrmInitData> map, long j) {
    ...
    private static Format deriveAudioFormat(Format format, @o0OO00OO Format format2, boolean z) {
        String str;
        int i;
        int i2;
        String str2;
