...
public final class DefaultHlsPlaylistTracker implements HlsPlaylistTracker, Loader.Callback<ParsingLoadable<HlsPlaylist>> {
    ...
    public static final HlsPlaylistTracker.Factory FACTORY = new HlsPlaylistTracker.Factory() { // from class: com.google.android.exoplayer2.source.hls.playlist.o00oOOo0
    ...
    public final class MediaPlaylistBundle implements Loader.Callback<ParsingLoadable<HlsPlaylist>> {
        ...
        public void loadPlaylistInternal(final Uri uri) {
            ...
            DefaultHlsPlaylistTracker.this.playlistRefreshHandler.postDelayed(new Runnable() { // from class: com.google.android.exoplayer2.source.hls.playlist.o00oOOoO
        ...
        public void processLoadedPlaylist(HlsMediaPlaylist hlsMediaPlaylist, LoadEventInfo loadEventInfo) {
            ...
            if (latestPlaylistSnapshot != hlsMediaPlaylist2) {
                ...
                if (hlsMediaPlaylist.mediaSequence + hlsMediaPlaylist.segments.size() < hlsMediaPlaylist3.mediaSequence) {
                    ...
                    playlistStuckException = ((double) (elapsedRealtime - this.lastSnapshotChangeMs)) > DefaultHlsPlaylistTracker.this.playlistStuckTargetDurationCoefficient * ((double) Util.usToMs(hlsMediaPlaylist3.targetDurationUs)) ? new HlsPlaylistTracker.PlaylistStuckException(this.playlistUrl) : null;
                    z = false;
                }
            ...
            this.earliestNextLoadTimeMs = Util.usToMs(j) + elapsedRealtime;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public HlsMediaPlaylist getLatestPlaylistSnapshot(@o0OO00OO HlsMediaPlaylist hlsMediaPlaylist, HlsMediaPlaylist hlsMediaPlaylist2) {
    ...
    private int getLoadedPlaylistDiscontinuitySequence(@o0OO00OO HlsMediaPlaylist hlsMediaPlaylist, HlsMediaPlaylist hlsMediaPlaylist2) {
    ...
    private long getLoadedPlaylistStartTimeUs(@o0OO00OO HlsMediaPlaylist hlsMediaPlaylist, HlsMediaPlaylist hlsMediaPlaylist2) {
