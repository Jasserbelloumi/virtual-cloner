...
public final class DefaultHlsExtractorFactory implements HlsExtractorFactory {
    ...
    private Extractor createExtractorByFileType(int i, Format format, @o0OO00OO List<Format> list, TimestampAdjuster timestampAdjuster) {
        if (i != 0) {
            if (i != 1) {
                if (i != 2) {
                    if (i != 7) {
    ...
    private static FragmentedMp4Extractor createFragmentedMp4Extractor(TimestampAdjuster timestampAdjuster, Format format, @o0OO00OO List<Format> list) {
    ...
    private static TsExtractor createTsExtractor(int i, boolean z, Format format, @o0OO00OO List<Format> list, TimestampAdjuster timestampAdjuster) {
        int i2 = i | 16;
        if (list != null) {
            i2 |= 32;
        } else {
    ...
    public BundledHlsMediaChunkExtractor createExtractor(Uri uri, Format format, @o0OO00OO List<Format> list, TimestampAdjuster timestampAdjuster, Map<String, List<String>> map, ExtractorInput extractorInput, PlayerId playerId) throws IOException {
    ...
    @Override // com.google.android.exoplayer2.source.hls.HlsExtractorFactory
    public /* bridge */ /* synthetic */ HlsMediaChunkExtractor createExtractor(Uri uri, Format format, @o0OO00OO List list, TimestampAdjuster timestampAdjuster, Map map, ExtractorInput extractorInput, PlayerId playerId) throws IOException {
