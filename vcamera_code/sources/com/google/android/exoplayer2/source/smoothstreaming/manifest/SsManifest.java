...
public class SsManifest implements FilterableManifest<SsManifest> {
    ...
    public static class StreamElement {
        ...
        public StreamElement(String str, String str2, int i, String str3, long j, String str4, int i2, int i3, int i4, int i5, @o0OO00OO String str5, Format[] formatArr, List<Long> list, long j2) {
        ...
        private StreamElement(String str, String str2, int i, String str3, long j, String str4, int i2, int i3, int i4, int i5, @o0OO00OO String str5, Format[] formatArr, List<Long> list, long[] jArr, long j2) {
            this.baseUri = str;
    ...
    private SsManifest(int i, int i2, long j, long j2, int i3, boolean z, @o0OO00OO ProtectionElement protectionElement, StreamElement[] streamElementArr) {
        this.majorVersion = i;
    ...
    public SsManifest(int i, int i2, long j, long j2, long j3, int i3, boolean z, @o0OO00OO ProtectionElement protectionElement, StreamElement[] streamElementArr) {
