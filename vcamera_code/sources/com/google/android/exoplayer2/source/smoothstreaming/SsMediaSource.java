...
public final class SsMediaSource extends BaseMediaSource implements Loader.Callback<ParsingLoadable<SsManifest>> {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory(SsChunkSource.Factory factory, @o0OO00OO DataSource.Factory factory2) {
        ...
        public Factory setManifestParser(@o0OO00OO ParsingLoadable.Parser<? extends SsManifest> parser) {
    ...
    private SsMediaSource(MediaItem mediaItem, @o0OO00OO SsManifest ssManifest, @o0OO00OO DataSource.Factory factory, @o0OO00OO ParsingLoadable.Parser<? extends SsManifest> parser, SsChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j) {
    ...
    private void scheduleManifestRefresh() {
        if (this.manifest.isLive) {
            this.manifestRefreshHandler.postDelayed(new Runnable() { // from class: com.google.android.exoplayer2.source.smoothstreaming.o00oOOo0
