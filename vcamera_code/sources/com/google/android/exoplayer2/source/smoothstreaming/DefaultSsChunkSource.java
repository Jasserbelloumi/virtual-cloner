...
public class DefaultSsChunkSource implements SsChunkSource {
    ...
    public static final class Factory implements SsChunkSource.Factory {
        ...
        public SsChunkSource createChunkSource(LoaderErrorThrower loaderErrorThrower, SsManifest ssManifest, int i, ExoTrackSelection exoTrackSelection, @o0OO00OO TransferListener transferListener) {
    ...
    public DefaultSsChunkSource(LoaderErrorThrower loaderErrorThrower, SsManifest ssManifest, int i, ExoTrackSelection exoTrackSelection, DataSource dataSource) {
        ...
        while (i2 < this.chunkExtractors.length) {
            ...
            int i4 = i2;
            this.chunkExtractors[i4] = new BundledChunkExtractor(new FragmentedMp4Extractor(3, null, new Track(indexInTrackGroup, i3, streamElement.timescale, C.TIME_UNSET, ssManifest.durationUs, format, 0, trackEncryptionBoxArr, i3 == 2 ? 4 : 0, null, null)), streamElement.type, format);
            i2 = i4 + 1;
        }
    }

    private static MediaChunk newMediaChunk(Format format, DataSource dataSource, Uri uri, int i, long j, long j2, long j3, int i2, @o0OO00OO Object obj, ChunkExtractor chunkExtractor) {
    ...
    public void updateManifest(SsManifest ssManifest) {
        ...
        if (i3 != 0 && streamElement2.chunkCount != 0) {
            int i4 = i3 - 1;
            long startTimeUs = streamElement.getStartTimeUs(i4);
            long startTimeUs2 = streamElement2.getStartTimeUs(0);
            if (streamElement.getChunkDurationUs(i4) + startTimeUs > startTimeUs2) {
                i = streamElement.getChunkIndex(startTimeUs2) + this.currentManifestChunkOffset;
                this.currentManifestChunkOffset = i;
                this.manifest = ssManifest;
            }
        }
        i = this.currentManifestChunkOffset + i3;
        this.currentManifestChunkOffset = i;
        this.manifest = ssManifest;
    }
