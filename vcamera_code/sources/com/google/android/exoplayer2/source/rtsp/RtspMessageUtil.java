...
public final class RtspMessageUtil {
    ...
    public static void checkManifestExpression(boolean z, @o0OO00OO String str) throws ParserException {
        if (!z) {
    ...
    public static ImmutableList<Integer> parsePublicHeader(@o0OO00OO String str) {
        if (str == null) {
