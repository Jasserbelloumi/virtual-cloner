...
public final class RtspMediaTrack {
    ...
    public static RtpPayloadFormat generatePayloadFormat(MediaDescription mediaDescription) {
        ...
        switch (c) {
            ...
            case 2:
                ...
                z = !fmtpParametersAsMap.containsKey(PARAMETER_AMR_INTERLEAVING);
        ...
        return new RtpPayloadFormat(builder.build(), i3, i4, fmtpParametersAsMap);
    }
    ...
    private static void processH264FmtpAttribute(Format.Builder builder, ImmutableMap<String, String> immutableMap) {
        ...
        if (str != null) {
            buildAvcCodecString = H264_CODECS_PREFIX + str;
        } else {
            buildAvcCodecString = CodecSpecificDataUtil.buildAvcCodecString(parseSpsNalUnit.profileIdc, parseSpsNalUnit.constraintsFlagsAndReservedZero2Bits, parseSpsNalUnit.levelIdc);
        }
    ...
    private static void processMPEG4FmtpAttribute(Format.Builder builder, ImmutableMap<String, String> immutableMap) {
        ...
        StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0(MPEG4_CODECS_PREFIX);
        if (str2 == null) {
            str2 = "1";
        }
        o00oOOo02.append(str2);
        builder.setCodecs(o00oOOo02.toString());
    }
