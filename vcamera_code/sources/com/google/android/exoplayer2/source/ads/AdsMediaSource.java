...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    public static final class AdLoadException extends IOException {
        ...
        public static AdLoadException createForAdGroup(Exception exc, int i) {
            return new AdLoadException(1, new IOException(android.support.v4.media.o00oOOo0.o00oOOo0("Failed to load ad group ", i), exc));
        }
    ...
    public final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.o00oOoO
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.o00oo00O
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.o00oo0
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public void prepareSourceInternal(@o0OO00OO TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.o00oOo0O
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.o00oOo00
            @Override // java.lang.Runnable
            public final void run() {
