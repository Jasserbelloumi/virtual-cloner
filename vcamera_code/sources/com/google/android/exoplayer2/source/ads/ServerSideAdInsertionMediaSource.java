...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    public static final class SharedMediaPeriod implements MediaPeriod.Callback {
        ...
        @o0OO00OO
        public MediaPeriodImpl getMediaPeriodForEvent(@o0OO00OO MediaLoadData mediaLoadData) {
    ...
    public ServerSideAdInsertionMediaSource(MediaSource mediaSource, @o0OO00OO AdPlaybackStateUpdater adPlaybackStateUpdater) {
    ...
    @o0OO00OO
    private MediaPeriodImpl getMediaPeriodForEvent(@o0OO00OO MediaSource.MediaPeriodId mediaPeriodId, @o0OO00OO MediaLoadData mediaLoadData, boolean z) {
    ...
    public void setAdPlaybackStates(final ImmutableMap<Object, AdPlaybackState> immutableMap) {
        ...
        synchronized (this) {
            ...
            if (handler == null) {
                ...
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.o00oo0OO
