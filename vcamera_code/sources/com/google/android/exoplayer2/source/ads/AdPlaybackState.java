...
public final class AdPlaybackState implements Bundleable {
    ...
    public static final Bundleable.Creator<AdPlaybackState> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.source.ads.o00oOOo0
    ...
    public static final class AdGroup implements Bundleable {
        public static final Bundleable.Creator<AdGroup> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.source.ads.o00oOOoO
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public int getNextAdIndexToPlay(@o0O0o00O(from = -1) int i) {
            int i2;
            int i3 = i + 1;
            while (true) {
        ...
        public int hashCode() {
            ...
            return ((((hashCode2 + ((hashCode + (((((this.count * 31) + ((int) (j ^ (j >>> 32)))) * 31) + Arrays.hashCode(this.uris)) * 31)) * 31)) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31) + (this.isServerSideInserted ? 1 : 0);
        }
        ...
        @o0OoO00O
        public AdGroup withAdState(int i, @o0O0o00O(from = 0) int i2) {
            int i3 = this.count;
            boolean z = false;
        ...
        @o0OoO00O
        public AdGroup withAdUri(Uri uri, @o0O0o00O(from = 0) int i) {
    ...
    private AdPlaybackState(@o0OO00OO Object obj, AdGroup[] adGroupArr, long j, long j2, int i) {
        this.adsId = obj;
    ...
    public AdGroup getAdGroup(@o0O0o00O(from = 0) int i) {
    ...
    public boolean isAdInErrorState(@o0O0o00O(from = 0) int i, @o0O0o00O(from = 0) int i2) {
        AdGroup adGroup;
        int i3;
    ...
    public String toString() {
        StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("AdPlaybackState(adsId=");
        o00oOOo02.append(this.adsId);
        o00oOOo02.append(", adResumePositionUs=");
        o00oOOo02.append(this.adResumePositionUs);
        o00oOOo02.append(", adGroups=[");
        for (int i = 0; i < this.adGroups.length; i++) {
            o00oOOo02.append("adGroup(timeUs=");
            o00oOOo02.append(this.adGroups[i].timeUs);
            o00oOOo02.append(", ads=[");
            for (int i2 = 0; i2 < this.adGroups[i].states.length; i2++) {
                o00oOOo02.append("ad(state=");
                int i3 = this.adGroups[i].states[i2];
                o00oOOo02.append(i3 != 0 ? i3 != 1 ? i3 != 2 ? i3 != 3 ? i3 != 4 ? '?' : '!' : 'P' : 'S' : 'R' : '_');
                o00oOOo02.append(", durationUs=");
                o00oOOo02.append(this.adGroups[i].durationsUs[i2]);
                o00oOOo02.append(')');
    ...
    @o0OoO00O
    public AdPlaybackState withAdCount(@o0O0o00O(from = 0) int i, @o0O0o00O(from = 1) int i2) {
    ...
    @o0OoO00O
    public AdPlaybackState withAdDurationsUs(@o0O0o00O(from = 0) int i, long... jArr) {
    ...
    @o0OoO00O
    public AdPlaybackState withAdGroupTimeUs(@o0O0o00O(from = 0) int i, long j) {
        int i2 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
        AdGroup[] adGroupArr2 = (AdGroup[]) Util.nullSafeArrayCopy(adGroupArr, adGroupArr.length);
    ...
    @o0OoO00O
    public AdPlaybackState withAdLoadError(@o0O0o00O(from = 0) int i, @o0O0o00O(from = 0) int i2) {
        int i3 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
        AdGroup[] adGroupArr2 = (AdGroup[]) Util.nullSafeArrayCopy(adGroupArr, adGroupArr.length);
    ...
    @o0OoO00O
    public AdPlaybackState withAdUri(@o0O0o00O(from = 0) int i, @o0O0o00O(from = 0) int i2, Uri uri) {
        int i3 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
        AdGroup[] adGroupArr2 = (AdGroup[]) Util.nullSafeArrayCopy(adGroupArr, adGroupArr.length);
    ...
    @o0OoO00O
    public AdPlaybackState withContentResumeOffsetUs(@o0O0o00O(from = 0) int i, long j) {
        int i2 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
    ...
    @o0OoO00O
    public AdPlaybackState withIsServerSideInserted(@o0O0o00O(from = 0) int i, boolean z) {
        int i2 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
    ...
    @o0OoO00O
    public AdPlaybackState withNewAdGroup(@o0O0o00O(from = 0) int i, long j) {
        int i2 = i - this.removedAdGroupCount;
    ...
    @o0OoO00O
    public AdPlaybackState withPlayedAd(@o0O0o00O(from = 0) int i, @o0O0o00O(from = 0) int i2) {
        int i3 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
        AdGroup[] adGroupArr2 = (AdGroup[]) Util.nullSafeArrayCopy(adGroupArr, adGroupArr.length);
    ...
    @o0OoO00O
    public AdPlaybackState withRemovedAdGroupCount(@o0O0o00O(from = 0) int i) {
        int i2 = this.removedAdGroupCount;
        if (i2 == i) {
            return this;
        }
    ...
    @o0OoO00O
    public AdPlaybackState withResetAdGroup(@o0O0o00O(from = 0) int i) {
        int i2 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
        AdGroup[] adGroupArr2 = (AdGroup[]) Util.nullSafeArrayCopy(adGroupArr, adGroupArr.length);
    ...
    @o0OoO00O
    public AdPlaybackState withSkippedAd(@o0O0o00O(from = 0) int i, @o0O0o00O(from = 0) int i2) {
        int i3 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
        AdGroup[] adGroupArr2 = (AdGroup[]) Util.nullSafeArrayCopy(adGroupArr, adGroupArr.length);
    ...
    @o0OoO00O
    public AdPlaybackState withSkippedAdGroup(@o0O0o00O(from = 0) int i) {
        int i2 = i - this.removedAdGroupCount;
        AdGroup[] adGroupArr = this.adGroups;
        AdGroup[] adGroupArr2 = (AdGroup[]) Util.nullSafeArrayCopy(adGroupArr, adGroupArr.length);
