...
public interface MediaSource {
    ...
    @Deprecated
    default void prepareSource(MediaSourceCaller mediaSourceCaller, @o0OO00OO TransferListener transferListener) {
        prepareSource(mediaSourceCaller, transferListener, PlayerId.UNSET);
    }

    void prepareSource(MediaSourceCaller mediaSourceCaller, @o0OO00OO TransferListener transferListener, PlayerId playerId);
