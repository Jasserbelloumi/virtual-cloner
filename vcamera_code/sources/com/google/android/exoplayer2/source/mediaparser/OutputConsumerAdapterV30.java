...
public final class OutputConsumerAdapterV30 implements MediaParser.OutputConsumer {
    ...
    public OutputConsumerAdapterV30(@o0OO00OO Format format, int i, boolean z) {
    ...
    private static List<byte[]> getInitializationData(MediaFormat mediaFormat) {
        ...
        int i = 0;
        while (true) {
            StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("csd-");
            int i2 = i + 1;
            o00oOOo02.append(i);
            ByteBuffer byteBuffer = mediaFormat.getByteBuffer(o00oOOo02.toString());
            if (byteBuffer == null) {
                return arrayList;
            }
    ...
    private static String getMimeType(String str) {
        ...
        switch (c) {
            ...
            default:
                throw new IllegalArgumentException(o00oo.o00oOOo0("Illegal parser name: ", str));
        }
    }
    ...
    @o0OO00OO
    private TrackOutput.CryptoData toExoPlayerCryptoData(int i, @o0OO00OO MediaCodec.CryptoInfo cryptoInfo) {
        int i2;
        if (cryptoInfo == null) {
            return null;
        }
    ...
    @o0OO00OO
    private static DrmInitData toExoPlayerDrmInitData(@o0OO00OO String str, @o0OO00OO android.media.DrmInitData drmInitData) {
        if (drmInitData == null) {
            return null;
        }
    ...
    private static int toTrackTypeConstant(@o0OO00OO String str) {
        char c;
        if (str == null) {
            return -1;
        }
        switch (str.hashCode()) {
            case -450004177:
                ...
                break;
            case -284840886:
                if (str.equals(o00oo0OO.f10107o00oOOoO)) {
                    c = 1;
                    break;
                }
                c = 65535;
    ...
    public void onSampleCompleted(int i, long j, int i2, int i3, int i4, @o0OO00OO MediaCodec.CryptoInfo cryptoInfo) {
