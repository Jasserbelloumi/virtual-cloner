...
public final class ConcatenatingMediaSource extends CompositeMediaSource<MediaSourceHolder> {
    ...
    public static final class MessageData<T> {
        ...
        public MessageData(int i, T t, @o0OO00OO HandlerAndRunnable handlerAndRunnable) {
            this.index = i;
            this.customData = t;
    ...
    @o0O0OOOo("this")
    private void addPublicMediaSources(int i, Collection<MediaSource> collection, @o0OO00OO Handler handler, @o0OO00OO Runnable runnable) {
    ...
    @o0O0OOOo("this")
    @o0OO00OO
    private HandlerAndRunnable createOnCompletionAction(@o0OO00OO Handler handler, @o0OO00OO Runnable runnable) {
    ...
    @o0O0OOOo("this")
    private void movePublicMediaSource(int i, int i2, @o0OO00OO Handler handler, @o0OO00OO Runnable runnable) {
        Assertions.checkArgument((handler == null) == (runnable == null));
        Handler handler2 = this.playbackThreadHandler;
    ...
    @o0O0OOOo("this")
    private void removePublicMediaSources(int i, int i2, @o0OO00OO Handler handler, @o0OO00OO Runnable runnable) {
        Assertions.checkArgument((handler == null) == (runnable == null));
        Handler handler2 = this.playbackThreadHandler;
    ...
    private void scheduleTimelineUpdate(@o0OO00OO HandlerAndRunnable handlerAndRunnable) {
    ...
    @o0O0OOOo("this")
    private void setPublicShuffleOrder(ShuffleOrder shuffleOrder, @o0OO00OO Handler handler, @o0OO00OO Runnable runnable) {
        Assertions.checkArgument((handler == null) == (runnable == null));
        Handler handler2 = this.playbackThreadHandler;
        if (handler2 != null) {
            int size = getSize();
    ...
    @Override // com.google.android.exoplayer2.source.CompositeMediaSource, com.google.android.exoplayer2.source.BaseMediaSource
    public synchronized void prepareSourceInternal(@o0OO00OO TransferListener transferListener) {
        super.prepareSourceInternal(transferListener);
        this.playbackThreadHandler = new Handler(new Handler.Callback() { // from class: com.google.android.exoplayer2.source.o00oOOoO
