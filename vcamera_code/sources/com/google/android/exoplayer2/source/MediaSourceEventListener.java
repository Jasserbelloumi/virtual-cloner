...
public interface MediaSourceEventListener {
    ...
    public static class EventDispatcher {
        ...
        private EventDispatcher(CopyOnWriteArrayList<ListenerAndHandler> copyOnWriteArrayList, int i, @o0OO00OO MediaSource.MediaPeriodId mediaPeriodId, long j) {
        ...
        public void downstreamFormatChanged(int i, @o0OO00OO Format format, int i2, @o0OO00OO Object obj, long j) {
        ...
        public void downstreamFormatChanged(final MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ...
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.source.o0O0o
        ...
        public void loadCanceled(LoadEventInfo loadEventInfo, int i, int i2, @o0OO00OO Format format, int i3, @o0OO00OO Object obj, long j, long j2) {
        ...
        public void loadCanceled(final LoadEventInfo loadEventInfo, final MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                final MediaSourceEventListener mediaSourceEventListener = next.listener;
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.source.o00ooO
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void loadCompleted(LoadEventInfo loadEventInfo, int i, int i2, @o0OO00OO Format format, int i3, @o0OO00OO Object obj, long j, long j2) {
        ...
        public void loadCompleted(final LoadEventInfo loadEventInfo, final MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                final MediaSourceEventListener mediaSourceEventListener = next.listener;
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.source.o00ooO0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void loadError(LoadEventInfo loadEventInfo, int i, int i2, @o0OO00OO Format format, int i3, @o0OO00OO Object obj, long j, long j2, IOException iOException, boolean z) {
        ...
        public void loadError(final LoadEventInfo loadEventInfo, final MediaLoadData mediaLoadData, final IOException iOException, final boolean z) {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                final MediaSourceEventListener mediaSourceEventListener = next.listener;
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.source.o00oo
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void loadStarted(LoadEventInfo loadEventInfo, int i, int i2, @o0OO00OO Format format, int i3, @o0OO00OO Object obj, long j, long j2) {
        ...
        public void loadStarted(final LoadEventInfo loadEventInfo, final MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                final MediaSourceEventListener mediaSourceEventListener = next.listener;
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.source.o00oo0O
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void upstreamDiscarded(final MediaLoadData mediaLoadData) {
            ...
            while (it.hasNext()) {
                ListenerAndHandler next = it.next();
                final MediaSourceEventListener mediaSourceEventListener = next.listener;
                Util.postOrRun(next.handler, new Runnable() { // from class: com.google.android.exoplayer2.source.o0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        @o0OoO00O
        public EventDispatcher withParameters(int i, @o0OO00OO MediaSource.MediaPeriodId mediaPeriodId, long j) {
            return new EventDispatcher(this.listenerAndHandlers, i, mediaPeriodId, j);
        }
    }

    default void onDownstreamFormatChanged(int i, @o0OO00OO MediaSource.MediaPeriodId mediaPeriodId, MediaLoadData mediaLoadData) {
    }

    default void onLoadCanceled(int i, @o0OO00OO MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
    }

    default void onLoadCompleted(int i, @o0OO00OO MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
    }

    default void onLoadError(int i, @o0OO00OO MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData, IOException iOException, boolean z) {
    }

    default void onLoadStarted(int i, @o0OO00OO MediaSource.MediaPeriodId mediaPeriodId, LoadEventInfo loadEventInfo, MediaLoadData mediaLoadData) {
    }
