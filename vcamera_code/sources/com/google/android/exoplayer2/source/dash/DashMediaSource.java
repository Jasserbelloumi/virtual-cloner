...
public final class DashMediaSource extends BaseMediaSource {
    ...
    public static final class DashTimeline extends Timeline {
        ...
        public DashTimeline(long j, long j2, long j3, int i, long j4, long j5, long j6, DashManifest dashManifest, MediaItem mediaItem, @o0OO00OO MediaItem.LiveConfiguration liveConfiguration) {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public Factory(DashChunkSource.Factory factory, @o0OO00OO DataSource.Factory factory2) {
        ...
        public Factory setManifestParser(@o0OO00OO ParsingLoadable.Parser<? extends DashManifest> parser) {
    ...
    private DashMediaSource(MediaItem mediaItem, @o0OO00OO DashManifest dashManifest, @o0OO00OO DataSource.Factory factory, @o0OO00OO ParsingLoadable.Parser<? extends DashManifest> parser, DashChunkSource.Factory factory2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory, DrmSessionManager drmSessionManager, LoadErrorHandlingPolicy loadErrorHandlingPolicy, long j) {
        ...
        if (!z) {
            ...
            this.refreshManifestRunnable = new Runnable() { // from class: com.google.android.exoplayer2.source.dash.o00oOOoO
                @Override // java.lang.Runnable
                public final void run() {
                    DashMediaSource.this.startLoadingManifest();
                }
            };
            this.simulateManifestRefreshRunnable = new Runnable() { // from class: com.google.android.exoplayer2.source.dash.o00oOo00
                @Override // java.lang.Runnable
                public final void run() {
    ...
    private static long getIntervalUntilNextManifestRefreshMs(DashManifest dashManifest, long j) {
        ...
        for (int i = 0; i < period.adaptationSets.size(); i++) {
            ...
            if (!list.isEmpty() && (index = list.get(0).getIndex()) != null) {
                ...
                if (nextSegmentAvailableTimeUs < msToUs4 - IndexSeeker.MIN_TIME_BETWEEN_POINTS_US || (nextSegmentAvailableTimeUs > msToUs4 && nextSegmentAvailableTimeUs < IndexSeeker.MIN_TIME_BETWEEN_POINTS_US + msToUs4)) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0061, code lost:
        if (r1 != com.google.android.exoplayer2.C.TIME_UNSET) goto L14;
     */
    /* JADX WARN: Code restructure failed: missing block: B:8:0x0025, code lost:
        if (r1 != com.google.android.exoplayer2.C.TIME_UNSET) goto L3;
     */
