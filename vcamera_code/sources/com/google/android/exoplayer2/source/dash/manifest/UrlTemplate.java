    ...
    private static int parseTemplate(String str, String[] strArr, int[] iArr, String[] strArr2) {
        ...
        while (i < str.length()) {
            ...
            if (indexOf == -1) {
                ...
                strArr[i2] = o00oOOoO.o00oOOo0(new StringBuilder(), strArr[i2], "$");
                i += 2;
            } else {
                int i3 = i + 1;
                ...
                if (substring.equals(REPRESENTATION)) {
                    ...
                    if (indexOf3 != -1) {
                        ...
                        if (!str2.endsWith(GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG) && !str2.endsWith("x") && !str2.endsWith("X")) {
                            str2 = o00oo.o00oOOo0(str2, GoogleApiAvailabilityLight.TRACKING_SOURCE_DIALOG);
                        }
                    ...
                    switch (c) {
                        ...
                        case 2:
                            ...
                            break;
                        default:
                            throw new IllegalArgumentException(o00oo.o00oOOo0("Invalid template: ", str));
                    }
                    strArr2[i2] = str2;
                }
                i2++;
