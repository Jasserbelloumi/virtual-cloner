...
public abstract class Representation {
    ...
    public static class MultiSegmentRepresentation extends Representation implements DashSegmentIndex {
        ...
        public MultiSegmentRepresentation(long j, Format format, List<BaseUrl> list, SegmentBase.MultiSegmentBase multiSegmentBase, @o0OO00OO List<Descriptor> list2, List<Descriptor> list3, List<Descriptor> list4) {
    ...
    public static class SingleSegmentRepresentation extends Representation {
        ...
        public SingleSegmentRepresentation(long j, Format format, List<BaseUrl> list, SegmentBase.SingleSegmentBase singleSegmentBase, @o0OO00OO List<Descriptor> list2, List<Descriptor> list3, List<Descriptor> list4, @o0OO00OO String str, long j2) {
        ...
        public static SingleSegmentRepresentation newInstance(long j, Format format, String str, long j2, long j3, long j4, long j5, List<Descriptor> list, @o0OO00OO String str2, long j6) {
    ...
    private Representation(long j, Format format, List<BaseUrl> list, SegmentBase segmentBase, @o0OO00OO List<Descriptor> list2, List<Descriptor> list3, List<Descriptor> list4) {
    ...
    public static Representation newInstance(long j, Format format, List<BaseUrl> list, SegmentBase segmentBase, @o0OO00OO List<Descriptor> list2, List<Descriptor> list3, List<Descriptor> list4, @o0OO00OO String str) {
