...
public final class DashMediaPeriod implements MediaPeriod, SequenceableLoader.Callback<ChunkSampleStream<DashChunkSource>>, ChunkSampleStream.ReleaseCallback<DashChunkSource> {
    ...
    private static void buildManifestEventTrackGroupInfos(List<EventStream> list, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr, int i) {
        ...
        int i2 = 0;
        while (i2 < list.size()) {
            trackGroupArr[i] = new TrackGroup(eventStream.id() + ":" + i2, new Format.Builder().setId(list.get(i2).id()).setSampleMimeType(MimeTypes.APPLICATION_EMSG).build());
    ...
    private static int buildPrimaryAndEmbeddedTrackGroupInfos(DrmSessionManager drmSessionManager, List<AdaptationSet> list, int[][] iArr, int i, boolean[] zArr, Format[][] formatArr, TrackGroup[] trackGroupArr, TrackGroupInfo[] trackGroupInfoArr) {
        ...
        while (i4 < i) {
            ...
            String num = i8 != -1 ? Integer.toString(i8) : android.support.v4.media.o00oOOo0.o00oOOo0("unset:", i4);
            int i9 = i5 + 1;
            if (zArr[i4]) {
                i2 = i9;
                i9++;
            ...
            if (i2 != -1) {
                String o00oOOo02 = o00oo.o00oOOo0(num, ":emsg");
                trackGroupArr[i2] = new TrackGroup(o00oOOo02, new Format.Builder().setId(o00oOOo02).setSampleMimeType(MimeTypes.APPLICATION_EMSG).build());
                trackGroupInfoArr[i2] = TrackGroupInfo.embeddedEmsgTrack(iArr2, i5);
            }
            if (i9 != -1) {
                trackGroupArr[i9] = new TrackGroup(o00oo.o00oOOo0(num, ":cc"), formatArr[i4]);
        ...
        for (int i : iArr) {
            ...
            for (int i2 = 0; i2 < list2.size(); i2++) {
                ...
                if ("urn:scte:dash:cc:cea-608:2015".equals(descriptor.schemeIdUri)) {
                    build = new Format.Builder().setSampleMimeType(MimeTypes.APPLICATION_CEA608).setId(adaptationSet.id + ":cea608").build();
                    pattern = CEA608_SERVICE_DESCRIPTOR_REGEX;
                } else if ("urn:scte:dash:cc:cea-708:2015".equals(descriptor.schemeIdUri)) {
                    build = new Format.Builder().setSampleMimeType(MimeTypes.APPLICATION_CEA708).setId(adaptationSet.id + ":cea708").build();
