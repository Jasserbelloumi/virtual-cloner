...
public class DefaultDashChunkSource implements DashChunkSource {
    ...
    public static final class RepresentationHolder {
        ...
        public RepresentationHolder(long j, Representation representation, BaseUrl baseUrl, @o0OO00OO ChunkExtractor chunkExtractor, long j2, @o0OO00OO DashSegmentIndex dashSegmentIndex) {
        ...
        public RepresentationHolder copyWithNewRepresentation(long j, Representation representation) throws BehindLiveWindowException {
            ...
            if (index.isExplicit()) {
                ...
                int i = ((index.getDurationUs(j2, j) + timeUs2) > timeUs3 ? 1 : ((index.getDurationUs(j2, j) + timeUs2) == timeUs3 ? 0 : -1));
                if (i == 0) {
                    segmentNum = j2 + 1;
                } else if (i < 0) {
    ...
    private long getSegmentNum(RepresentationHolder representationHolder, @o0OO00OO MediaChunk mediaChunk, long j, long j2, long j3) {
    ...
    public Chunk newInitializationChunk(RepresentationHolder representationHolder, DataSource dataSource, Format format, int i, @o0OO00OO Object obj, @o0OO00OO RangedUri rangedUri, @o0OO00OO RangedUri rangedUri2) {
