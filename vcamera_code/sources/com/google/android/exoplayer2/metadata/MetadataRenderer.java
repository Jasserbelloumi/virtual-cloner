...
public final class MetadataRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public MetadataRenderer(MetadataOutput metadataOutput, @o0OO00OO Looper looper) {
        this(metadataOutput, looper, MetadataDecoderFactory.DEFAULT);
    }

    public MetadataRenderer(MetadataOutput metadataOutput, @o0OO00OO Looper looper, MetadataDecoderFactory metadataDecoderFactory) {
        super(5);
