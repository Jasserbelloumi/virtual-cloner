...
public final class EventMessage implements Metadata.Entry {
    ...
    public int hashCode() {
        if (this.hashCode == 0) {
            ...
            long j2 = this.id;
            this.hashCode = Arrays.hashCode(this.messageData) + ((((((hashCode + hashCode2) * 31) + ((int) (j ^ (j >>> 32)))) * 31) + ((int) (j2 ^ (j2 >>> 32)))) * 31);
        }
        return this.hashCode;
    }

    public String toString() {
        StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("EMSG: scheme=");
        o00oOOo02.append(this.schemeIdUri);
        o00oOOo02.append(", id=");
        o00oOOo02.append(this.id);
        o00oOOo02.append(", durationMs=");
        o00oOOo02.append(this.durationMs);
        o00oOOo02.append(", value=");
        o00oOOo02.append(this.value);
