...
public final class Id3Decoder extends SimpleMetadataDecoder {
    ...
    public static final FramePredicate NO_FRAMES_PREDICATE = new FramePredicate() { // from class: com.google.android.exoplayer2.metadata.id3.o00oOOo0
    ...
    public Id3Decoder(@o0OO00OO FramePredicate framePredicate) {
    ...
    private static ApicFrame decodeApicFrame(ParsableByteArray parsableByteArray, int i, int i2) throws UnsupportedEncodingException {
        ...
        if (i2 == 2) {
            StringBuilder o00oOOo03 = o00oOo0O.o00oOOo0("image/");
            o00oOOo03.append(Ascii.toLowerCase(new String(bArr, 0, 3, C.ISO88591_NAME)));
            o00oOOo02 = o00oOOo03.toString();
            if ("image/jpg".equals(o00oOOo02)) {
                o00oOOo02 = MimeTypes.IMAGE_JPEG;
            }
            indexOfZeroByte = 2;
        } else {
            ...
            o00oOOo02 = lowerCase.indexOf(47) == -1 ? o00oo.o00oOOo0("image/", lowerCase) : lowerCase;
        }
        int i4 = indexOfZeroByte + 2;
        int indexOfEos = indexOfEos(bArr, i4, readUnsignedByte);
        return new ApicFrame(o00oOOo02, new String(bArr, i4, indexOfEos - i4, charsetName), bArr[indexOfZeroByte + 1] & 255, copyOfRangeIfValid(bArr, indexOfEos + delimiterLength(readUnsignedByte), i3));
    }
    ...
    private static ChapterFrame decodeChapterFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, @o0OO00OO FramePredicate framePredicate) throws UnsupportedEncodingException {
        ...
        long j = readUnsignedInt == UnsignedInts.INT_MASK ? -1L : readUnsignedInt;
        long readUnsignedInt2 = parsableByteArray.readUnsignedInt();
        long j2 = readUnsignedInt2 == UnsignedInts.INT_MASK ? -1L : readUnsignedInt2;
    ...
    private static ChapterTocFrame decodeChapterTOCFrame(ParsableByteArray parsableByteArray, int i, int i2, boolean z, int i3, @o0OO00OO FramePredicate framePredicate) throws UnsupportedEncodingException {
        int position = parsableByteArray.getPosition();
        int indexOfZeroByte = indexOfZeroByte(parsableByteArray.getData(), position);
        String str = new String(parsableByteArray.getData(), position, indexOfZeroByte - position, C.ISO88591_NAME);
        parsableByteArray.setPosition(indexOfZeroByte + 1);
    ...
    */
    private static com.google.android.exoplayer2.metadata.id3.Id3Frame decodeFrame(int r19, com.google.android.exoplayer2.util.ParsableByteArray r20, boolean r21, int r22, @o00oOooO.o0OO00OO com.google.android.exoplayer2.metadata.id3.Id3Decoder.FramePredicate r23) {
        /*
    ...
    private static Id3Header decodeHeader(ParsableByteArray parsableByteArray) {
        ...
        if (parsableByteArray.bytesLeft() < 10) {
            ...
            sb = o00oOo0O.o00oOOo0("Unexpected first three bytes of ID3 tag header: 0x");
    ...
    public Metadata decode(byte[] bArr, int i) {
        ...
        if (!validateFrames(parsableByteArray, decodeHeader.majorVersion, i2, false)) {
            if (decodeHeader.majorVersion != 4 || !validateFrames(parsableByteArray, 4, i2, true)) {
                StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("Failed to validate ID3 tag with majorVersion=");
                o00oOOo02.append(decodeHeader.majorVersion);
