...
public interface ExoMediaDrm {
    ...
    public interface OnEventListener {
        void onEvent(ExoMediaDrm exoMediaDrm, @o0OO00OO byte[] bArr, int i, int i2, @o0OO00OO byte[] bArr2);
    }
    ...
    KeyRequest getKeyRequest(byte[] bArr, @o0OO00OO List<DrmInitData.SchemeData> list, int i, @o0OO00OO HashMap<String, String> hashMap) throws NotProvisionedException;
    ...
    void setOnEventListener(@o0OO00OO OnEventListener onEventListener);

    void setOnExpirationUpdateListener(@o0OO00OO OnExpirationUpdateListener onExpirationUpdateListener);

    void setOnKeyStatusChangeListener(@o0OO00OO OnKeyStatusChangeListener onKeyStatusChangeListener);
