...
public class DefaultDrmSession implements DrmSession {
    ...
    public static final class UnexpectedDrmSessionException extends IOException {
        public UnexpectedDrmSessionException(@o0OO00OO Throwable th) {
            super(th);
        }
    }

    public DefaultDrmSession(UUID uuid, ExoMediaDrm exoMediaDrm, ProvisioningManager provisioningManager, ReferenceCountListener referenceCountListener, @o0OO00OO List<DrmInitData.SchemeData> list, int i, boolean z, boolean z2, @o0OO00OO byte[] bArr, HashMap<String, String> hashMap, MediaDrmCallback mediaDrmCallback, Looper looper, LoadErrorHandlingPolicy loadErrorHandlingPolicy, PlayerId playerId) {
        ...
        if (i == 0 || i == 1) {
            if (this.offlineLicenseKeySetId == null) {
                ...
                if (this.mode != 0 || licenseDurationRemainingSec > 60) {
                    ...
                    this.state = 4;
                    dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.o00oOoO
    ...
    private void onError(final Exception exc, int i) {
        ...
        dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.o00oOo0O
            @Override // com.google.android.exoplayer2.util.Consumer
            public final void accept(Object obj) {
        ...
        if (obj == this.currentKeyRequest && isOpen()) {
            ...
            try {
                ...
                if (this.mode == 3) {
                    ...
                    consumer = new Consumer() { // from class: com.google.android.exoplayer2.drm.o00oOOo0
                        @Override // com.google.android.exoplayer2.util.Consumer
                    ...
                    this.state = 4;
                    consumer = new Consumer() { // from class: com.google.android.exoplayer2.drm.o00oOOoO
                        @Override // com.google.android.exoplayer2.util.Consumer
                        public final void accept(Object obj3) {
    ...
    private boolean openInternal() {
        ...
        try {
            ...
            this.state = 3;
            dispatchEvent(new Consumer() { // from class: com.google.android.exoplayer2.drm.o00oOo00
                @Override // com.google.android.exoplayer2.util.Consumer
                public final void accept(Object obj) {
    ...
    public void acquire(@o0OO00OO DrmSessionEventListener.EventDispatcher eventDispatcher) {
        if (this.referenceCount < 0) {
            StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("Session reference count less than zero: ");
            o00oOOo02.append(this.referenceCount);
            Log.e(TAG, o00oOOo02.toString());
