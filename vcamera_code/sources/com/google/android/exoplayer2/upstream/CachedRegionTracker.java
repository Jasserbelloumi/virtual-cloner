...
public final class CachedRegionTracker implements Cache.Listener {
    ...
    private boolean regionsConnect(@o0OO00OO Region region, @o0OO00OO Region region2) {
    ...
    public synchronized int getRegionEndTimeMs(long j) {
        ...
        if (floor != null) {
            ...
            if (j <= j2 && (i = floor.endOffsetIndex) != -1) {
                ...
                i2 = (int) ((chunkIndex.timesUs[i] + ((chunkIndex.durationsUs[i] * (j2 - chunkIndex.offsets[i])) / chunkIndex.sizes[i])) / 1000);
                return i2;
            }
        }
        return -1;
