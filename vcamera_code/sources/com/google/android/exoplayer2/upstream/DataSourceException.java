...
public class DataSourceException extends IOException {
    ...
    public DataSourceException(@o0OO00OO String str, int i) {
        super(str);
        this.reason = i;
    }

    public DataSourceException(@o0OO00OO String str, @o0OO00OO Throwable th, int i) {
        super(str, th);
        this.reason = i;
    }

    public DataSourceException(@o0OO00OO Throwable th, int i) {
        super(th);
        this.reason = i;
    }
