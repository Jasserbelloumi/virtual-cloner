...
public final class DataSpec {
    ...
    public static final class Builder {
        ...
        public Builder setCustomData(@o0OO00OO Object obj) {
            this.customData = obj;
            return this;
        }
        ...
        public Builder setHttpBody(@o0OO00OO byte[] bArr) {
            this.httpBody = bArr;
            return this;
        }
        ...
        public Builder setKey(@o0OO00OO String str) {
            this.key = str;
            return this;
        }
    ...
    @Deprecated
    public DataSpec(Uri uri, int i, @o0OO00OO byte[] bArr, long j, long j2, long j3, @o0OO00OO String str, int i2) {
        this(uri, i, bArr, j, j2, j3, str, i2, Collections.emptyMap());
    }

    @Deprecated
    public DataSpec(Uri uri, int i, @o0OO00OO byte[] bArr, long j, long j2, long j3, @o0OO00OO String str, int i2, Map<String, String> map) {
        this(uri, j - j2, i, bArr, map, j2, j3, str, i2, null);
    }

    private DataSpec(Uri uri, long j, int i, @o0OO00OO byte[] bArr, Map<String, String> map, long j2, long j3, @o0OO00OO String str, int i2, @o0OO00OO Object obj) {
        byte[] bArr2 = bArr;
        long j4 = j + j2;
        boolean z = true;
    ...
    @Deprecated
    public DataSpec(Uri uri, long j, long j2, long j3, @o0OO00OO String str, int i) {
        this(uri, null, j, j2, j3, str, i);
    }

    @Deprecated
    public DataSpec(Uri uri, long j, long j2, @o0OO00OO String str) {
        this(uri, j, j, j2, str, 0);
    }

    @Deprecated
    public DataSpec(Uri uri, long j, long j2, @o0OO00OO String str, int i) {
        this(uri, j, j, j2, str, i);
    }

    @Deprecated
    public DataSpec(Uri uri, long j, long j2, @o0OO00OO String str, int i, Map<String, String> map) {
        this(uri, 1, null, j, j, j2, str, i, map);
    }

    @Deprecated
    public DataSpec(Uri uri, @o0OO00OO byte[] bArr, long j, long j2, long j3, @o0OO00OO String str, int i) {
    ...
    public static String getStringForHttpMethod(int i) {
        if (i != 1) {
            ...
            return o00oo0o0.o00oo0.f7538o00oOoOo;
        }
        return o00oo0o0.o00oo0.f7537o00oOoOO;
    }
    ...
    public String toString() {
        StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("DataSpec[");
        o00oOOo02.append(getHttpMethodString());
        o00oOOo02.append(" ");
        o00oOOo02.append(this.uri);
        o00oOOo02.append(", ");
        ...
        o00oOOo02.append(", ");
        return android.support.v4.media.o00oOo00.o00oOOo0(o00oOOo02, this.flags, "]");
    }
