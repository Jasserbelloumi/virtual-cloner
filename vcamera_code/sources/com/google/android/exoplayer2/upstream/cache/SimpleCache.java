...
public final class SimpleCache implements Cache {
    ...
    public SimpleCache(File file, CacheEvictor cacheEvictor, @o0OO00OO DatabaseProvider databaseProvider, @o0OO00OO byte[] bArr, boolean z, boolean z2) {
    ...
    public SimpleCache(File file, CacheEvictor cacheEvictor, CachedContentIndex cachedContentIndex, @o0OO00OO CacheFileMetadataIndex cacheFileMetadataIndex) {
        if (!lockFolder(file)) {
    ...
    @Deprecated
    public SimpleCache(File file, CacheEvictor cacheEvictor, @o0OO00OO byte[] bArr) {
        this(file, cacheEvictor, bArr, bArr != null);
    }

    @Deprecated
    public SimpleCache(File file, CacheEvictor cacheEvictor, @o0OO00OO byte[] bArr, boolean z) {
    ...
    private static long createUid(File file) throws IOException {
        ...
        File file2 = new File(file, o00oo.o00oOOo0(Long.toString(abs, 16), UID_FILE_SUFFIX));
    ...
    @oO0Oo
    public static void delete(File file, @o0OO00OO DatabaseProvider databaseProvider) {
        if (file.exists()) {
    ...
    public void initialize() {
        ...
        if (listFiles == null) {
            StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("Failed to list cache directory files: ");
            o00oOOo02.append(this.cacheDir);
            ...
            if (loadUid == -1) {
                try {
                    ...
                    StringBuilder o00oOOo03 = o00oOo0O.o00oOOo0("Failed to create cache UID: ");
                    o00oOOo03.append(this.cacheDir);
            ...
            try {
                ...
                StringBuilder o00oOOo04 = o00oOo0O.o00oOOo0("Failed to initialize cache indices: ");
                o00oOOo04.append(this.cacheDir);
                String sb3 = o00oOOo04.toString();
                Log.e(TAG, sb3, e4);
    ...
    private void loadDirectory(File file, boolean z, @o0OO00OO File[] fileArr, @o0OO00OO Map<String, CacheFileMetadata> map) {
