...
public final class CacheDataSource implements DataSource {
    ...
    public static final class Factory implements DataSource.Factory {
        ...
        private CacheDataSource createDataSourceInternal(@o0OO00OO DataSource dataSource, int i, int i2) {
            DataSink dataSink;
        ...
        public Factory setCacheWriteDataSinkFactory(@o0OO00OO DataSink.Factory factory) {
            this.cacheWriteDataSinkFactory = factory;
            this.cacheIsReadOnly = factory == null;
            return this;
        }

        public Factory setEventListener(@o0OO00OO EventListener eventListener) {
        ...
        public Factory setUpstreamDataSourceFactory(@o0OO00OO DataSource.Factory factory) {
        ...
        public Factory setUpstreamPriorityTaskManager(@o0OO00OO PriorityTaskManager priorityTaskManager) {
    ...
    public CacheDataSource(Cache cache, @o0OO00OO DataSource dataSource) {
        this(cache, dataSource, 0);
    }

    public CacheDataSource(Cache cache, @o0OO00OO DataSource dataSource, int i) {
        this(cache, dataSource, new FileDataSource(), new CacheDataSink(cache, CacheDataSink.DEFAULT_FRAGMENT_SIZE), i, null);
    }

    public CacheDataSource(Cache cache, @o0OO00OO DataSource dataSource, DataSource dataSource2, @o0OO00OO DataSink dataSink, int i, @o0OO00OO EventListener eventListener) {
        this(cache, dataSource, dataSource2, dataSink, i, eventListener, null);
    }

    public CacheDataSource(Cache cache, @o0OO00OO DataSource dataSource, DataSource dataSource2, @o0OO00OO DataSink dataSink, int i, @o0OO00OO EventListener eventListener, @o0OO00OO CacheKeyFactory cacheKeyFactory) {
        this(cache, dataSource, dataSource2, dataSink, cacheKeyFactory, i, null, 0, eventListener);
    }

    private CacheDataSource(Cache cache, @o0OO00OO DataSource dataSource, DataSource dataSource2, @o0OO00OO DataSink dataSink, @o0OO00OO CacheKeyFactory cacheKeyFactory, int i, @o0OO00OO PriorityTaskManager priorityTaskManager, int i2, @o0OO00OO EventListener eventListener) {
        this.cache = cache;
