...
public class CachedContentIndex {
    ...
    public static final class DatabaseStorage implements Storage {
        ...
        private static String getTableName(String str) {
            return o00oo.o00oOOo0(TABLE_PREFIX, str);
        }
        ...
        private void initializeTable(SQLiteDatabase sQLiteDatabase) throws DatabaseIOException {
            ...
            StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("CREATE TABLE ");
            o00oOOo02.append(this.tableName);
            o00oOOo02.append(" ");
            o00oOOo02.append(TABLE_SCHEMA);
            sQLiteDatabase.execSQL(o00oOOo02.toString());
        }
    ...
    public static class LegacyStorage implements Storage {
        ...
        public LegacyStorage(File file, @o0OO00OO byte[] bArr, boolean z) {
            Cipher cipher;
    ...
    public CachedContentIndex(@o0OO00OO DatabaseProvider databaseProvider, @o0OO00OO File file, @o0OO00OO byte[] bArr, boolean z, boolean z2) {
    ...
    public static DefaultContentMetadata readContentMetadata(DataInputStream dataInputStream) throws IOException {
        ...
        for (int i = 0; i < readInt; i++) {
            ...
            int readInt2 = dataInputStream.readInt();
            if (readInt2 < 0) {
                throw new IOException(android.support.v4.media.o00oOOo0.o00oOOo0("Invalid value size: ", readInt2));
            }
