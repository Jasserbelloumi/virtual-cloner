...
public class TrackSelectionView extends LinearLayout {
    ...
    public TrackSelectionView(Context context, @o0OO00OO AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public TrackSelectionView(Context context, @o0OO00OO AttributeSet attributeSet, @o00oOooO.o0O000Oo int i) {
    ...
    private void onTrackViewClicked(View view) {
        ...
        TrackSelectionOverride trackSelectionOverride2 = this.overrides.get(mediaTrackGroup);
        if (trackSelectionOverride2 == null) {
            if (!this.allowMultipleOverrides && this.overrides.size() > 0) {
                this.overrides.clear();
            }
            map = this.overrides;
            trackSelectionOverride = new TrackSelectionOverride(mediaTrackGroup, ImmutableList.of(Integer.valueOf(i)));
        } else {
        ...
        map.put(mediaTrackGroup, trackSelectionOverride);
    }
    ...
    public void init(List<Tracks.Group> list, boolean z, Map<TrackGroup, TrackSelectionOverride> map, @o0OO00OO final Comparator<Format> comparator, @o0OO00OO TrackSelectionListener trackSelectionListener) {
        this.isDisabled = z;
        this.trackInfoComparator = comparator == null ? null : new Comparator() { // from class: com.google.android.exoplayer2.ui.o0O0O0O
