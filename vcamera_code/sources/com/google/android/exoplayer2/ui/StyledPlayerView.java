...
public class StyledPlayerView extends FrameLayout implements AdViewProvider {
    ...
    public StyledPlayerView(Context context, @o0OO00OO AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    /* JADX WARN: Multi-variable type inference failed */
    public StyledPlayerView(Context context, @o0OO00OO AttributeSet attributeSet, int i) {
    ...
    public static void switchTargetView(Player player, @o0OO00OO StyledPlayerView styledPlayerView, @o0OO00OO StyledPlayerView styledPlayerView2) {
    ...
    @Deprecated
    public void setControllerOnFullScreenModeChangedListener(@o0OO00OO StyledPlayerControlView.OnFullScreenModeChangedListener onFullScreenModeChangedListener) {
        Assertions.checkStateNotNull(this.controller);
    ...
    @Deprecated
    public void setControllerVisibilityListener(@o0OO00OO StyledPlayerControlView.VisibilityListener visibilityListener) {
        Assertions.checkStateNotNull(this.controller);
    ...
    public void setControllerVisibilityListener(@o0OO00OO ControllerVisibilityListener controllerVisibilityListener) {
    ...
    public void setFullscreenButtonClickListener(@o0OO00OO FullscreenButtonClickListener fullscreenButtonClickListener) {
        Assertions.checkStateNotNull(this.controller);
    ...
    public void setShutterBackgroundColor(@o00oOooO.o0O00O int i) {
        View view = this.shutterView;
        if (view != null) {
