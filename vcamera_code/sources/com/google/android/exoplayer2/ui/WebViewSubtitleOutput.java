...
final class WebViewSubtitleOutput extends FrameLayout implements SubtitleView.Output {
    ...
    public WebViewSubtitleOutput(Context context, @o0OO00OO AttributeSet attributeSet) {
    ...
    private static String convertAlignmentToCss(@o0OO00OO Layout.Alignment alignment) {
        if (alignment == null) {
