...
public final class GlUtil {
    ...
    public static final class Api17 {
        ...
        @o0O0O0Oo
        public static void destroyEglContext(@o0OO00OO EGLDisplay eGLDisplay, @o0OO00OO EGLContext eGLContext) {
            if (eGLDisplay == null) {
                return;
            }
    ...
    public static void bindTexture(int i, int i2) {
        ...
        checkGlError();
        GLES20.glTexParameteri(i, androidx.work.o00oOOoO.f5764o00oOooO, 9729);
        checkGlError();
    ...
    public static void checkGlError() {
        ...
        while (true) {
            ...
            StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("glError: ");
            o00oOOo02.append(GLU.gluErrorString(glGetError));
            Log.e(TAG, o00oOOo02.toString());
            i = glGetError;
        }
        if (i != 0) {
            StringBuilder o00oOOo03 = android.support.v4.media.o00oOo0O.o00oOOo0("glError: ");
            o00oOOo03.append(GLU.gluErrorString(i));
            throwGlException(o00oOOo03.toString());
        }
    }
    ...
    public static int createTexture(int i, int i2) {
        ...
        GLES20.glTexImage2D(3553, 0, o0OOo000.f15118o00oo0OO, i, i2, 0, o0OOo000.f15118o00oo0OO, 5121, ByteBuffer.allocateDirect(i * i2 * 4));
        checkGlError();
        return generateTexture;
    }
