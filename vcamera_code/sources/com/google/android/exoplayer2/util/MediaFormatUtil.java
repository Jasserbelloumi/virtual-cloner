...
public final class MediaFormatUtil {
    ...
    public static void maybeSetByteBuffer(MediaFormat mediaFormat, String str, @o0OO00OO byte[] bArr) {
        if (bArr != null) {
            mediaFormat.setByteBuffer(str, ByteBuffer.wrap(bArr));
        }
    }

    public static void maybeSetColorInfo(MediaFormat mediaFormat, @o0OO00OO ColorInfo colorInfo) {
        if (colorInfo != null) {
    ...
    public static void maybeSetString(MediaFormat mediaFormat, String str, @o0OO00OO String str2) {
        if (str2 != null) {
    ...
    public static void setCsdBuffers(MediaFormat mediaFormat, List<byte[]> list) {
        for (int i = 0; i < list.size(); i++) {
            mediaFormat.setByteBuffer(android.support.v4.media.o00oOOo0.o00oOOo0("csd-", i), ByteBuffer.wrap(list.get(i)));
        }
    }
}
