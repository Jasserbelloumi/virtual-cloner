...
public final class GlProgram {
        ...
        public void bind() {
            switch (this.type) {
                ...
                case 36198:
                    ...
                    break;
                default:
                    StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("Unexpected uniform type: ");
                    o00oOOo02.append(this.type);
    ...
    public GlProgram(String str, String str2) {
        ...
        if (iArr[0] != 1) {
            StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("Unable to link shader program: \n");
            o00oOOo02.append(GLES20.glGetProgramInfoLog(glCreateProgram));
            GlUtil.throwGlException(o00oOOo02.toString());
        }
