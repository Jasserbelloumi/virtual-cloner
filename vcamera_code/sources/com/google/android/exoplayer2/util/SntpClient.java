...
public final class SntpClient {
    ...
    public static final class NtpTimeCallback implements Loader.Callback<Loader.Loadable> {
        ...
        public NtpTimeCallback(@o0OO00OO InitializationCallback initializationCallback) {
    ...
    private static void checkValidServerReply(byte b, byte b2, int i, long j) throws IOException {
        ...
        if (b2 != 4 && b2 != 5) {
            throw new IOException(android.support.v4.media.o00oOOo0.o00oOOo0("SNTP: Untrusted mode: ", b2));
        }
        if (i == 0 || i > 15) {
            throw new IOException(android.support.v4.media.o00oOOo0.o00oOOo0("SNTP: Untrusted stratum: ", i));
        }
        if (j == 0) {
    ...
    public static void initialize(@o0OO00OO Loader loader, @o0OO00OO InitializationCallback initializationCallback) {
        if (isInitialized()) {
            if (initializationCallback != null) {
    ...
    private static long readTimestamp(byte[] bArr, int i) {
        ...
        return ((read322 * 1000) / o00oOOoO.o00oOo00.f6911o00ooo0o) + ((read32 - OFFSET_1900_TO_1970) * 1000);
    }
    ...
    private static void writeTimestamp(byte[] bArr, int i, long j) {
        ...
        int i5 = i4 + 1;
        bArr[i4] = (byte) (j3 >> 0);
        long j4 = ((j - (j2 * 1000)) * o00oOOoO.o00oOo00.f6911o00ooo0o) / 1000;
        int i6 = i5 + 1;
        bArr[i5] = (byte) (j4 >> 24);
        int i7 = i6 + 1;
        bArr[i6] = (byte) (j4 >> 16);
