...
public final class ParsableByteArray {
    ...
    public int readLittleEndianUnsignedIntToInt() {
        ...
        throw new IllegalStateException(android.support.v4.media.o00oOOo0.o00oOOo0("Top bit not zero: ", readLittleEndianInt));
    }
    ...
    public int readUnsignedIntToInt() {
        ...
        throw new IllegalStateException(android.support.v4.media.o00oOOo0.o00oOOo0("Top bit not zero: ", readInt));
    }
    ...
    public long readUnsignedLongToLong() {
        ...
        throw new IllegalStateException(o0O0OO0.o00oOo0O.o00oOOo0("Top bit not zero: ", readLong));
    }
    ...
    public long readUtf8EncodedLong() {
        ...
        if (i2 != 0) {
            for (i = 1; i < i2; i++) {
                if ((this.data[this.position + i] & 192) != 128) {
                    throw new NumberFormatException(o0O0OO0.o00oOo0O.o00oOOo0("Invalid UTF-8 sequence continuation byte: ", j));
                }
                j = (j << 6) | (b & 63);
            }
            this.position += i2;
        ...
        throw new NumberFormatException(o0O0OO0.o00oOo0O.o00oOOo0("Invalid UTF-8 sequence first byte: ", j));
    }
