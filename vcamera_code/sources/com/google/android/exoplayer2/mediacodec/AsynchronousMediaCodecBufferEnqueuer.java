...
class AsynchronousMediaCodecBufferEnqueuer {
    ...
    @o0OO00OO
    private static byte[] copy(@o0OO00OO byte[] bArr, @o0OO00OO byte[] bArr2) {
        if (bArr == null) {
            return bArr2;
        }
    ...
    @o0OO00OO
    private static int[] copy(@o0OO00OO int[] iArr, @o0OO00OO int[] iArr2) {
        if (iArr == null) {
            return iArr2;
        }
    ...
    public void doHandleMessage(Message message) {
        ...
        if (i == 0) {
            ...
            o0oO0Ooo.o00oOOo0(this.pendingRuntimeException, null, new IllegalStateException(String.valueOf(message.what)));
        } else {
    ...
    private void doQueueInputBuffer(int i, int i2, int i3, long j, int i4) {
        try {
            ...
            o0oO0Ooo.o00oOOo0(this.pendingRuntimeException, null, e);
        }
    }
