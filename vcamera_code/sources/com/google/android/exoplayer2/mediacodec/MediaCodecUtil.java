...
public final class MediaCodecUtil {
    ...
    public static final class CodecKey {
        ...
        public int hashCode() {
            return ((o0O0OOOo.o00oo0O0.o00oOOo0(this.mimeType, 31, 31) + (this.secure ? 1231 : 1237)) * 31) + (this.tunneling ? 1231 : 1237);
        }
    }
    ...
    private static void applyWorkarounds(String str, List<MediaCodecInfo> list) {
        if (MimeTypes.AUDIO_RAW.equals(str)) {
            ...
            sortByScore(list, new ScoreProvider() { // from class: com.google.android.exoplayer2.mediacodec.o0O0o
        ...
        if (i < 21 && list.size() > 1) {
            ...
            if ("OMX.SEC.mp3.dec".equals(str2) || "OMX.SEC.MP3.Decoder".equals(str2) || "OMX.brcm.audio.mp3.decoder".equals(str2)) {
                sortByScore(list, new ScoreProvider() { // from class: com.google.android.exoplayer2.mediacodec.o00oo
                    @Override // com.google.android.exoplayer2.mediacodec.MediaCodecUtil.ScoreProvider
                    public final int getScore(Object obj) {
    ...
    @o0OO00OO
    private static Integer dolbyVisionStringToLevel(@o0OO00OO String str) {
        int i;
        if (str == null) {
            return null;
        }
    ...
    @o0OO00OO
    private static Integer dolbyVisionStringToProfile(@o0OO00OO String str) {
        int i;
        if (str == null) {
            return null;
        }
    ...
    @o0OO00OO
    private static Pair<Integer, Integer> getAv1ProfileAndLevel(String str, String[] strArr, @o0OO00OO ColorInfo colorInfo) {
        StringBuilder sb;
        int parseInt;
        int parseInt2;
        int parseInt3;
    ...
    private static Pair<Integer, Integer> getAvcProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length >= 2) {
            ...
            if (avcProfileNumberToConst == -1) {
                o00oOOo02 = android.support.v4.media.o00oOOo0.o00oOOo0("Unknown AVC profile: ", i);
                Log.w(TAG, o00oOOo02);
                return null;
            }
    ...
    */
    ...
    public static List<MediaCodecInfo> getDecoderInfosSortedByFormatSupport(List<MediaCodecInfo> list, final Format format) {
        ...
        sortByScore(arrayList, new ScoreProvider() { // from class: com.google.android.exoplayer2.mediacodec.o00ooO0
            @Override // com.google.android.exoplayer2.mediacodec.MediaCodecUtil.ScoreProvider
            public final int getScore(Object obj) {
    ...
    private static Pair<Integer, Integer> getVp9ProfileAndLevel(String str, String[] strArr) {
        ...
        if (strArr.length >= 3) {
            ...
            if (vp9ProfileNumberToConst == -1) {
                o00oOOo02 = android.support.v4.media.o00oOOo0.o00oOOo0("Unknown VP9 profile: ", parseInt);
                Log.w(TAG, o00oOOo02);
                return null;
            }
    ...
    @o0OO00OO
    private static Integer hevcCodecStringToProfileLevel(@o0OO00OO String str) {
        int i;
        if (str == null) {
            return null;
        }
    ...
    private static <T> void sortByScore(List<T> list, final ScoreProvider<T> scoreProvider) {
        Collections.sort(list, new Comparator() { // from class: com.google.android.exoplayer2.mediacodec.o00oo0O
