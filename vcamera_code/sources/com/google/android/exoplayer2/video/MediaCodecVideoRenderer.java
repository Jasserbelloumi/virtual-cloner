...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    private static final int[] STANDARD_LONG_EDGE_VIDEO_PX = {1920, 1600, 1440, MediaDiscoverer.Event.Started, 960, 854, 640, 540, 480};
    ...
    public MediaCodecVideoRenderer(Context context, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, long j, boolean z, @o0OO00OO Handler handler, @o0OO00OO VideoRendererEventListener videoRendererEventListener, int i) {
        this(context, factory, mediaCodecSelector, j, z, handler, videoRendererEventListener, i, 30.0f);
    }

    public MediaCodecVideoRenderer(Context context, MediaCodecAdapter.Factory factory, MediaCodecSelector mediaCodecSelector, long j, boolean z, @o0OO00OO Handler handler, @o0OO00OO VideoRendererEventListener videoRendererEventListener, int i, float f) {
    ...
    public MediaCodecVideoRenderer(Context context, MediaCodecSelector mediaCodecSelector, long j, @o0OO00OO Handler handler, @o0OO00OO VideoRendererEventListener videoRendererEventListener, int i) {
        this(context, MediaCodecAdapter.Factory.DEFAULT, mediaCodecSelector, j, false, handler, videoRendererEventListener, i, 30.0f);
    }

    public MediaCodecVideoRenderer(Context context, MediaCodecSelector mediaCodecSelector, long j, boolean z, @o0OO00OO Handler handler, @o0OO00OO VideoRendererEventListener videoRendererEventListener, int i) {
    ...
    */
    ...
    private void setOutput(@o0OO00OO Object obj) throws ExoPlaybackException {
    ...
    @Override // com.google.android.exoplayer2.mediacodec.MediaCodecRenderer
    public MediaCodecDecoderException createDecoderException(Throwable th, @o0OO00OO MediaCodecInfo mediaCodecInfo) {
    ...
    @Override // com.google.android.exoplayer2.mediacodec.MediaCodecRenderer
    @TargetApi(17)
    public MediaCodecAdapter.Configuration getMediaCodecConfiguration(MediaCodecInfo mediaCodecInfo, Format format, @o0OO00OO MediaCrypto mediaCrypto, float f) {
        PlaceholderSurface placeholderSurface = this.placeholderSurface;
    ...
    @Override // com.google.android.exoplayer2.mediacodec.MediaCodecRenderer
    public void onOutputFormatChanged(Format format, @o0OO00OO MediaFormat mediaFormat) {
        MediaCodecAdapter codec = getCodec();
        if (codec != null) {
            codec.setVideoScalingMode(this.scalingMode);
        }
    ...
    @Override // com.google.android.exoplayer2.mediacodec.MediaCodecRenderer
    public boolean processOutputBuffer(long j, long j2, @o0OO00OO MediaCodecAdapter mediaCodecAdapter, @o0OO00OO ByteBuffer byteBuffer, int i, int i2, int i3, long j3, boolean z, boolean z2, Format format) throws ExoPlaybackException {
        boolean z3;
        long j4;
