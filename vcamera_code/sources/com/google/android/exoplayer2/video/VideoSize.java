...
public final class VideoSize implements Bundleable {
    ...
    public static final Bundleable.Creator<VideoSize> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.video.o00ooO
    ...
    public VideoSize(@o0O0o00O(from = 0) int i, @o0O0o00O(from = 0) int i2) {
        this(i, i2, 0, 1.0f);
    }

    public VideoSize(@o0O0o00O(from = 0) int i, @o0O0o00O(from = 0) int i2, @o0O0o00O(from = 0, to = 359) int i3, @o0O0OO0(from = 0.0d, fromInclusive = false) float f) {
        this.width = i;
        this.height = i2;
