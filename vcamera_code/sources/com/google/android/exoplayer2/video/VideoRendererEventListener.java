...
public interface VideoRendererEventListener {
    ...
    public static final class EventDispatcher {
        ...
        public EventDispatcher(@o0OO00OO Handler handler, @o0OO00OO VideoRendererEventListener videoRendererEventListener) {
        ...
        public void decoderInitialized(final String str, final long j, final long j2) {
            ...
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00ooO0
        ...
        public void decoderReleased(final String str) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00oo00O
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void disabled(final DecoderCounters decoderCounters) {
            ...
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00oOo0O
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void droppedFrames(final int i, final long j) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00oo
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void enabled(final DecoderCounters decoderCounters) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00oOoO
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void inputFormatChanged(final Format format, @o0OO00OO final DecoderReuseEvaluation decoderReuseEvaluation) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00oo0O0
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void renderedFirstFrame(final Object obj) {
            if (this.handler != null) {
                ...
                this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o0O0o
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void reportVideoFrameProcessingOffset(final long j, final int i) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00oo0OO
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void videoCodecError(final Exception exc) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00oo0O
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        public void videoSizeChanged(final VideoSize videoSize) {
            Handler handler = this.handler;
            if (handler != null) {
                handler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.o00oo0
                    @Override // java.lang.Runnable
                    public final void run() {
    ...
    default void onVideoInputFormatChanged(Format format, @o0OO00OO DecoderReuseEvaluation decoderReuseEvaluation) {
    }
