...
public final class VideoFrameReleaseHelper {
    ...
    public interface DisplayHelper {
        ...
        public interface Listener {
            void onDefaultDisplayChanged(@o0OO00OO Display display);
        }
    ...
    public VideoFrameReleaseHelper(@o0OO00OO Context context) {
    ...
    @o0OO00OO
    private static DisplayHelper maybeBuildDisplayHelper(@o0OO00OO Context context) {
        if (context != null) {
    ...
    public void updateDefaultDisplayRefreshRateParams(@o0OO00OO Display display) {
        long j;
        if (display != null) {
    ...
    */
    ...
    public void onStarted() {
        ...
        if (this.displayHelper != null) {
            ...
            this.displayHelper.register(new DisplayHelper.Listener() { // from class: com.google.android.exoplayer2.video.o00oOOoO
    ...
    public void onSurfaceChanged(@o0OO00OO Surface surface) {
