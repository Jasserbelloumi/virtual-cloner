...
public final class SceneRenderer implements VideoFrameMetadataListener, CameraMotionListener {
    ...
    private void setProjection(@o0OO00OO byte[] bArr, int i, long j) {
    ...
    public SurfaceTexture init() {
        ...
        surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: com.google.android.exoplayer2.video.spherical.o00oOOo0
    ...
    public void onVideoFrameAboutToBeRendered(long j, long j2, Format format, @o0OO00OO MediaFormat mediaFormat) {
