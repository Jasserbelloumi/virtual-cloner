...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    public SphericalGLSurfaceView(Context context, @o0OO00OO AttributeSet attributeSet) {
    ...
    public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture) {
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.spherical.o00oOOoO
    ...
    private static void releaseSurface(@o0OO00OO SurfaceTexture surfaceTexture, @o0OO00OO Surface surface) {
    ...
    public void onDetachedFromWindow() {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.video.spherical.o00oOo00
            @Override // java.lang.Runnable
            public final void run() {
