...
public final class DefaultPlaybackSessionManager implements PlaybackSessionManager {
    public static final Supplier<String> DEFAULT_SESSION_ID_GENERATOR = new Supplier() { // from class: com.google.android.exoplayer2.analytics.o0OOO0
    ...
    public final class SessionDescriptor {
        ...
        public SessionDescriptor(String str, int i, @o00oOooO.o0OO00OO MediaSource.MediaPeriodId mediaPeriodId) {
            this.sessionId = str;
            this.windowIndex = i;
        ...
        public boolean belongsToSession(int i, @o00oOooO.o0OO00OO MediaSource.MediaPeriodId mediaPeriodId) {
        ...
        public void maybeSetWindowSequenceNumber(int i, @o00oOooO.o0OO00OO MediaSource.MediaPeriodId mediaPeriodId) {
    ...
    private SessionDescriptor getOrAddSession(int i, @o00oOooO.o0OO00OO MediaSource.MediaPeriodId mediaPeriodId) {
        int i2;
