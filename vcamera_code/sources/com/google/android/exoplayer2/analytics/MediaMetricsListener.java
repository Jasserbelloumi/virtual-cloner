...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    private boolean canReportPendingFormatUpdate(@o00oOooO.o0OO00OO PendingFormatUpdate pendingFormatUpdate) {
    ...
    private void maybeUpdateAudioFormat(long j, @o00oOooO.o0OO00OO Format format, int i) {
    ...
    private void maybeUpdateTextFormat(long j, @o00oOooO.o0OO00OO Format format, int i) {
    ...
    private void maybeUpdateTimelineMetadata(Timeline timeline, @o00oOooO.o0OO00OO MediaSource.MediaPeriodId mediaPeriodId) {
        int indexOfPeriod;
        PlaybackMetrics$Builder playbackMetrics$Builder = this.metricsBuilder;
        ...
        playbackMetrics$Builder.setStreamType(getStreamType(this.window.mediaItem));
    ...
    private void maybeUpdateVideoFormat(long j, @o00oOooO.o0OO00OO Format format, int i) {
    ...
    private void reportTrackChangeEvent(int i, long j, @o00oOooO.o0OO00OO Format format, int i2) {
