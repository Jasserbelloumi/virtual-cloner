...
public final class TtmlRenderUtil {
    ...
    public static void applyStylesToSpan(Spannable spannable, int i, int i2, TtmlStyle ttmlStyle, @o0OO00OO TtmlNode ttmlNode, Map<String, TtmlStyle> map, int i3) {
    ...
    @o0OO00OO
    private static TtmlNode findRubyContainerNode(@o0OO00OO TtmlNode ttmlNode, Map<String, TtmlStyle> map) {
        while (ttmlNode != null) {
    ...
    @o0OO00OO
    public static TtmlStyle resolveStyle(@o0OO00OO TtmlStyle ttmlStyle, @o0OO00OO String[] strArr, Map<String, TtmlStyle> map) {
        int i = 0;
        if (ttmlStyle == null) {
            if (strArr == null) {
                return null;
