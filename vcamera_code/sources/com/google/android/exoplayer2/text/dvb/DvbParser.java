...
final class DvbParser {
    ...
    private static int paint2BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, @o0OO00OO byte[] bArr, int i, int i2, @o0OO00OO Paint paint, Canvas canvas) {
        boolean z;
        int i3;
        int readBits;
        int i4 = i;
    ...
    private static int paint4BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, @o0OO00OO byte[] bArr, int i, int i2, @o0OO00OO Paint paint, Canvas canvas) {
        boolean z;
        int i3;
        int readBits;
        int i4 = i;
    ...
    private static int paint8BitPixelCodeString(ParsableBitArray parsableBitArray, int[] iArr, @o0OO00OO byte[] bArr, int i, int i2, @o0OO00OO Paint paint, Canvas canvas) {
        boolean z;
        int readBits;
        int i3 = i;
        boolean z2 = false;
    ...
    private static void paintPixelDataSubBlock(byte[] bArr, int[] iArr, int i, int i2, int i3, @o0OO00OO Paint paint, Canvas canvas) {
        byte[] bArr2;
        byte[] bArr3;
        byte[] bArr4;
    ...
    private static void paintPixelDataSubBlocks(ObjectData objectData, ClutDefinition clutDefinition, int i, int i2, int i3, @o0OO00OO Paint paint, Canvas canvas) {
    ...
    private static ClutDefinition parseClutDefinition(ParsableBitArray parsableBitArray, int i) {
        ...
        while (i6 > 0) {
            ...
            iArr[readBits5] = getColor((byte) (255 - (readBits2 & 255)), Util.constrainValue((int) ((1.402d * d2) + d), 0, 255), Util.constrainValue((int) ((d - (0.34414d * d3)) - (d2 * 0.71414d)), 0, 255), Util.constrainValue((int) ((d3 * 1.772d) + d), 0, 255));
            i6 = i2;
            readBits4 = readBits4;
            i4 = 8;
            i5 = 2;
