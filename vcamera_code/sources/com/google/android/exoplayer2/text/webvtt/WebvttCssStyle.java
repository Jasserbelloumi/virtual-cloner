...
public final class WebvttCssStyle {
    ...
    private static int updateScoreForMatch(int i, String str, @o0OO00OO String str2, int i2) {
        if (str.isEmpty() || i == -1) {
            return i;
        }
        if (str.equals(str2)) {
    ...
    public int getSpecificityScore(@o0OO00OO String str, @o0OO00OO String str2, Set<String> set, @o0OO00OO String str3) {
    ...
    public WebvttCssStyle setFontFamily(@o0OO00OO String str) {
