...
public final class TextRenderer extends BaseRenderer implements Handler.Callback {
    ...
    public TextRenderer(TextOutput textOutput, @o0OO00OO Looper looper) {
        this(textOutput, looper, SubtitleDecoderFactory.DEFAULT);
    }

    public TextRenderer(TextOutput textOutput, @o0OO00OO Looper looper, SubtitleDecoderFactory subtitleDecoderFactory) {
        super(3);
    ...
    private void handleDecoderError(SubtitleDecoderException subtitleDecoderException) {
        StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("Subtitle decoding failed. streamFormat=");
        o00oOOo02.append(this.streamFormat);
        Log.e(TAG, o00oOOo02.toString(), subtitleDecoderException);
        clearOutput();
        replaceDecoder();
    }
