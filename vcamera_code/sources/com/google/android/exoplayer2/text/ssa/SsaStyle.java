...
public final class SsaStyle {
    ...
    public static final class Overrides {
        ...
        private Overrides(int i, @o0OO00OO PointF pointF) {
            this.alignment = i;
    ...
    private SsaStyle(String str, int i, @o0O00O @o0OO00OO Integer num, @o0O00O @o0OO00OO Integer num2, float f, boolean z, boolean z2, boolean z3, boolean z4, int i2) {
        this.name = str;
        this.alignment = i;
    ...
    public static Integer parseColor(String str) {
        try {
            ...
            Assertions.checkArgument(parseLong <= UnsignedInts.INT_MASK);
