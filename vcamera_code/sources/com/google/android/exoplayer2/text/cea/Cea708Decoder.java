...
public final class Cea708Decoder extends CeaDecoder {
    ...
    public static final class Cea708CueInfo {
        private static final Comparator<Cea708CueInfo> LEAST_IMPORTANT_FIRST = new Comparator() { // from class: com.google.android.exoplayer2.text.cea.o00oOOo0
    ...
    public Cea708Decoder(int i, @o0OO00OO List<byte[]> list) {
        boolean z = true;
    ...
    private void handleC0Command(int i) {
        ...
        if (i != 0) {
            ...
            switch (i) {
                ...
                default:
                    if (i >= 17 && i <= 23) {
                        com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Currently unsupported COMMAND_EXT1 Command: ", i, TAG);
                        parsableBitArray = this.captionChannelPacketData;
                    } else if (i < 24 || i > 31) {
                        com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Invalid C0 command: ", i, TAG);
                        return;
                    } else {
                        com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Currently unsupported COMMAND_P16 Command: ", i, TAG);
                        parsableBitArray = this.captionChannelPacketData;
                        i2 = 16;
                    }
    ...
    private void handleC1Command(int i) {
        ...
        switch (i) {
            ...
            case 150:
            default:
                com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Invalid C1 command: ", i, TAG);
                return;
    ...
    private void handleG2Character(int i) {
        ...
        if (i == 32) {
            ...
            switch (i) {
                ...
                case 49:
                    cueInfoBuilder = this.currentCueInfoBuilder;
                    c = oOo0oooO.f13914o00oo;
                    break;
                case 50:
                    cueInfoBuilder = this.currentCueInfoBuilder;
                    c = oOo0oooO.f13926o00ooO00;
                    break;
                case 51:
                    cueInfoBuilder = this.currentCueInfoBuilder;
                    c = oOo0oooO.f13927o00ooO0O;
                    break;
                case 52:
                    cueInfoBuilder = this.currentCueInfoBuilder;
                    c = oOo0oooO.f13928o00ooO0o;
                    break;
                case 53:
                    cueInfoBuilder = this.currentCueInfoBuilder;
                    c = oOo0oooO.f13931o00ooOOo;
                    break;
                default:
                    switch (i) {
                        case 118:
                        ...
                        case 127:
                            ...
                            break;
                        default:
                            com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Invalid G2 character: ", i, TAG);
                            return;
                    }
            }
        } else {
    ...
    private void handleG3Character(int i) {
        ...
        if (i == 160) {
            ...
            com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Invalid G3 character: ", i, TAG);
            cueInfoBuilder = this.currentCueInfoBuilder;
            c = '_';
        }
        cueInfoBuilder.append(c);
    ...
    private void processCurrentPacket() {
        ...
        if (dtvCcPacket.currentIndex != (dtvCcPacket.packetSize * 2) - 1) {
            StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("DtvCcPacket ended prematurely; size is ");
            o00oOOo02.append((this.currentDtvCcPacket.packetSize * 2) - 1);
            o00oOOo02.append(", but current index is ");
            o00oOOo02.append(this.currentDtvCcPacket.currentIndex);
            o00oOOo02.append(" (sequence number ");
            o00oOOo02.append(this.currentDtvCcPacket.sequenceNumber);
            o00oOOo02.append(");");
            Log.d(TAG, o00oOOo02.toString());
        }
        boolean z = false;
        ...
        while (true) {
            ...
            if (readBits == 7) {
                ...
                if (readBits < 7) {
                    com.google.android.exoplayer2.o00oOOo0.o00oOOo0("Invalid extended service number: ", readBits, TAG);
                }
            }
            if (readBits2 == 0) {
                if (readBits != 0) {
            ...
            if (i == 2 || i == 3) {
                if (z) {
                    if (i == 3) {
                        ...
                        if (i3 != -1 && i2 != (i3 + 1) % 4) {
                            resetCueBuilders();
                            StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("Sequence number discontinuity. previous=");
                            o00oOOo02.append(this.previousSequenceNumber);
                            o00oOOo02.append(" current=");
                            o00oOOo02.append(i2);
