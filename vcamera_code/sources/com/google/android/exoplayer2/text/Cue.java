...
public final class Cue implements Bundleable {
    ...
    public static final Bundleable.Creator<Cue> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.text.o00oOOo0
    ...
    public static final class Builder {
        ...
        public Builder setMultiRowAlignment(@o0OO00OO Layout.Alignment alignment) {
        ...
        public Builder setTextAlignment(@o0OO00OO Layout.Alignment alignment) {
        ...
        public Builder setWindowColor(@o0O00O int i) {
            this.windowColor = i;
    ...
    @Deprecated
    public Cue(CharSequence charSequence, @o0OO00OO Layout.Alignment alignment, float f, int i, int i2, float f2, int i3, float f3) {
        this(charSequence, alignment, f, i, i2, f2, i3, f3, false, -16777216);
    }

    @Deprecated
    public Cue(CharSequence charSequence, @o0OO00OO Layout.Alignment alignment, float f, int i, int i2, float f2, int i3, float f3, int i4, float f4) {
        this(charSequence, alignment, null, null, f, i, i2, f2, i3, i4, f4, f3, -3.4028235E38f, false, -16777216, Integer.MIN_VALUE, 0.0f);
    }

    @Deprecated
    public Cue(CharSequence charSequence, @o0OO00OO Layout.Alignment alignment, float f, int i, int i2, float f2, int i3, float f3, boolean z, int i4) {
    ...
    private Cue(@o0OO00OO CharSequence charSequence, @o0OO00OO Layout.Alignment alignment, @o0OO00OO Layout.Alignment alignment2, @o0OO00OO Bitmap bitmap, float f, int i, int i2, float f2, int i3, int i4, float f3, float f4, float f5, boolean z, int i5, int i6, float f6) {
