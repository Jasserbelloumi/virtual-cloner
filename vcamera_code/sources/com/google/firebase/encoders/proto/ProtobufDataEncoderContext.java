...
public final class ProtobufDataEncoderContext implements ObjectEncoderContext {
    ...
    private static final ObjectEncoder<Map.Entry<Object, Object>> DEFAULT_MAP_ENCODER = new ObjectEncoder() { // from class: com.google.firebase.encoders.proto.o00oOOo0
    ...
    @oo0oO0
    public ObjectEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, double d) throws IOException {
        return add(fieldDescriptor, d, true);
    }

    public ObjectEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, double d, boolean z) throws IOException {
        if (z && d == 0.0d) {
            return this;
        }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, float f) throws IOException {
        return add(fieldDescriptor, f, true);
    }

    public ObjectEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, float f, boolean z) throws IOException {
        if (z && f == 0.0f) {
            return this;
        }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, @o0OO00OO Object obj) throws IOException {
        return add(fieldDescriptor, obj, true);
    }

    public ObjectEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, @o0OO00OO Object obj, boolean z) throws IOException {
        if (obj == null) {
            return this;
        }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext add(@oo0oO0 String str, double d) throws IOException {
        return add(FieldDescriptor.of(str), d);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext add(@oo0oO0 String str, int i) throws IOException {
        return add(FieldDescriptor.of(str), i);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext add(@oo0oO0 String str, long j) throws IOException {
        return add(FieldDescriptor.of(str), j);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext add(@oo0oO0 String str, @o0OO00OO Object obj) throws IOException {
        return add(FieldDescriptor.of(str), obj);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext add(@oo0oO0 String str, boolean z) throws IOException {
        return add(FieldDescriptor.of(str), z);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ProtobufDataEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, int i) throws IOException {
        return add(fieldDescriptor, i, true);
    }

    public ProtobufDataEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (z && i == 0) {
            return this;
        }
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ProtobufDataEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, long j) throws IOException {
        return add(fieldDescriptor, j, true);
    }

    public ProtobufDataEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (z && j == 0) {
            return this;
        }
        Protobuf protobuf = getProtobuf(fieldDescriptor);
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ProtobufDataEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, boolean z) throws IOException {
        return add(fieldDescriptor, z, true);
    }

    public ProtobufDataEncoderContext add(@oo0oO0 FieldDescriptor fieldDescriptor, boolean z, boolean z2) throws IOException {
        return add(fieldDescriptor, z ? 1 : 0, z2);
    }

    public ProtobufDataEncoderContext encode(@o0OO00OO Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder<?> objectEncoder = this.objectEncoders.get(obj.getClass());
        ...
        StringBuilder o00oOOo02 = o00oOo0O.o00oOOo0("No encoder for ");
    ...
    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext inline(@o0OO00OO Object obj) throws IOException {
        return encode(obj);
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext nested(@oo0oO0 FieldDescriptor fieldDescriptor) throws IOException {
        throw new EncodingException("nested() is not implemented for protobuf encoding.");
    }

    @Override // com.google.firebase.encoders.ObjectEncoderContext
    @oo0oO0
    public ObjectEncoderContext nested(@oo0oO0 String str) throws IOException {
