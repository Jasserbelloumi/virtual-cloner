...
public final class JsonDataEncoderBuilder implements EncoderConfig<JsonDataEncoderBuilder> {
    private static final ObjectEncoder<Object> DEFAULT_FALLBACK_ENCODER = new ObjectEncoder() { // from class: com.google.firebase.encoders.json.o00oOOo0
        @Override // com.google.firebase.encoders.ObjectEncoder, com.google.firebase.encoders.Encoder
        public final void encode(Object obj, ObjectEncoderContext objectEncoderContext) {
            JsonDataEncoderBuilder.lambda$static$0(obj, objectEncoderContext);
        }
    };
    private static final ValueEncoder<String> STRING_ENCODER = new ValueEncoder() { // from class: com.google.firebase.encoders.json.o00oOOoO
    ...
    private static final ValueEncoder<Boolean> BOOLEAN_ENCODER = new ValueEncoder() { // from class: com.google.firebase.encoders.json.o00oOo00
        @Override // com.google.firebase.encoders.ValueEncoder, com.google.firebase.encoders.Encoder
        public final void encode(Object obj, ValueEncoderContext valueEncoderContext) {
    ...
    public static final class TimestampEncoder implements ValueEncoder<Date> {
        ...
        @Override // com.google.firebase.encoders.ValueEncoder, com.google.firebase.encoders.Encoder
        public void encode(@oo0oO0 Date date, @oo0oO0 ValueEncoderContext valueEncoderContext) throws IOException {
    ...
    public DataEncoder build() {
        return new DataEncoder() { // from class: com.google.firebase.encoders.json.JsonDataEncoderBuilder.1
            ...
            public String encode(@oo0oO0 Object obj) {
            ...
            @Override // com.google.firebase.encoders.DataEncoder
            public void encode(@oo0oO0 Object obj, @oo0oO0 Writer writer) throws IOException {
    ...
    @oo0oO0
    public JsonDataEncoderBuilder configureWith(@oo0oO0 Configurator configurator) {
    ...
    @oo0oO0
    public <T> JsonDataEncoderBuilder registerEncoder(@oo0oO0 Class<T> cls, @oo0oO0 ObjectEncoder<? super T> objectEncoder) {
    ...
    @Override // com.google.firebase.encoders.config.EncoderConfig
    @oo0oO0
    public <T> JsonDataEncoderBuilder registerEncoder(@oo0oO0 Class<T> cls, @oo0oO0 ValueEncoder<? super T> valueEncoder) {
    ...
    @oo0oO0
    public JsonDataEncoderBuilder registerFallbackEncoder(@oo0oO0 ObjectEncoder<Object> objectEncoder) {
