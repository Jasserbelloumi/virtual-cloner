...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    private static final Provider<Set<Object>> EMPTY_PROVIDER = new Provider() { // from class: com.google.firebase.components.o00oo
    ...
    public static final class Builder {
        ...
        public Builder addComponentRegistrar(final ComponentRegistrar componentRegistrar) {
            this.lazyRegistrars.add(new Provider() { // from class: com.google.firebase.components.o00ooO0
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
    ...
    private void discoverComponents(List<Component<?>> list) {
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.o00oo0O0
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
            ...
            if (component.isValue()) {
                ...
                for (Qualified<? super Object> qualified : component.getProvidedInterfaces()) {
                    if (this.lazyInstanceMap.containsKey(qualified)) {
                        ...
                        arrayList.add(new Runnable() { // from class: com.google.firebase.components.o00oo0OO
        ...
        for (Map.Entry entry2 : hashMap.entrySet()) {
            if (this.lazySetMap.containsKey(entry2.getKey())) {
                ...
                for (final Provider provider : (Set) entry2.getValue()) {
                    arrayList.add(new Runnable() { // from class: com.google.firebase.components.o00oo0O
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    private static Iterable<Provider<ComponentRegistrar>> toProviders(Iterable<ComponentRegistrar> iterable) {
        ...
        for (final ComponentRegistrar componentRegistrar : iterable) {
            arrayList.add(new Provider() { // from class: com.google.firebase.components.o0O0o
                @Override // com.google.firebase.inject.Provider
                public final Object get() {
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap hashMap;
        if (o0oO0Ooo.o00oOOo0(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
