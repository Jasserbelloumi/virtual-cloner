...
public final class Dependency {
    ...
    private static String describeInjection(int i) {
        if (i != 0) {
            if (i != 1) {
                ...
                throw new AssertionError(android.support.v4.media.o00oOOo0.o00oOOo0("Unsupported injection: ", i));
            }
    ...
    public String toString() {
        ...
        sb.append(", injection=");
        return android.support.v4.media.o00oOOoO.o00oOOo0(sb, describeInjection(this.injection), "}");
    }
}
