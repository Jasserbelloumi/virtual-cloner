...
public class OptionalProvider<T> implements Provider<T>, Deferred<T> {
    ...
    private static final Deferred.DeferredHandler<Object> NOOP_HANDLER = new Deferred.DeferredHandler() { // from class: com.google.firebase.components.o0
        @Override // com.google.firebase.inject.Deferred.DeferredHandler
        public final void handle(Provider provider) {
            OptionalProvider.lambda$static$0(provider);
        }
    };
    private static final Provider<Object> EMPTY_PROVIDER = new Provider() { // from class: com.google.firebase.components.o0O00000
    ...
    public void whenAvailable(@oo0oO0 final Deferred.DeferredHandler<T> deferredHandler) {
        Provider<T> provider;
        ...
        synchronized (this) {
            ...
            if (provider != provider3) {
                ...
                this.handler = new Deferred.DeferredHandler() { // from class: com.google.firebase.components.o0O0000O
                    @Override // com.google.firebase.inject.Deferred.DeferredHandler
