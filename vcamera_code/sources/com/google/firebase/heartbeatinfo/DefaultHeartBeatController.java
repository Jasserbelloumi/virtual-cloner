...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    private DefaultHeartBeatController(final Context context, final String str, Set<HeartBeatConsumer> set, Provider<UserAgentPublisher> provider, Executor executor) {
        this(new Provider() { // from class: com.google.firebase.heartbeatinfo.o00oOo0O
    ...
    @oo0oO0
    public synchronized HeartBeatInfo.HeartBeat getHeartBeatCode(@oo0oO0 String str) {
    ...
    public Task<String> getHeartBeatsHeader() {
        return o0O0O0Oo.o00oOOo0.o00oOOo0(this.applicationContext) ^ true ? Tasks.forResult("") : Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.o00oOOo0
    ...
    public Task<Void> registerHeartBeat() {
        if (this.consumers.size() > 0 && !(!o0O0O0Oo.o00oOOo0.o00oOOo0(this.applicationContext))) {
            return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.o00oOOoO
                @Override // java.util.concurrent.Callable
                public final Object call() {
