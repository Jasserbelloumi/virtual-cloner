...
public class ConfigFetchHandler {
    ...
    public static class FetchResponse {
        ...
        private FetchResponse(Date date, int i, ConfigContainer configContainer, @o0OO00OO String str) {
            this.fetchTime = date;
            this.status = i;
    ...
    private FirebaseRemoteConfigServerException createExceptionWithGenericMessage(FirebaseRemoteConfigServerException firebaseRemoteConfigServerException) throws FirebaseRemoteConfigClientException {
        ...
        return new FirebaseRemoteConfigServerException(firebaseRemoteConfigServerException.getHttpStatusCode(), o00oo.o00oOOo0("Fetch failed: ", str), firebaseRemoteConfigServerException);
    }
    ...
    private Task<FetchResponse> fetchFromBackendAndCacheResponse(String str, String str2, Date date) {
        try {
            ...
            return fetchFromBackend.getStatus() != 0 ? Tasks.forResult(fetchFromBackend) : this.fetchedConfigsCache.put(fetchFromBackend.getFetchedConfigs()).onSuccessTask(this.executor, new SuccessContinuation() { // from class: com.google.firebase.remoteconfig.internal.o00oo0
    ...
    public Task<FetchResponse> lambda$fetch$0(Task<ConfigContainer> task, long j) {
        ...
        if (backoffEndTimeInMillis != null) {
            ...
            continueWithTask = Tasks.whenAllComplete(id, token).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.o00oOoO
        ...
        return continueWithTask.continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.o00oo00O
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
    ...
    public Task<FetchResponse> fetch(final long j) {
        return this.fetchedConfigsCache.get().continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.o00oOo0O
            @Override // com.google.android.gms.tasks.Continuation
