...
public final class Utils {
    ...
    public static boolean isValidApiKeyFormat(@o0OO00OO String str) {
        return API_KEY_FORMAT.matcher(str).matches();
    }

    public static boolean isValidAppIdFormat(@o0OO00OO String str) {
    ...
    public boolean isAuthTokenExpired(@oo0oO0 PersistedInstallationEntry persistedInstallationEntry) {
