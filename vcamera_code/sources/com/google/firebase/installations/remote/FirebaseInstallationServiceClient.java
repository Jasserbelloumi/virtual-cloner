...
public class FirebaseInstallationServiceClient {
    ...
    public FirebaseInstallationServiceClient(@oo0oO0 Context context, @oo0oO0 Provider<HeartBeatController> provider) {
        this.context = context;
        this.heartBeatProvider = provider;
    }

    private static String availableFirebaseOptions(@o0OO00OO String str, @oo0oO0 String str2, @oo0oO0 String str3) {
        Object[] objArr = new Object[3];
        objArr[0] = str2;
        objArr[1] = str3;
        objArr[2] = TextUtils.isEmpty(str) ? "" : o00oo.o00oOOo0(", ", str);
        return String.format("Firebase options used while communicating with Firebase server APIs: %s, %s%s", objArr);
    }

    private static JSONObject buildCreateFirebaseInstallationRequestBody(@o0OO00OO String str, @oo0oO0 String str2) {
        try {
    ...
    private static void logFisCommunicationError(HttpURLConnection httpURLConnection, @o0OO00OO String str, @oo0oO0 String str2, @oo0oO0 String str3) {
    ...
    private void writeFIDCreateRequestBodyToOutputStream(HttpURLConnection httpURLConnection, @o0OO00OO String str, @oo0oO0 String str2) throws IOException {
    ...
    @oo0oO0
    public InstallationResponse createFirebaseInstallation(@oo0oO0 String str, @o0OO00OO String str2, @oo0oO0 String str3, @oo0oO0 String str4, @o0OO00OO String str5) throws FirebaseInstallationsException {
        int responseCode;
        ...
        if (this.requestLimiter.isRequestAllowed()) {
            ...
            for (int i = 0; i <= 1; i++) {
                ...
                try {
                    openHttpURLConnection.setRequestMethod(o00oo0.f7538o00oOoOo);
    ...
    @oo0oO0
    public void deleteFirebaseInstallation(@oo0oO0 String str, @oo0oO0 String str2, @oo0oO0 String str3, @oo0oO0 String str4) throws FirebaseInstallationsException {
        int responseCode;
        int i = 0;
    ...
    @oo0oO0
    public TokenResult generateAuthToken(@oo0oO0 String str, @oo0oO0 String str2, @oo0oO0 String str3, @oo0oO0 String str4) throws FirebaseInstallationsException {
        int responseCode;
