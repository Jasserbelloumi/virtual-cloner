...
public class PersistedInstallation {
    ...
    public PersistedInstallation(@oo0oO0 FirebaseApp firebaseApp) {
    ...
    @oo0oO0
    public PersistedInstallationEntry insertOrUpdatePersistedInstallationEntry(@oo0oO0 PersistedInstallationEntry persistedInstallationEntry) {
        File createTempFile;
        try {
