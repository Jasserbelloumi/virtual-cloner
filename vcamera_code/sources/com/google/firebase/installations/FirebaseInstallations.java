...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    @o0O0OOOo("FirebaseInstallations.this")
    ...
    @SuppressLint({"ThreadPoolCreation"})
    public FirebaseInstallations(final FirebaseApp firebaseApp, @oo0oO0 Provider<HeartBeatController> provider, @oo0oO0 ExecutorService executorService, @oo0oO0 Executor executor) {
        this(executorService, executor, firebaseApp, new FirebaseInstallationServiceClient(firebaseApp.getApplicationContext(), provider), new PersistedInstallation(firebaseApp), Utils.getInstance(), new Lazy(new Provider() { // from class: com.google.firebase.installations.o00oOoO
    ...
    */
    ...
    public final void lambda$getToken$2(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.o00oOOo0
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(@oo0oO0 PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
    ...
    @oo0oO0
    public static FirebaseInstallations getInstance(@oo0oO0 FirebaseApp firebaseApp) {
    ...
    public Task<Void> delete() {
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.installations.o00oOOoO
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.o00oOo0O
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.o00oOo00
            @Override // java.lang.Runnable
            public final void run() {
    ...
    @Override // com.google.firebase.installations.FirebaseInstallationsApi
    @oo0oO0
    public synchronized FidListenerHandle registerFidListener(@oo0oO0 final FidListener fidListener) {
