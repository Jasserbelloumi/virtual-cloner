...
final class AutoValue_InstallationTokenResult extends InstallationTokenResult {
    ...
    public static final class Builder extends InstallationTokenResult.Builder {
        ...
        public InstallationTokenResult build() {
            ...
            if (this.tokenExpirationTimestamp == null) {
                str = o00oo.o00oOOo0(str, " tokenExpirationTimestamp");
            }
            if (this.tokenCreationTimestamp == null) {
                str = o00oo.o00oOOo0(str, " tokenCreationTimestamp");
            }
            if (str.isEmpty()) {
    ...
    public String toString() {
        StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("InstallationTokenResult{token=");
        o00oOOo02.append(this.token);
        o00oOOo02.append(", tokenExpirationTimestamp=");
        o00oOOo02.append(this.tokenExpirationTimestamp);
        o00oOOo02.append(", tokenCreationTimestamp=");
        return android.support.v4.media.session.o00oOo00.o00oOOo0(o00oOOo02, this.tokenCreationTimestamp, "}");
    }
}
