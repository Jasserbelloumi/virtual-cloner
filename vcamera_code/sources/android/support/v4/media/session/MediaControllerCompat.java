...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        public static class MediaControllerCallbackApi21 extends MediaController.Callback {
            ...
            public void onAudioInfoChanged(MediaController.PlaybackInfo playbackInfo) {
                ...
                if (callback != null) {
                    callback.onAudioInfoChanged(new PlaybackInfo(playbackInfo.getPlaybackType(), AudioAttributesCompat.o00oOoOo(playbackInfo.getAudioAttributes()), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume()));
                }
            }
    ...
    public static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public static class ExtraBinderRequestResultReceiver extends ResultReceiver {
            ...
            public void onReceiveResult(int i, Bundle bundle) {
                ...
                synchronized (mediaControllerImplApi21.mLock) {
                    mediaControllerImplApi21.mSessionToken.setExtraBinder(IMediaSession.Stub.asInterface(oO00O0o0.o00oOOo0.o00oOOo0(bundle, MediaSessionCompat.KEY_EXTRA_BINDER)));
                    mediaControllerImplApi21.mSessionToken.setSession2Token(oooOO0.o00oOo00(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN));
        ...
        @o0OO00OO
        public static MediaControllerCompat getMediaController(@oo0oO0 Activity activity) {
        ...
        public static void setMediaController(@oo0oO0 Activity activity, @o0OO00OO MediaControllerCompat mediaControllerCompat) {
        ...
        public PlaybackInfo getPlaybackInfo() {
            ...
            if (playbackInfo != null) {
                return new PlaybackInfo(playbackInfo.getPlaybackType(), AudioAttributesCompat.o00oOoOo(playbackInfo.getAudioAttributes()), playbackInfo.getVolumeControl(), playbackInfo.getMaxVolume(), playbackInfo.getCurrentVolume());
            }
            return null;
        }
    ...
    public static final class PlaybackInfo {
        ...
        */
        public PlaybackInfo(int r9, int r10, int r11, int r12, int r13) {
            /*
                r8 = this;
                androidx.media.AudioAttributesCompat$o00oOo0O r0 = new androidx.media.AudioAttributesCompat$o00oOo0O
                r0.<init>()
                androidx.media.AudioAttributesImpl$o00oOOo0 r1 = r0.f3484o00oOOo0
                r1.o00oOOoO(r10)
                androidx.media.AudioAttributesCompat r4 = r0.o00oOOo0()
                r2 = r8
                r3 = r9
                r5 = r11
                r6 = r12
        ...
        public PlaybackInfo(int i, @oo0oO0 AudioAttributesCompat audioAttributesCompat, int i2, int i3, int i4) {
        ...
        public int getAudioStream() {
            return this.mAudioAttrsCompat.o00oOo0O();
        }
    ...
    public MediaControllerCompat(Context context, @oo0oO0 MediaSessionCompat.Token token) {
        if (token == null) {
    ...
    public MediaControllerCompat(Context context, @oo0oO0 MediaSessionCompat mediaSessionCompat) {
    ...
    public static void setMediaController(@oo0oO0 Activity activity, MediaControllerCompat mediaControllerCompat) {
    ...
    public static void validateCustomAction(String str, Bundle bundle) {
        ...
        if (str.equals(MediaSessionCompat.ACTION_FOLLOW) || str.equals(MediaSessionCompat.ACTION_UNFOLLOW)) {
            if (bundle == null || !bundle.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                throw new IllegalArgumentException(o00oOoO.o00oOOo0("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action ", str, "."));
            }
        }
    }
    ...
    public void registerCallback(@oo0oO0 Callback callback) {
        registerCallback(callback, null);
    }

    public void registerCallback(@oo0oO0 Callback callback, Handler handler) {
        if (callback == null) {
    ...
    public void sendCommand(@oo0oO0 String str, @o0OO00OO Bundle bundle, @o0OO00OO ResultReceiver resultReceiver) {
    ...
    public void unregisterCallback(@oo0oO0 Callback callback) {
        if (callback == null) {
            throw new IllegalArgumentException("callback must not be null");
        }
