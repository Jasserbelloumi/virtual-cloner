...
public class MediaSessionCompat {
        ...
        public class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                if (message.what == 1) {
                    ...
                    mediaSessionImpl.setCurrentControllerInfo((o00oOOoO.C0034o00oOOoO) message.obj);
            ...
            public void onCommand(String str, Bundle bundle, ResultReceiver resultReceiver) {
                ...
                try {
                    ...
                    if (str.equals(MediaControllerCompat.COMMAND_GET_EXTRA_BINDER)) {
                        ...
                        oO00O0o0.o00oOOo0.o00oOOoO(bundle2, MediaSessionCompat.KEY_EXTRA_BINDER, asBinder);
                        oooOO0.o00oOo0O(bundle2, MediaSessionCompat.KEY_SESSION2_TOKEN, sessionToken.getSession2Token());
    ...
    public interface MediaSessionImpl {
        ...
        o00oOOoO.C0034o00oOOoO getCurrentControllerInfo();
        ...
        void setCurrentControllerInfo(o00oOOoO.C0034o00oOOoO c0034o00oOOoO);
        ...
        void setPlaybackToRemote(o00oOo0O o00ooo0o2);
    ...
    public static class MediaSessionImplApi18 extends MediaSessionImplBase {
        ...
        public MediaSessionImplApi18(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, o0OO000o o0oo000o, Bundle bundle) {
            super(context, str, componentName, pendingIntent, o0oo000o, bundle);
        }
    ...
    public static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        public MediaSessionImplApi19(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, o0OO000o o0oo000o, Bundle bundle) {
            super(context, str, componentName, pendingIntent, o0oo000o, bundle);
        }
    ...
    public static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        @o0O0OOOo("mLock")
        public o00oOOoO.C0034o00oOOoO mRemoteUserInfo;
        ...
        public class ExtraSession extends IMediaSession.Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback, new o00oOOoO.C0034o00oOOoO(o00oOOoO.C0034o00oOOoO.f3648o00oOOoO, Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public MediaSessionImplApi21(Context context, String str, o0OO000o o0oo000o, Bundle bundle) {
            MediaSession createFwkMediaSession = createFwkMediaSession(context, str, bundle);
            this.mSessionFwk = createFwkMediaSession;
            this.mToken = new Token(createFwkMediaSession.getSessionToken(), new ExtraSession(), o0oo000o);
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public o00oOOoO.C0034o00oOOoO getCurrentControllerInfo() {
            o00oOOoO.C0034o00oOOoO c0034o00oOOoO;
            synchronized (this.mLock) {
                c0034o00oOOoO = this.mRemoteUserInfo;
            }
            return c0034o00oOOoO;
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setCurrentControllerInfo(o00oOOoO.C0034o00oOOoO c0034o00oOOoO) {
            synchronized (this.mLock) {
                this.mRemoteUserInfo = c0034o00oOOoO;
            }
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        public void setPlaybackToRemote(o00oOo0O o00ooo0o2) {
            this.mSessionFwk.setPlaybackToRemote((VolumeProvider) o00ooo0o2.o00oOo0O());
        }
    ...
    public static class MediaSessionImplApi22 extends MediaSessionImplApi21 {
        public MediaSessionImplApi22(Context context, String str, o0OO000o o0oo000o, Bundle bundle) {
            super(context, str, o0oo000o, bundle);
        }
    ...
    public static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        public MediaSessionImplApi28(Context context, String str, o0OO000o o0oo000o, Bundle bundle) {
            super(context, str, o0oo000o, bundle);
        }
        ...
        @Override // android.support.v4.media.session.MediaSessionCompat.MediaSessionImplApi21, android.support.v4.media.session.MediaSessionCompat.MediaSessionImpl
        @oo0oO0
        public final o00oOOoO.C0034o00oOOoO getCurrentControllerInfo() {
            return new o00oOOoO.C0034o00oOOoO(this.mSessionFwk.getCurrentControllerInfo());
        }
    ...
    public static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        public MediaSessionImplApi29(Context context, String str, o0OO000o o0oo000o, Bundle bundle) {
            super(context, str, o0oo000o, bundle);
        }
    ...
    public static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        private o00oOOoO.C0034o00oOOoO mRemoteUserInfo;
        public int mRepeatMode;
        ...
        public o00oOo0O mVolumeProvider;
        ...
        public int mFlags = 3;
        private o00oOo0O.AbstractC0147o00oOo0O mVolumeCallback = new o00oOo0O.AbstractC0147o00oOo0O() { // from class: android.support.v4.media.session.MediaSessionCompat.MediaSessionImplBase.1
            @Override // o0O0O0Oo.o00oOo0O.AbstractC0147o00oOo0O
            public void onVolumeChanged(o00oOo0O o00ooo0o2) {
                if (MediaSessionImplBase.this.mVolumeProvider != o00ooo0o2) {
                    return;
                }
                MediaSessionImplBase mediaSessionImplBase = MediaSessionImplBase.this;
                MediaSessionImplBase.this.sendVolumeInfoChanged(new ParcelableVolumeInfo(mediaSessionImplBase.mVolumeType, mediaSessionImplBase.mLocalStream, o00ooo0o2.o00oOo00(), o00ooo0o2.o00oOOoO(), o00ooo0o2.o00oOOo0()));
            }
        };
        ...
        public class MediaSessionStub extends IMediaSession.Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                ...
                synchronized (MediaSessionImplBase.this.mLock) {
                    ...
                    o00oOo0O o00ooo0o2 = mediaSessionImplBase.mVolumeProvider;
                    i3 = 2;
                    if (i == 2) {
                        int o00oOo002 = o00ooo0o2.o00oOo00();
                        int o00oOOoO2 = o00ooo0o2.o00oOOoO();
                        streamVolume = o00ooo0o2.o00oOOo0();
                        streamMaxVolume = o00oOOoO2;
                        i3 = o00oOo002;
                    } else {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback) {
                ...
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback, new o00oOOoO.C0034o00oOOoO(MediaSessionImplBase.this.getPackageNameForUid(Binder.getCallingUid()), Binder.getCallingPid(), Binder.getCallingUid()));
            }
        ...
        public class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                MediaSessionImplBase.this.setCurrentControllerInfo(new o00oOOoO.C0034o00oOOoO(data.getString(MediaSessionCompat.DATA_CALLING_PACKAGE), data.getInt("data_calling_pid"), data.getInt("data_calling_uid")));
        ...
        public MediaSessionImplBase(Context context, String str, ComponentName componentName, PendingIntent pendingIntent, o0OO000o o0oo000o, Bundle bundle) {
            ...
            this.mToken = new Token(mediaSessionStub, null, o0oo000o);
            this.mRatingType = 0;
            this.mVolumeType = 1;
            this.mLocalStream = 3;
        ...
        public void adjustVolume(int i, int i2) {
            ...
            o00oOo0O o00ooo0o2 = this.mVolumeProvider;
            if (o00ooo0o2 != null) {
                o00ooo0o2.o00oOo0o(i);
            }
        }
        ...
        */
        ...
        public String getPackageNameForUid(int i) {
            ...
            return TextUtils.isEmpty(nameForUid) ? o00oOOoO.C0034o00oOOoO.f3648o00oOOoO : nameForUid;
        }
        ...
        */
        ...
        public void setPlaybackToRemote(o00oOo0O o00ooo0o2) {
            ...
            o00oOo0O o00ooo0o3 = this.mVolumeProvider;
            if (o00ooo0o3 != null) {
                o00ooo0o3.o00oOoO(null);
            }
            this.mVolumeType = 2;
            this.mVolumeProvider = o00ooo0o2;
            sendVolumeInfoChanged(new ParcelableVolumeInfo(this.mVolumeType, this.mLocalStream, this.mVolumeProvider.o00oOo00(), this.mVolumeProvider.o00oOOoO(), this.mVolumeProvider.o00oOOo0()));
            o00ooo0o2.o00oOoO(this.mVolumeCallback);
        }
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public String toString() {
            StringBuilder o00oOOo02 = android.support.v4.media.o00oOo0O.o00oOOo0("MediaSession.QueueItem {Description=");
            o00oOOo02.append(this.mDescription);
            o00oOOo02.append(", Id=");
            return o00oOo00.o00oOOo0(o00oOOo02, this.mId, " }");
        }
    ...
    public static final class ResultReceiverWrapper implements Parcelable {
        ...
        public ResultReceiverWrapper(@oo0oO0 ResultReceiver resultReceiver) {
    ...
    public static final class Token implements Parcelable {
        ...
        @o0O0OOOo("mLock")
        private o0OO000o mSession2Token;
        ...
        public Token(Object obj, IMediaSession iMediaSession, o0OO000o o0oo000o) {
            this.mLock = new Object();
            this.mInner = obj;
            this.mExtraBinder = iMediaSession;
            this.mSession2Token = o0oo000o;
        }
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            IMediaSession asInterface = IMediaSession.Stub.asInterface(oO00O0o0.o00oOOo0.o00oOOo0(bundle, MediaSessionCompat.KEY_EXTRA_BINDER));
            o0OO000o o00oOo002 = oooOO0.o00oOo00(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN);
            Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token == null) {
                return null;
            }
            return new Token(token.mInner, asInterface, o00oOo002);
        }
        ...
        @o0OO0oO({o0OO0oO.o00oOOo0.LIBRARY_GROUP_PREFIX})
        public o0OO000o getSession2Token() {
            o0OO000o o0oo000o;
            synchronized (this.mLock) {
                o0oo000o = this.mSession2Token;
            }
            return o0oo000o;
        }
        ...
        @o0OO0oO({o0OO0oO.o00oOOo0.LIBRARY_GROUP_PREFIX})
        public void setSession2Token(o0OO000o o0oo000o) {
            synchronized (this.mLock) {
                this.mSession2Token = o0oo000o;
            }
        }
        ...
        public Bundle toBundle() {
            ...
            synchronized (this.mLock) {
                ...
                if (iMediaSession != null) {
                    oO00O0o0.o00oOOo0.o00oOOoO(bundle, MediaSessionCompat.KEY_EXTRA_BINDER, iMediaSession.asBinder());
                }
                o0OO000o o0oo000o = this.mSession2Token;
                if (o0oo000o != null) {
                    oooOO0.o00oOo0O(bundle, MediaSessionCompat.KEY_SESSION2_TOKEN, o0oo000o);
                }
            }
            return bundle;
        }
    ...
    static {
        PENDING_INTENT_FLAG_MUTABLE = o0O000.o00oOOo0.o00oOoOO() ? 33554432 : 0;
    }
    ...
    public MediaSessionCompat(@oo0oO0 Context context, @oo0oO0 String str) {
        this(context, str, null, null);
    }

    public MediaSessionCompat(@oo0oO0 Context context, @oo0oO0 String str, @o0OO00OO ComponentName componentName, @o0OO00OO PendingIntent pendingIntent) {
        this(context, str, componentName, pendingIntent, null);
    }

    public MediaSessionCompat(@oo0oO0 Context context, @oo0oO0 String str, @o0OO00OO ComponentName componentName, @o0OO00OO PendingIntent pendingIntent, @o0OO00OO Bundle bundle) {
        this(context, str, componentName, pendingIntent, bundle, null);
    }

    @SuppressLint({"WrongConstant"})
    @o0OO0oO({o0OO0oO.o00oOOo0.LIBRARY_GROUP_PREFIX})
    public MediaSessionCompat(@oo0oO0 Context context, @oo0oO0 String str, @o0OO00OO ComponentName componentName, @o0OO00OO PendingIntent pendingIntent, @o0OO00OO Bundle bundle, @o0OO00OO o0OO000o o0oo000o) {
        this.mActiveListeners = new ArrayList<>();
        if (context == null) {
        ...
        componentName = componentName == null ? o0O0O0o.o00oOo00.o00oOo00(context) : componentName;
        if (componentName != null && pendingIntent == null) {
            Intent intent = new Intent("android.intent.action.MEDIA_BUTTON");
            intent.setComponent(componentName);
            pendingIntent = PendingIntent.getBroadcast(context, 0, intent, PENDING_INTENT_FLAG_MUTABLE);
        }
        this.mImpl = Build.VERSION.SDK_INT >= 29 ? new MediaSessionImplApi29(context, str, o0oo000o, bundle) : new MediaSessionImplApi28(context, str, o0oo000o, bundle);
    ...
    @o0OO0oO({o0OO0oO.o00oOOo0.LIBRARY})
    public static void ensureClassLoader(@o0OO00OO Bundle bundle) {
        if (bundle != null) {
    ...
    @o0OO00OO
    @o0OO0oO({o0OO0oO.o00oOOo0.LIBRARY})
    public static Bundle unparcelWithClassLoader(@o0OO00OO Bundle bundle) {
        if (bundle == null) {
            return null;
        }
    ...
    public void setPlaybackToRemote(o00oOo0O o00ooo0o2) {
        ...
        this.mImpl.setPlaybackToRemote(o00ooo0o2);
    }
