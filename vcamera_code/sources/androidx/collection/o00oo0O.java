...
public class o00oo0O<K, V> {
    ...
    public void entryRemoved(boolean z, @oo0oO0 K k, @oo0oO0 V v, @o0OO00OO V v2) {
    }
    ...
    @o0OO00OO
    public final V put(@oo0oO0 K k, @oo0oO0 V v) {
        V put;
        if (k == null || v == null) {
    ...
    @o0OO00OO
    public final V remove(@oo0oO0 K k) {
        V remove;
        if (k != null) {
            synchronized (this) {
    ...
    public int sizeOf(@oo0oO0 K k, @oo0oO0 V v) {
        return 1;
    }
    ...
    */
    public void trimToSize(int r5) {
        ...
        L71:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.o00oo0O.trimToSize(int):void");
    }
}
