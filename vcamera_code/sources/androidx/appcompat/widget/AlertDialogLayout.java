...
public class AlertDialogLayout extends LinearLayoutCompat {
    public AlertDialogLayout(@o00oOooO.o0OO00OO Context context) {
        super(context);
    }

    public AlertDialogLayout(@o00oOooO.o0OO00OO Context context, @o00oOooO.o0OO00OO AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public static int o00oOOoO(View view) {
        int o0O000o2 = o0O000oo.o0O0o00O.o0O000o(view);
        if (o0O000o2 > 0) {
            return o0O000o2;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return o00oOOoO(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    public final void forceUniformWidth(int i, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            ...
            if (childAt.getVisibility() != 8) {
                LinearLayoutCompat.o00oOOoO o00ooooo2 = (LinearLayoutCompat.o00oOOoO) childAt.getLayoutParams();
                if (((LinearLayout.LayoutParams) o00ooooo2).width == -1) {
                    int i4 = ((LinearLayout.LayoutParams) o00ooooo2).height;
                    ((LinearLayout.LayoutParams) o00ooooo2).height = childAt.getMeasuredHeight();
    ...
    */
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r15 = r2
            androidx.appcompat.widget.LinearLayoutCompat$o00oOOoO r15 = (androidx.appcompat.widget.LinearLayoutCompat.o00oOOoO) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L7e
            r2 = r11
        L7e:
            int r3 = o0O000oo.o0O0o00O.o0O000O(r17)
